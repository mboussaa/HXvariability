...
public class BytesInput extends haxe.io.Input
{
	...
	{
		//line 24 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
	...
	{
		//line 38 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		haxe.io.BytesInput.__hx_ctor_haxe_io_BytesInput(this, b, pos, len);
	}
	
	
	public static void __hx_ctor_haxe_io_BytesInput(haxe.io.BytesInput __temp_me35, haxe.io.Bytes b, java.lang.Object pos, java.lang.Object len)
	{
		//line 39 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		...
		//line 40 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		...
		//line 41 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		...
		//line 53 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		__temp_me35.b = b.b;
		//line 54 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		__temp_me35.pos = ((int) (haxe.lang.Runtime.toInt(pos)) );
		//line 55 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		__temp_me35.len = ((int) (haxe.lang.Runtime.toInt(len)) );
		//line 56 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		__temp_me35.totlen = ((int) (haxe.lang.Runtime.toInt(len)) );
	}
	...
	{
		//line 67 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		return this.pos;
	}
	...
	{
		//line 75 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		return this.totlen;
	}
	...
	{
		//line 80 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		if (( p < 0 )) 
		{
			//line 80 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			p = 0;
		...
		{
			//line 81 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			if (( p > this.totlen )) 
			{
				//line 81 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
				p = this.totlen;
		...
		//line 85 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		this.len = ( this.totlen - p );
		//line 86 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		return this.pos = p;
	}
	...
	{
		//line 94 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		if (( this.len == 0 )) 
		{
			//line 95 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			throw haxe.lang.HaxeException.wrap(new haxe.io.Eof());
		}
		
		//line 96 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		this.len--;
		//line 104 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
	...
	{
		//line 113 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		if (( ( ( pos < 0 ) || ( len < 0 ) ) || ( ( pos + len ) > buf.length ) )) 
		{
			//line 114 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			throw haxe.lang.HaxeException.wrap(haxe.io.Error.OutsideBounds);
		}
		
		//line 121 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		int avail = this.len;
		//line 122 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		if (( len > avail )) 
		{
			//line 122 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			len = avail;
		...
		//line 123 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		if (( len == 0 )) 
		{
			//line 124 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
			throw haxe.lang.HaxeException.wrap(new haxe.io.Eof());
		}
		
		//line 125 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		java.lang.System.arraycopy(((java.lang.Object) (this.b) ), ((int) (this.pos) ), ((java.lang.Object) (buf.b) ), ((int) (pos) ), ((int) (len) ));
		//line 126 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		this.pos += len;
		//line 127 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		this.len -= len;
		//line 156 "/usr/lib/haxe/std/haxe/io/BytesInput.hx"
		return len;
	}
