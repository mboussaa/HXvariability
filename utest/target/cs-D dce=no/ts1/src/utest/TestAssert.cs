...
namespace utest {
	public class TestAssert : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_TestAssert(global::utest.TestAssert __temp_me90, int i) {
			__temp_me90.x = i;
		}
		...
		public virtual void expect(int esuccesses, int efailures, global::haxe.lang.Null<int> eothers) {
			unchecked {
				int __temp_eothers89 = ( ( ! (eothers.hasValue) ) ? (0) : ((eothers).@value) );
				int failures = 0;
				int others = 0;
				{
				...
				global::utest.Assert.@equals(__temp_eothers89, others, global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("expected ", global::haxe.lang.Runtime.toString(__temp_eothers89)), " other results but were "), global::haxe.lang.Runtime.toString(others)), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"expect", "utest.TestAssert", "TestAssert.hx"}, new int[]{1981972957}, new double[]{((double) (353) )}));
