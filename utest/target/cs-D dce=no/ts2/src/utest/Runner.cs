...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me88) {
			__temp_me88.globalPattern = null;
			__temp_me88.fixtures = new global::Array<object>();
			__temp_me88.onProgress = new global::utest.Dispatcher<object>();
			__temp_me88.onStart = new global::utest.Dispatcher<object>();
			__temp_me88.onComplete = new global::utest.Dispatcher<object>();
			__temp_me88.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me88.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me88.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me88.length = 0;
		}
