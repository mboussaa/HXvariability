...
public class TestPseudoRandom extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_math_random_TestPseudoRandom(thx.math.random.TestPseudoRandom __temp_me51, int i)
	{
	...
	{
		//line 12 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		int _g1 = 0;
		//line 12 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		int _g = this.x;
		//line 12 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		while (( _g1 < _g ))
		{
			//line 12 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			 ++ _g1;
			//line 13 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			...
			//line 16 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			{
				//line 16 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
				int _g2 = 0;
				//line 16 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
				while (( _g2 < expected.length ))
				{
					...
					//line 16 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
					 ++ _g2;
					//line 17 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
	...
	{
		//line 21 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		int _g1 = 0;
		//line 21 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		int _g = this.x;
		//line 21 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
		while (( _g1 < _g ))
		{
			//line 21 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			 ++ _g1;
			//line 22 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			...
			//line 25 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
			{
				//line 25 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
				int _g2 = 0;
				//line 25 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
				while (( _g2 < expected.length ))
				{
					...
					//line 25 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
					 ++ _g2;
					//line 26 "/HXvariability/math/test/thx/math/random/TestPseudoRandom.hx"
