...
public class PseudoRandom extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_math_random_PseudoRandom(thx.math.random.PseudoRandom __temp_me50, java.lang.Object seed)
	{
		//line 7 "/HXvariability/math/src/thx/math/random/PseudoRandom.hx"
		int __temp_seed49 = ( (haxe.lang.Runtime.eq(seed, null)) ? (1) : (((int) (haxe.lang.Runtime.toInt(seed)) )) );
		//line 7 "/HXvariability/math/src/thx/math/random/PseudoRandom.hx"
		__temp_me50.seed = __temp_seed49;
	}
