...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me176, string className, string setupName, string teardownName) {
			__temp_me176.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me176.className = className;
			__temp_me176.setupName = setupName;
			__temp_me176.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me176.teardownName = teardownName;
			__temp_me176.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me176.methods = 0;
			__temp_me176.stats = new global::utest.ui.common.ResultStats();
		}
