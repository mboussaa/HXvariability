...
namespace haxe.ds {
	public class StringMap<T> : global::haxe.lang.HxObject, global::haxe.ds.StringMap, global::haxe.IMap<object, T> {
		...
		public static void __hx_ctor_haxe_ds_StringMap<T_c>(global::haxe.ds.StringMap<T_c> __temp_me72) {
			unchecked {
				__temp_me72.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr69 = new T_c[this.vals.Length];
								int __temp_i70 = -1;
								while ((  ++ __temp_i70 < this.vals.Length )) {
									object __temp_obj71 = ((object) (this.vals[__temp_i70]) );
									if (( __temp_obj71 != null )) {
										__temp_new_arr69[__temp_i70] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj71);
									}
									
								}
								
								new_me.vals = __temp_new_arr69;
							}
							else {
								new_me.vals = null;
							}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapKeyIterator<T_c>(global::haxe.ds._StringMap.StringMapKeyIterator<T_c> __temp_me73, global::haxe.ds.StringMap<T_c> m) {
			__temp_me73.m = m;
			__temp_me73.i = 0;
			__temp_me73.len = m.nBuckets;
		}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapValueIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapValueIterator<T_c>(global::haxe.ds._StringMap.StringMapValueIterator<T_c> __temp_me74, global::haxe.ds.StringMap<T_c> m) {
			__temp_me74.m = m;
			__temp_me74.i = 0;
