...
namespace thx.math.random {
	public class PseudoRandom : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_math_random_PseudoRandom(global::thx.math.random.PseudoRandom __temp_me86, global::haxe.lang.Null<int> seed) {
			unchecked {
				int __temp_seed85 = ( ( ! (seed.hasValue) ) ? (1) : ((seed).@value) );
				__temp_me86.seed = __temp_seed85;
			}
		}
