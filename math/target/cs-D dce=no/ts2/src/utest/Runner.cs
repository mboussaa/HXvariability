...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me91) {
			__temp_me91.globalPattern = null;
			__temp_me91.fixtures = new global::Array<object>();
			__temp_me91.onProgress = new global::utest.Dispatcher<object>();
			__temp_me91.onStart = new global::utest.Dispatcher<object>();
			__temp_me91.onComplete = new global::utest.Dispatcher<object>();
			__temp_me91.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me91.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me91.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me91.length = 0;
		}
