...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me107) {
			__temp_me107.assertations = 0;
			__temp_me107.successes = 0;
			__temp_me107.failures = 0;
			__temp_me107.errors = 0;
			__temp_me107.warnings = 0;
			__temp_me107.isOk = true;
			__temp_me107.hasFailures = false;
			__temp_me107.hasErrors = false;
			__temp_me107.hasWarnings = false;
			__temp_me107.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me107.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me107.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me107.onAddWarnings = new global::utest.Dispatcher<int>();
		}
