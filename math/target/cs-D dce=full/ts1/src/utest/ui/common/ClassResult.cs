...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me47, string className, string setupName, string teardownName) {
			__temp_me47.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me47.className = className;
			__temp_me47.setupName = setupName;
			__temp_me47.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me47.teardownName = teardownName;
			__temp_me47.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me47.methods = 0;
			__temp_me47.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::utest.ui.common.FixtureResult @get(string method) {
			return ((global::utest.ui.common.FixtureResult) ((this.fixtures.@get(method)).@value) );
		}
		
		
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority46 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
