								...
								$messages = "";
								{
									...
									while(true) {
										...
										case 1:{
											$buf->add("F");
											$tmp8 = $this->indents(2);
											$messages .= _hx_string_or_null($tmp8) . "line: " . _hx_string_rec(_hx_deref($assertation)->params[1]->lineNumber, "") . ", " . _hx_string_or_null(_hx_deref($assertation)->params[0]) . _hx_string_or_null($this->newline);
										}break;
										case 2:{
											$buf->add("E");
											$tmp9 = $this->indents(2);
											$tmp10 = Std::string(_hx_deref($assertation)->params[0]);
											$tmp11 = _hx_string_or_null($tmp9) . _hx_string_or_null($tmp10);
											$tmp12 = $this->dumpStack(_hx_deref($assertation)->params[1]);
											$messages .= _hx_string_or_null($tmp11) . _hx_string_or_null($tmp12) . _hx_string_or_null($this->newline);
										}break;
										case 3:{
											$buf->add("S");
											$tmp13 = $this->indents(2);
											$tmp14 = Std::string(_hx_deref($assertation)->params[0]);
											$tmp15 = _hx_string_or_null($tmp13) . _hx_string_or_null($tmp14);
											$tmp16 = $this->dumpStack(_hx_deref($assertation)->params[1]);
											$messages .= _hx_string_or_null($tmp15) . _hx_string_or_null($tmp16) . _hx_string_or_null($this->newline);
										}break;
										case 4:{
											$buf->add("T");
											$tmp17 = $this->indents(2);
											$tmp18 = Std::string(_hx_deref($assertation)->params[0]);
											$tmp19 = _hx_string_or_null($tmp17) . _hx_string_or_null($tmp18);
											$tmp20 = $this->dumpStack(_hx_deref($assertation)->params[1]);
											$messages .= _hx_string_or_null($tmp19) . _hx_string_or_null($tmp20) . _hx_string_or_null($this->newline);
										}break;
										case 5:{
											$buf->add("O");
											$tmp21 = $this->indents(2);
											$tmp22 = _hx_string_or_null($tmp21) . "missed async calls: " . _hx_string_rec(_hx_deref($assertation)->params[0], "");
											$tmp23 = $this->dumpStack(_hx_deref($assertation)->params[1]);
											$messages .= _hx_string_or_null($tmp22) . _hx_string_or_null($tmp23) . _hx_string_or_null($this->newline);
										}break;
										case 6:{
											$buf->add("A");
											$tmp24 = $this->indents(2);
											$tmp25 = Std::string(_hx_deref($assertation)->params[0]);
											$tmp26 = _hx_string_or_null($tmp24) . _hx_string_or_null($tmp25);
											$tmp27 = $this->dumpStack(_hx_deref($assertation)->params[1]);
											$messages .= _hx_string_or_null($tmp26) . _hx_string_or_null($tmp27) . _hx_string_or_null($this->newline);
										}break;
										case 7:{
											$buf->add("W");
											$tmp28 = $this->indents(2);
											$messages .= _hx_string_or_null($tmp28) . _hx_string_or_null(_hx_deref($assertation)->params[0]) . _hx_string_or_null($this->newline);
										}break;
										}
										unset($tmp7,$assertation);
									}
									unset($tmp6);
								}
								$buf->add($this->newline);
