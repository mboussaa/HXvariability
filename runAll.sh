...
time(docker run -w /HXvariability -it --rm -v /HXvariability:/HXvariability --name=haxe_"$line"_"$ts"_"$i" mboussaa/haxe /bin/bash -c "./run.sh '$line' '$ts' '$i' 100") 2>> /shared/stats/statistics/time_"$ts"_"$j".csv
