...
class thx_csv_TestCsv {
	...
	public function testEncode() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_csv_Csv::encode((new _hx_array(array((new _hx_array(array("1997", "Ford", "E350")))))));
			...
			$tmp1 = thx_csv_Csv::encode((new _hx_array(array((new _hx_array(array("1997", "Ford", "E350", "Super, luxurious truck")))))));
			...
			$tmp2 = thx_csv_Csv::encode((new _hx_array(array((new _hx_array(array("1997", "Ford", "E350", "Super, \"luxurious\" truck")))))));
			...
			$tmp3 = thx_csv_Csv::encode((new _hx_array(array((new _hx_array(array("1997", "Ford", "E350", "Go get one now\x0Athey are going fast")))))));
	...
	public function testDecode() {
		...
		while($_g1 < $_g) {
			...
			$tmp6 = thx_csv_Csv::decode(",\x0A\x0A,");
			...
			$tmp7 = thx_csv_Csv::decode(",\x0A\"\"\x0A,");
			...
			$tmp8 = thx_csv_Csv::decode("1997,Ford,E350");
			...
			$tmp9 = thx_csv_Csv::decode("\"1997\",\"Ford\",\"E350\"");
			...
			$tmp10 = thx_csv_Csv::decode("1997,Ford,E350,\"Super, luxurious truck\"");
			...
			$tmp11 = thx_csv_Csv::decode("1997,Ford,E350,\"Super, \"\"luxurious\"\" truck\"");
			...
			$tmp12 = thx_csv_Csv::decode("1997,Ford,E350,\"Go get one now\x0Athey are going fast\"");
	...
	public function testIssue20160125() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$decoded = thx_csv_Csv::decode("265671209,\"Dynagreen Environmental Protection Group Co., Ltd.\",1330,China,HKD,");
			$encoded = thx_csv_Csv::encode($decoded);
	...
	public function testTerminalComma() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$decoded = thx_csv_Csv::decode("Company ID,Name,Ticker,Country,Currency,\x0A24085,1-800-Flowers.com Inc.,FLWS,United States,USD,");
			$encoded = thx_csv_Csv::encode($decoded);
	...
	public function testRoundtrip() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$decoded = thx_csv_Csv::decode("Year,Make,Model,Description,Price\x0A1997,Ford,E350,\"ac, abs, moon\",3000.00\x0A1999,Chevy,\"Venture \"\"Extended Edition\"\"\",\"\",4900.00\x0A1999,Chevy,\"Venture \"\"Extended Edition, Very Large\"\"\",,5000.00\x0A1996,Jeep,Grand Cherokee,\"MUST SELL!\x0Aair, moon roof, loaded\",4799.00");
			$encoded = thx_csv_Csv::encode($decoded);
	...
	public function testAutoTrim() {
		...
		while($_g1 < $_g) {
			...
			$tmp = thx_csv_Csv::decode("1997,Ford,E350,\" Super, luxurious truck \"");
	...
	public function testSurroundingWhitespaces() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_csv_Csv::decode("1997, \"Ford\" ,E350");
	...
	public function testTsv() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_csv_Tsv::decode("1997   Ford    E350");
