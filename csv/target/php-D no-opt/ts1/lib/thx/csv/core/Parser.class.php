	...
	public function parse($s) {
		...
		try {
			...
			$e = $_ex_;
			{
				...
				$tmp31 = Std::string($e);
				throw new HException(new thx_Error(_hx_string_or_null($tmp30) . _hx_string_or_null($tmp31), null, _hx_anonymous(array("fileName" => "Parser.hx", "lineNumber" => 39, "className" => "thx.csv.core.Parser", "methodName" => "parse"))));
			}
		}
		$this->pushCell();
		$this->pushRow();
