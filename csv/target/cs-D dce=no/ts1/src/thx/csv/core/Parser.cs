...
namespace thx.csv.core {
	public class Parser : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_csv_core_Parser(global::thx.csv.core.Parser __temp_me164, string delimiter, string quote, string escapedQuote) {
			__temp_me164.delimiter = delimiter;
			__temp_me164.quote = quote;
			__temp_me164.escapedQuote = escapedQuote;
		}
			...
			unchecked {
				...
				try {
					...
					
					{
						...
						throw global::haxe.lang.HaxeException.wrap(new global::thx.Error(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("unable to parse at pos ", global::haxe.lang.Runtime.toString(this.pos)), ": "), global::Std.@string(e)), null, new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"parse", "thx.csv.core.Parser", "Parser.hx"}, new int[]{1981972957}, new double[]{((double) (39) )})));
					}
