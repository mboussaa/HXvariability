...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me186) {
			__temp_me186.assertations = 0;
			__temp_me186.successes = 0;
			__temp_me186.failures = 0;
			__temp_me186.errors = 0;
			__temp_me186.warnings = 0;
			__temp_me186.isOk = true;
			__temp_me186.hasFailures = false;
			__temp_me186.hasErrors = false;
			__temp_me186.hasWarnings = false;
			__temp_me186.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me186.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me186.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me186.onAddWarnings = new global::utest.Dispatcher<int>();
		}
