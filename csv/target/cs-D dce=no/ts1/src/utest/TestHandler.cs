...
namespace utest {
	public class TestHandler<T> : global::haxe.lang.HxObject, global::utest.TestHandler {
		...
		public static void __hx_ctor_utest_TestHandler<T_c>(global::utest.TestHandler<T_c> __temp_me174, global::utest.TestFixture fixture) {
			if (( fixture == null )) {
				throw global::haxe.lang.HaxeException.wrap("fixture argument is null");
			}
			
			__temp_me174.fixture = fixture;
			__temp_me174.results = new global::List<object>();
			__temp_me174.asyncStack = new global::List<object>();
			__temp_me174.onTested = new global::utest.Dispatcher<object>();
			__temp_me174.onTimeout = new global::utest.Dispatcher<object>();
		...
		public static global::Array<object> exceptionStack(global::haxe.lang.Null<int> pops) {
			unchecked {
				int __temp_pops173 = ( ( ! (pops.hasValue) ) ? (2) : ((pops).@value) );
				global::Array<object> stack = global::haxe.CallStack.exceptionStack();
				while (( __temp_pops173-- > 0 )) {
					stack.pop();
				}
		...
		public virtual global::haxe.lang.Function addEvent<EventArg>(global::haxe.lang.Function f, global::haxe.lang.Null<int> timeout) {
			unchecked {
				int __temp_timeout172 = ( ( ! (timeout.hasValue) ) ? (250) : ((timeout).@value) );
				global::haxe.lang.Runtime.callField(this.asyncStack, "add", 4846113, new global::Array<object>(new object[]{f}));
				global::utest.TestHandler<T> handler = this;
				this.setTimeout(__temp_timeout172);
