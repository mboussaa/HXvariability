...
class thx_TestInt64s {
	...
	public function testRounding() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tests = (new _hx_array(array(_hx_anonymous(array("roundUp" => 3, "roundDown" => 2, "round" => 3, "num" => 5, "div" => 2, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 21, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => 0, "roundDown" => 0, "round" => 0, "num" => 0, "div" => 2, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 22, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => 1, "roundDown" => 0, "round" => 0, "num" => 1, "div" => 4, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 23, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => -2, "roundDown" => -3, "round" => -2, "num" => -5, "div" => 2, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 25, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => 0, "roundDown" => -1, "round" => 0, "num" => -1, "div" => 4, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 26, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => 0, "roundDown" => 0, "round" => 0, "num" => 0, "div" => -2, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 28, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => -2, "roundDown" => -3, "round" => -2, "num" => 5, "div" => -2, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 29, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))), _hx_anonymous(array("roundUp" => 0, "roundDown" => -1, "round" => 0, "num" => 1, "div" => -4, "pos" => thx_TestInt64s::here(_hx_anonymous(array("fileName" => "TestInt64s.hx", "lineNumber" => 30, "className" => "thx.TestInt64s", "methodName" => "testRounding"))))))));
			$up = null;
			$down = null;
			$round = null;
			$num = null;
