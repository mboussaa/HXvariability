...
class thx_fp__Map_Map_Impl_ {
	...
	static function delete($this1, $key, $comparator) {
		...
		case 1:{
			...
			case 0:{
				$tmp = thx_fp__Map_Map_Impl_::delete($lhs, $key, $comparator);
				return thx_fp__Map_Map_Impl_::balance($kx, $x, $tmp, $rhs);
			}break;
			case 1:{
				$tmp1 = thx_fp__Map_Map_Impl_::delete($rhs, $key, $comparator);
				return thx_fp__Map_Map_Impl_::balance($kx, $x, $lhs, $tmp1);
			}break;
			case 2:{
	...
	static function insert($this1, $kx, $x, $comparator) {
		...
		case 1:{
			...
			switch(Type::enumIndex($_g)) {
			case 0:{
				$tmp = thx_fp__Map_Map_Impl_::insert($lhs, $kx, $x, $comparator);
				return thx_fp__Map_Map_Impl_::balance($ky, $y, $tmp, $rhs);
			}break;
			case 1:{
				$tmp1 = thx_fp__Map_Map_Impl_::insert($rhs, $kx, $x, $comparator);
				return thx_fp__Map_Map_Impl_::balance($ky, $y, $lhs, $tmp1);
			}break;
			case 2:{
	...
	static function foldLeft($this1, $b, $f) {
		...
		case 1:{
			...
			$tmp = call_user_func_array($f, array($b, _hx_deref($this1)->params[2]));
			$tmp1 = thx_fp__Map_Map_Impl_::foldLeft($l, $tmp, $f);
			return thx_fp__Map_Map_Impl_::foldLeft($r, $tmp1, $f);
		}break;
		}
	}
	static function map($this1, $f) {
		...
		case 1:{
			...
			$ky = _hx_deref($this1)->params[1];
			$sz = _hx_deref($this1)->params[0];
			$tmp = call_user_func_array($f, array($y));
			$tmp1 = thx_fp__Map_Map_Impl_::map($lhs, $f);
			$tmp2 = thx_fp__Map_Map_Impl_::map($rhs, $f);
			return thx_fp_MapImpl::Bin($sz, $ky, $tmp, $tmp1, $tmp2);
		}break;
		}
	}
	...
	static function foldLeftKeys($this1, $b, $f) {
		...
		case 1:{
			$r = _hx_deref($this1)->params[4];
			$l = _hx_deref($this1)->params[3];
			$tmp = call_user_func_array($f, array($b, _hx_deref($this1)->params[1]));
			$tmp1 = thx_fp__Map_Map_Impl_::foldLeftKeys($l, $tmp, $f);
			return thx_fp__Map_Map_Impl_::foldLeftKeys($r, $tmp1, $f);
		}break;
		}
	}
	static function foldLeftAll($this1, $b, $f) {
		...
		case 1:{
			$r = _hx_deref($this1)->params[4];
			$l = _hx_deref($this1)->params[3];
			$tmp = call_user_func_array($f, array($b, _hx_deref($this1)->params[1], _hx_deref($this1)->params[2]));
			$tmp1 = thx_fp__Map_Map_Impl_::foldLeftAll($l, $tmp, $f);
			return thx_fp__Map_Map_Impl_::foldLeftAll($r, $tmp1, $f);
		}break;
		}
	}
	static function foldLeftTuples($this1, $b, $f) {
		...
		case 1:{
			$r = _hx_deref($this1)->params[4];
			$l = _hx_deref($this1)->params[3];
			$tmp = call_user_func_array($f, array($b, _hx_anonymous(array("_0" => _hx_deref($this1)->params[1], "_1" => _hx_deref($this1)->params[2]))));
			$tmp1 = thx_fp__Map_Map_Impl_::foldLeftTuples($l, $tmp, $f);
			return thx_fp__Map_Map_Impl_::foldLeftTuples($r, $tmp1, $f);
		}break;
		}
	}
	...
	static function deleteFindMin($map) {
		...
		case 1:{
			if(Type::enumIndex(_hx_deref($map)->params[3]) === 0) {
				...
				$tmp = thx_fp__Map_Map_Impl_::balance($k1, $x1, $t->t, $r1);
				return _hx_anonymous(array("k" => $t->k, "x" => $t->x, "t" => $tmp));
			}
		}break;
		}
	}
	static function deleteFindMax($map) {
		...
		case 1:{
			if(Type::enumIndex(_hx_deref($map)->params[4]) === 0) {
				$k = _hx_deref($map)->params[1];
				$x = _hx_deref($map)->params[2];
				$l = _hx_deref($map)->params[3];
				...
				$tmp = thx_fp__Map_Map_Impl_::balance($k1, $x1, $l1, $t->t);
				return _hx_anonymous(array("k" => $t->k, "x" => $t->x, "t" => $tmp));
			}
		}break;
		}
	...
	static function doubleLeft($k1, $x1, $t1, $rhs) {
		if(Type::enumIndex($rhs) === 1) {
			if(Type::enumIndex(_hx_deref($rhs)->params[3]) === 1) {
	...
	static function doubleRight($k1, $x1, $lhs, $t4) {
		if(Type::enumIndex($lhs) === 1) {
			if(Type::enumIndex(_hx_deref($lhs)->params[4]) === 1) {
				$k2 = _hx_deref($lhs)->params[1];
				$x2 = _hx_deref($lhs)->params[2];
				$t1 = _hx_deref($lhs)->params[3];
