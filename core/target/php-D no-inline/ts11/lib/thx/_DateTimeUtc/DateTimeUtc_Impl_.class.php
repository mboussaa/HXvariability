...
class thx__DateTimeUtc_DateTimeUtc_Impl_ {
	...
	static function snapNext($this1, $period) {
		...
		case 3:{
			$tmp18 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp19 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp20 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp18, $tmp19, $tmp20 + 1, 0, 0, 0, null);
		}break;
		case 4:{
			$wd = thx__DateTimeUtc_DateTimeUtc_Impl_::get_dayOfWeek($this1);
			$tmp21 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp22 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp23 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp21, $tmp22, $tmp23 + 7 - $wd, 0, 0, 0, null);
		}break;
		case 5:{
			...
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp24, $tmp25 + 1, 1, 0, 0, 0, null);
		}break;
		case 6:{
			$tmp26 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp26 + 1, 1, 1, 0, 0, 0, null);
		}break;
		}
	}
	static function snapPrev($this1, $period) {
		...
		case 3:{
			...
			$tmp19 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp20 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp18, $tmp19, $tmp20, 0, 0, 0, null);
		}break;
		case 4:{
			$wd = thx__DateTimeUtc_DateTimeUtc_Impl_::get_dayOfWeek($this1);
			$tmp21 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp22 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp23 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp21, $tmp22, $tmp23 - $wd, 0, 0, 0, null);
		}break;
		case 5:{
			$tmp24 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp25 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp24, $tmp25, 1, 0, 0, 0, null);
		}break;
		case 6:{
			$tmp26 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp26, 1, 1, 0, 0, 0, null);
		}break;
		}
	}
	static function snapTo($this1, $period) {
		...
		case 3:{
			$mod = null;
			$tmp18 = thx__DateTimeUtc_DateTimeUtc_Impl_::get_hour($this1);
			if($tmp18 >= 12) {
				$mod = 1;
			} else {
				$mod = 0;
			...
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp19, $tmp20, $tmp21 + $mod, 0, 0, 0, null);
		}break;
		case 4:{
			$wd = thx__DateTimeUtc_DateTimeUtc_Impl_::get_dayOfWeek($this1);
			$mod1 = null;
			if($wd < 3) {
				...
				if($wd > 3) {
					...
					$tmp22 = thx__DateTimeUtc_DateTimeUtc_Impl_::get_hour($this1);
					if($tmp22 < 12) {
						$mod1 = -$wd;
					} else {
						$mod1 = 7 - $wd;
			...
			$tmp23 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp24 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp25 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp23, $tmp24, $tmp25 + $mod1, 0, 0, 0, null);
		}break;
		case 5:{
			$mod2 = null;
			...
			$tmp28 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp29 = Math::round(thx__DateTimeUtc_DateTimeUtc_Impl_::daysInMonth($tmp27, $tmp28) / 2);
			if($tmp26 > $tmp29) {
				$mod2 = 1;
			} else {
				$mod2 = 0;
			}
			$tmp30 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$tmp31 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp30, $tmp31 + $mod2, 1, 0, 0, 0, null);
		}break;
		case 6:{
			$mod3 = null;
			$tmp32 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$that = thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp32, 6, 2, 0, 0, 0, null);
			$b3 = $that;
			...
			$tmp35 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($this1, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			return thx__DateTimeUtc_DateTimeUtc_Impl_::create($tmp35 + $mod3, 1, 1, 0, 0, 0, null);
		}break;
		}
	}
