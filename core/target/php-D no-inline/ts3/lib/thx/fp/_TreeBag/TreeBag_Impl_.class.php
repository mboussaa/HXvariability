...
class thx_fp__TreeBag_TreeBag_Impl_ {
	...
	static function map($this1, $f) {
		...
		case 1:{
			...
			$tmp1 = thx_fp__TreeBag_TreeBag_Impl_::map($xs, $f);
			return thx_fp_TreeBagImpl::Cons($tmp, $tmp1);
		}break;
		case 2:{
			$r = _hx_deref($this1)->params[1];
			$tmp2 = thx_fp__TreeBag_TreeBag_Impl_::map(_hx_deref($this1)->params[0], $f);
			$tmp3 = thx_fp__TreeBag_TreeBag_Impl_::map($r, $f);
			return thx_fp_TreeBagImpl::Branch($tmp2, $tmp3);
		}break;
		}
	}
	static function flatMap($this1, $f) {
		...
		case 1:{
			...
			case 1:{
				if(Type::enumIndex($other) === 0) {
					...
					if(Type::enumIndex(_hx_deref($this2)->params[1]) === 0) {
		...
		case 2:{
			...
			switch(Type::enumIndex($this3)) {
			case 0:{
				if(Type::enumIndex($other1) === 0) {
					return thx_fp_TreeBagImpl::$hEmpty;
				} else {
					return $other1;
				}
			...
			case 1:{
				if(Type::enumIndex($other1) === 0) {
					...
					if(Type::enumIndex(_hx_deref($this3)->params[1]) === 0) {
...
function thx_fp__TreeBag_TreeBag_Impl__4($l, $r) {
	{
		...
		case 1:{
			if(Type::enumIndex($r) === 0) {
				...
				if(Type::enumIndex(_hx_deref($l)->params[1]) === 0) {
