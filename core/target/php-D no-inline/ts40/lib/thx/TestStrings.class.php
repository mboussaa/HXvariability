...
class thx_TestStrings {
	...
	public function testContains() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_Strings::contains("test", "");
			utest_Assert::isTrue($tmp, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 26, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp1 = thx_Strings::contains("test", "t");
			utest_Assert::isTrue($tmp1, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 27, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp2 = thx_Strings::contains("test", "te");
			utest_Assert::isTrue($tmp2, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 28, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp3 = thx_Strings::contains("test", "tes");
			utest_Assert::isTrue($tmp3, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 29, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp4 = thx_Strings::contains("test", "test");
			utest_Assert::isTrue($tmp4, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 30, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp5 = thx_Strings::contains("one two three", "one");
			utest_Assert::isTrue($tmp5, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 31, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp6 = thx_Strings::contains("one two three", "two");
			utest_Assert::isTrue($tmp6, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 32, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp7 = thx_Strings::contains("one two three", "three");
			utest_Assert::isTrue($tmp7, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 33, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp8 = thx_Strings::contains("test", "test ");
			utest_Assert::isFalse($tmp8, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 34, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp9 = thx_Strings::contains("test", " test");
			utest_Assert::isFalse($tmp9, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 35, "className" => "thx.TestStrings", "methodName" => "testContains")));
			$tmp10 = thx_Strings::contains("test", "tes ");
			utest_Assert::isFalse($tmp10, null, _hx_anonymous(array("fileName" => "TestStrings.hx", "lineNumber" => 36, "className" => "thx.TestStrings", "methodName" => "testContains")));
			unset($tmp9,$tmp8,$tmp7,$tmp6,$tmp5,$tmp4,$tmp3,$tmp2,$tmp10,$tmp1,$tmp);
		}
	}
	...
	public function testContainsAny() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_Strings::containsAny("test", (new _hx_array(array("t", "x", "y"))));
			...
			$tmp1 = thx_Strings::containsAny("test", (new _hx_array(array("e", "x", "y"))));
			...
			$tmp2 = thx_Strings::containsAny("test", (new _hx_array(array("s", "x", "y"))));
			...
			$tmp3 = thx_Strings::containsAny("test", (new _hx_array(array("x", "t", "y"))));
			...
			$tmp4 = thx_Strings::containsAny("test", (new _hx_array(array("x", "e", "y"))));
			...
			$tmp5 = thx_Strings::containsAny("test", (new _hx_array(array("x", "s", "y"))));
			...
			$tmp6 = thx_Strings::containsAny("test", (new _hx_array(array("x", "y", "t"))));
			...
			$tmp7 = thx_Strings::containsAny("test", (new _hx_array(array("x", "y", "e"))));
			...
			$tmp8 = thx_Strings::containsAny("test", (new _hx_array(array("x", "y", "s"))));
			...
			$tmp9 = thx_Strings::containsAny("one two three", (new _hx_array(array("zero", "one", "two"))));
			...
			$tmp10 = thx_Strings::containsAny("one two three", (new _hx_array(array("one", "two", "three"))));
			...
			$tmp11 = thx_Strings::containsAny("one two three", (new _hx_array(array("one two", "x", "three"))));
		...
		while($_g1 < $_g) {
			...
			$tests = (new _hx_array(array(_hx_anonymous(array("expected" => true, "test" => "a")), _hx_anonymous(array("expected" => true, "test" => "1a")), _hx_anonymous(array("expected" => false, "test" => " a")), _hx_anonymous(array("expected" => false, "test" => " ")), _hx_anonymous(array("expected" => false, "test" => "")))));
			{
				...
				while($_g2 < $tests->length) {
					...
					++$_g2;
					$tmp = $item->expected;
					$tmp1 = thx_Strings::isAlphaNum($item->test);
	...
	public function testTrim() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_Strings::trimChars("abcde", "x");
			...
			$tmp1 = thx_Strings::trimChars("abcde", "abe");
			...
			$tmp2 = thx_Strings::trimChars("abcde", "bd");
	...
	public function testToLines() {
		...
		while($_g1 < $_g) {
			++$_g1;
			$tmp = thx_Strings::toLines("Split\x0Ato\x0Alines");
