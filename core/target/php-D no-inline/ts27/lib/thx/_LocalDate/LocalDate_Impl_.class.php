...
class thx__LocalDate_LocalDate_Impl_ {
	...
	static function snapNext($this1, $period) {
		...
		case 5:{
			$tmp = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$tmp1 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_MONTH);
			return thx__LocalDate_LocalDate_Impl_::create($tmp, $tmp1 + 1, 1);
		}break;
		case 6:{
			$tmp2 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			return thx__LocalDate_LocalDate_Impl_::create($tmp2 + 1, 1, 1);
		}break;
		}
	}
	static function snapPrev($this1, $period) {
		...
		case 5:{
			$tmp = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$tmp1 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_MONTH);
			return thx__LocalDate_LocalDate_Impl_::create($tmp, $tmp1, 1);
		}break;
		case 6:{
			$tmp2 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			return thx__LocalDate_LocalDate_Impl_::create($tmp2, 1, 1);
		}break;
		}
	}
	static function snapTo($this1, $period) {
		...
		case 4:{
			...
			$tmp = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$tmp1 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_MONTH);
			$tmp2 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_DAY);
			return thx__LocalDate_LocalDate_Impl_::create($tmp, $tmp1, $tmp2 + $mod);
		}break;
		case 5:{
			$mod1 = null;
			$tmp3 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_DAY);
			$tmp4 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$tmp5 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_MONTH);
			$tmp6 = Math::round(thx__DateTimeUtc_DateTimeUtc_Impl_::daysInMonth($tmp4, $tmp5) / 2);
			if($tmp3 > $tmp6) {
				$mod1 = 1;
			} else {
				$mod1 = 0;
			}
			$tmp7 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$tmp8 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_MONTH);
			return thx__LocalDate_LocalDate_Impl_::create($tmp7, $tmp8 + $mod1, 1);
		}break;
		case 6:{
			$mod2 = null;
			$tmp9 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			$that = thx__LocalDate_LocalDate_Impl_::create($tmp9, 6, 2);
			if(thx_Ints::compare($this1, $that) > 0) {
				$mod2 = 1;
			} else {
				$mod2 = 0;
			}
			$tmp10 = thx__LocalDate_LocalDate_Impl_::getDatePart($this1, thx__LocalDate_LocalDate_Impl_::$DATE_PART_YEAR);
			return thx__LocalDate_LocalDate_Impl_::create($tmp10 + $mod2, 1, 1);
		}break;
		}
	}
