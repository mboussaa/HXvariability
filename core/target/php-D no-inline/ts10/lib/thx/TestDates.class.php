...
class thx_TestDates {
	...
	public function assertSnapTo($expected, $date, $period, $pos = null) {
		$tmp = Date::fromString($date);
		$t = thx_Dates::snapTo($tmp, $period);
		$tmp1 = Date::fromString($expected)->getTime();
		$tmp2 = $t->getTime();
		$tmp3 = "expected " . _hx_string_or_null($date) . " to snap to " . _hx_string_or_null($expected) . " for ";
		$tmp4 = Std::string($period);
		$tmp5 = _hx_string_or_null($tmp3) . _hx_string_or_null($tmp4) . " but it is ";
		$tmp6 = $t->toString();
		utest_Assert::floatEquals($tmp1, $tmp2, null, _hx_string_or_null($tmp5) . _hx_string_or_null($tmp6), $pos);
	}
	public function assertSnapPrev($expected, $date, $period, $pos = null) {
		$tmp = Date::fromString($date);
		$t = thx_Dates::snapPrev($tmp, $period);
		$tmp1 = Date::fromString($expected)->getTime();
		$tmp2 = $t->getTime();
		$tmp3 = "expected " . _hx_string_or_null($date) . " to snap before " . _hx_string_or_null($expected) . " for ";
		$tmp4 = Std::string($period);
		$tmp5 = _hx_string_or_null($tmp3) . _hx_string_or_null($tmp4) . " but it is ";
		$tmp6 = $t->toString();
		utest_Assert::floatEquals($tmp1, $tmp2, null, _hx_string_or_null($tmp5) . _hx_string_or_null($tmp6), $pos);
	...
	public function assertSnapNext($expected, $date, $period, $pos = null) {
		$tmp = Date::fromString($date);
		$t = thx_Dates::snapNext($tmp, $period);
		$tmp1 = Date::fromString($expected)->getTime();
		$tmp2 = $t->getTime();
		$tmp3 = "expected " . _hx_string_or_null($date) . " to snap after " . _hx_string_or_null($expected) . " for ";
		$tmp4 = Std::string($period);
		$tmp5 = _hx_string_or_null($tmp3) . _hx_string_or_null($tmp4) . " but it is ";
		$tmp6 = $t->toString();
		utest_Assert::floatEquals($tmp1, $tmp2, null, _hx_string_or_null($tmp5) . _hx_string_or_null($tmp6), $pos);
