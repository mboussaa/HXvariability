...
class thx_TestIterables {
	...
	public function testMin() {
		...
		while($_g1 < $_g) {
			...
			$tmp1 = thx_Iterables::min($a, (isset(thx_Ints::$order) ? thx_Ints::$order: array("thx_Ints", "order")));
			...
			$tmp2 = thx_Iterables::min((new _hx_array(array())), (isset(thx_Ints::$order) ? thx_Ints::$order: array("thx_Ints", "order")));
