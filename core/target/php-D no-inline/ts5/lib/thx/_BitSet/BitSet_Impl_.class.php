...
class thx__BitSet_BitSet_Impl_ {
	...
	static function expand($this1, $count) {
		$tmp = thx_Ints::range(thx__BitSet_BitSet_Impl_::get_length($this1), null, null);
		$values = thx_Arrays::flatMap($tmp, array(new _hx_lambda(array(&$count, &$this1), "thx__BitSet_BitSet_Impl__4"), 'execute'));
		$this2 = (new _hx_array(array(0)));
		thx_Arrays::resize($this2, 2, 0);
	...
	static function combine($this1, $right, $combiner) {
		$left = $this1;
		$tmp = thx_Ints::range(thx_Ints::max(thx__BitSet_BitSet_Impl_::get_length($left), thx__BitSet_BitSet_Impl_::get_length($right)), null, null);
		$this2 = (new _hx_array(array(0)));
		thx_Arrays::resize($this2, 2, 0);
