...
class thx__DateTime_DateTime_Impl_ {
	...
	static function snapNext($this1, $period) {
		...
		case 1:{
			...
			$tmp6 = $p011 << 16 << haxe__Int32_Int32_Impl_::$extraBits;
			$p011 = $tmp6 >> haxe__Int32_Int32_Impl_::$extraBits;
			...
			$tmp8 = $p101 << 16 << haxe__Int32_Int32_Impl_::$extraBits;
			$p101 = $tmp8 >> haxe__Int32_Int32_Impl_::$extraBits;
			$tmp9 = $low1 + $p101 << haxe__Int32_Int32_Impl_::$extraBits;
			$low1 = $tmp9 >> haxe__Int32_Int32_Impl_::$extraBits;
			...
			$tmp11 = $high1 + (haxe__Int32_Int32_Impl_::mul($a1->low, $b1->high) + haxe__Int32_Int32_Impl_::mul($a1->high, $b1->low) << haxe__Int32_Int32_Impl_::$extraBits >> haxe__Int32_Int32_Impl_::$extraBits) << haxe__Int32_Int32_Impl_::$extraBits;
		...
		case 2:{
			...
			$tmp12 = $p012 << 16 << haxe__Int32_Int32_Impl_::$extraBits;
			$p012 = $tmp12 >> haxe__Int32_Int32_Impl_::$extraBits;
			...
			$tmp14 = $p102 << 16 << haxe__Int32_Int32_Impl_::$extraBits;
			$p102 = $tmp14 >> haxe__Int32_Int32_Impl_::$extraBits;
			$tmp15 = $low2 + $p102 << haxe__Int32_Int32_Impl_::$extraBits;
			...
			$tmp17 = $high2 + (haxe__Int32_Int32_Impl_::mul($a2->low, $b2->high) + haxe__Int32_Int32_Impl_::mul($a2->high, $b2->low) << haxe__Int32_Int32_Impl_::$extraBits >> haxe__Int32_Int32_Impl_::$extraBits) << haxe__Int32_Int32_Impl_::$extraBits;
			$high2 = $tmp17 >> haxe__Int32_Int32_Impl_::$extraBits;
			$x2 = new haxe__Int64____Int64($high2, $low2);
		...
		case 3:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low4, $this4->low) < 0) {
				++$high4;
				$tmp19 = $high4 << haxe__Int32_Int32_Impl_::$extraBits;
				$high4 = $tmp19 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x4 = new haxe__Int64____Int64($high4, $low4);
			...
			$x5 = new haxe__Int64____Int64($high5, $low5);
			$tmp21 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x5, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			$day = $tmp21 + 1;
			$offset = $this1[1];
		...
		case 5:{
			...
			$tmp31 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x13, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$month2 = $tmp31 + 1;
			$offset2 = $this1[1];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this25->low, $b5->low) < 0) {
				--$high14;
				$tmp32 = $high14 << haxe__Int32_Int32_Impl_::$extraBits;
				$high14 = $tmp32 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
		...
		case 6:{
			...
			$tmp34 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x15, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$year3 = $tmp34 + 1;
			$offset3 = $this1[1];
	...
	static function snapPrev($this1, $period) {
		...
		case 3:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this9->low, $b3->low) < 0) {
				--$high6;
				$tmp21 = $high6 << haxe__Int32_Int32_Impl_::$extraBits;
				$high6 = $tmp21 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x6 = new haxe__Int64____Int64($high6, $low6);
			return (new _hx_array(array(thx__DateTimeUtc_DateTimeUtc_Impl_::fromInt64($x6), $this8[1])));
		}break;
		case 4:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low7, $this10->low) < 0) {
				++$high7;
				$tmp22 = $high7 << haxe__Int32_Int32_Impl_::$extraBits;
				$high7 = $tmp22 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x7 = new haxe__Int64____Int64($high7, $low7);
			$wd = thx__DateTimeUtc_DateTimeUtc_Impl_::get_dayOfWeek($x7);
			$this12 = $this1[0];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low8, $this12->low) < 0) {
				++$high8;
				$tmp23 = $high8 << haxe__Int32_Int32_Impl_::$extraBits;
				$high8 = $tmp23 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x8 = new haxe__Int64____Int64($high8, $low8);
			$year1 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x8, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$this14 = $this1[0];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low9, $this14->low) < 0) {
				++$high9;
				$tmp24 = $high9 << haxe__Int32_Int32_Impl_::$extraBits;
				$high9 = $tmp24 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x9 = new haxe__Int64____Int64($high9, $low9);
			$month1 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x9, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$this16 = $this1[0];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low10, $this16->low) < 0) {
				++$high10;
				$tmp25 = $high10 << haxe__Int32_Int32_Impl_::$extraBits;
				$high10 = $tmp25 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x10 = new haxe__Int64____Int64($high10, $low10);
			$tmp26 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x10, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			$day1 = $tmp26 - $wd;
			$offset1 = $this1[1];
			$dateTime1 = thx__DateTimeUtc_DateTimeUtc_Impl_::create($year1, $month1, $day1, 0, 0, 0, 0);
			$this18 = (new _hx_array(array($dateTime1, $offset1)));
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this19->low, $b4->low) < 0) {
				--$high11;
				$tmp27 = $high11 << haxe__Int32_Int32_Impl_::$extraBits;
				$high11 = $tmp27 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x11 = new haxe__Int64____Int64($high11, $low11);
			return (new _hx_array(array(thx__DateTimeUtc_DateTimeUtc_Impl_::fromInt64($x11), $this18[1])));
		}break;
		case 5:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low12, $this20->low) < 0) {
				++$high12;
				$tmp28 = $high12 << haxe__Int32_Int32_Impl_::$extraBits;
				$high12 = $tmp28 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x12 = new haxe__Int64____Int64($high12, $low12);
			$year2 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x12, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$this22 = $this1[0];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low13, $this22->low) < 0) {
				++$high13;
				$tmp29 = $high13 << haxe__Int32_Int32_Impl_::$extraBits;
				$high13 = $tmp29 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x13 = new haxe__Int64____Int64($high13, $low13);
		...
		case 6:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low15, $this26->low) < 0) {
				++$high15;
				$tmp31 = $high15 << haxe__Int32_Int32_Impl_::$extraBits;
				$high15 = $tmp31 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x15 = new haxe__Int64____Int64($high15, $low15);
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this29->low, $b6->low) < 0) {
				--$high16;
				$tmp32 = $high16 << haxe__Int32_Int32_Impl_::$extraBits;
				$high16 = $tmp32 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x16 = new haxe__Int64____Int64($high16, $low16);
			return (new _hx_array(array(thx__DateTimeUtc_DateTimeUtc_Impl_::fromInt64($x16), $this28[1])));
		}break;
	...
	static function snapTo($this1, $period) {
		...
		case 3:{
			...
			$x3 = new haxe__Int64____Int64($high3, $low3);
			$tmp19 = thx__DateTimeUtc_DateTimeUtc_Impl_::get_hour($x3);
			if($tmp19 >= 12) {
				$mod = 1;
			} else {
				$mod = 0;
			...
			$x6 = new haxe__Int64____Int64($high6, $low6);
			$tmp23 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x6, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			$day = $tmp23 + $mod;
			$offset = $this1[1];
			$dateTime = thx__DateTimeUtc_DateTimeUtc_Impl_::create($year, $month, $day, 0, 0, 0, 0);
		...
		case 4:{
			...
			if($wd < 3) {
				...
				if($wd > 3) {
					...
					$x9 = new haxe__Int64____Int64($high9, $low9);
					$tmp27 = thx__DateTimeUtc_DateTimeUtc_Impl_::get_hour($x9);
					if($tmp27 < 12) {
						$mod1 = -$wd;
					} else {
						$mod1 = 7 - $wd;
			...
			$x12 = new haxe__Int64____Int64($high12, $low12);
			$tmp31 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x12, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			$day1 = $tmp31 + $mod1;
			$offset1 = $this1[1];
			$dateTime1 = thx__DateTimeUtc_DateTimeUtc_Impl_::create($year1, $month1, $day1, 0, 0, 0, 0);
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this23->low, $b4->low) < 0) {
				--$high13;
				$tmp32 = $high13 << haxe__Int32_Int32_Impl_::$extraBits;
				$high13 = $tmp32 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x13 = new haxe__Int64____Int64($high13, $low13);
		...
		case 5:{
			...
			$x14 = new haxe__Int64____Int64($high14, $low14);
			$tmp34 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x14, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_DAY);
			$this26 = $this1[0];
			$this27 = $this1[1];
			$high15 = $this26->high + $this27->high << haxe__Int32_Int32_Impl_::$extraBits >> haxe__Int32_Int32_Impl_::$extraBits;
			$low15 = $this26->low + $this27->low << haxe__Int32_Int32_Impl_::$extraBits >> haxe__Int32_Int32_Impl_::$extraBits;
			if(haxe__Int32_Int32_Impl_::ucompare($low15, $this26->low) < 0) {
				++$high15;
				$tmp35 = $high15 << haxe__Int32_Int32_Impl_::$extraBits;
				$high15 = $tmp35 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x15 = new haxe__Int64____Int64($high15, $low15);
			$tmp36 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x15, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$this28 = $this1[0];
			$this29 = $this1[1];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low16, $this28->low) < 0) {
				++$high16;
				$tmp37 = $high16 << haxe__Int32_Int32_Impl_::$extraBits;
				$high16 = $tmp37 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x16 = new haxe__Int64____Int64($high16, $low16);
			$tmp38 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x16, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$tmp39 = Math::round(thx__DateTimeUtc_DateTimeUtc_Impl_::daysInMonth($tmp36, $tmp38) / 2);
			if($tmp34 > $tmp39) {
				$mod2 = 1;
			} else {
				$mod2 = 0;
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low17, $this30->low) < 0) {
				++$high17;
				$tmp40 = $high17 << haxe__Int32_Int32_Impl_::$extraBits;
				$high17 = $tmp40 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low18, $this32->low) < 0) {
				++$high18;
				$tmp41 = $high18 << haxe__Int32_Int32_Impl_::$extraBits;
				$high18 = $tmp41 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x18 = new haxe__Int64____Int64($high18, $low18);
			$tmp42 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x18, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_MONTH);
			$month2 = $tmp42 + $mod2;
			$offset2 = $this1[1];
			$dateTime2 = thx__DateTimeUtc_DateTimeUtc_Impl_::create($year2, $month2, 1, 0, 0, 0, 0);
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this35->low, $b5->low) < 0) {
				--$high19;
				$tmp43 = $high19 << haxe__Int32_Int32_Impl_::$extraBits;
				$high19 = $tmp43 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
		...
		case 6:{
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low20, $this36->low) < 0) {
				++$high20;
				$tmp44 = $high20 << haxe__Int32_Int32_Impl_::$extraBits;
				$high20 = $tmp44 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			...
			if(haxe__Int32_Int32_Impl_::ucompare($low22, $this40->low) < 0) {
				++$high22;
				$tmp46 = $high22 << haxe__Int32_Int32_Impl_::$extraBits;
				$high22 = $tmp46 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
			$x22 = new haxe__Int64____Int64($high22, $low22);
			$tmp47 = thx__DateTimeUtc_DateTimeUtc_Impl_::getDatePart($x22, thx__DateTimeUtc_DateTimeUtc_Impl_::$DATE_PART_YEAR);
			$year4 = $tmp47 + $mod3;
			$offset4 = $this1[1];
			...
			if(haxe__Int32_Int32_Impl_::ucompare($this43->low, $b7->low) < 0) {
				--$high23;
				$tmp48 = $high23 << haxe__Int32_Int32_Impl_::$extraBits;
				$high23 = $tmp48 >> haxe__Int32_Int32_Impl_::$extraBits;
			}
