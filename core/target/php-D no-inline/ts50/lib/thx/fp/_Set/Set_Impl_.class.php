...
class thx_fp__Set_Set_Impl_ {
	...
	static function foldLeft($this1, $b, $f) {
		...
		case 1:{
			...
			$tmp1 = thx_fp__Set_Set_Impl_::foldLeft($l, $tmp, $f);
			return thx_fp__Set_Set_Impl_::foldLeft($r, $tmp1, $f);
		}break;
		}
	}
	static function insert($this1, $x, $comparator) {
		...
		case 1:{
			...
			switch(Type::enumIndex($_g)) {
			case 0:{
				$tmp = thx_fp__Set_Set_Impl_::insert($l, $x, $comparator);
				return thx_fp__Set_Set_Impl_::balance($l, $y, $tmp, $r);
			}break;
			case 1:{
				$tmp1 = thx_fp__Set_Set_Impl_::insert($r, $x, $comparator);
				return thx_fp__Set_Set_Impl_::balance($r, $y, $l, $tmp1);
			}break;
			case 2:{
	...
	static function mapList($this1, $f) {
		...
		case 1:{
			...
			$tmp = thx_fp__Set_Set_Impl_::mapList($l, $f);
			$tmp1 = thx_fp__Set_Set_Impl_::mapList($r, $f);
			$xs = thx_fp__List_List_Impl_::concat($tmp, $tmp1);
	...
	static function doubleLeft($x1, $t1, $r) {
		if(Type::enumIndex($r) === 1) {
			if(Type::enumIndex(_hx_deref($r)->params[2]) === 1) {
	...
	static function doubleRight($x1, $l, $t4) {
		if(Type::enumIndex($l) === 1) {
			if(Type::enumIndex(_hx_deref($l)->params[3]) === 1) {
				$x2 = _hx_deref($l)->params[1];
				$t1 = _hx_deref($l)->params[2];
	...
	static function toList($this1) {
		...
		case 1:{
			...
			$tmp = thx_fp__Set_Set_Impl_::toList($l);
			$tmp1 = thx_fp__Set_Set_Impl_::toList($r);
			$xs = thx_fp__List_List_Impl_::concat($tmp, $tmp1);
			return thx_fp_ListImpl::Cons($x, $xs);
		}break;
		}
