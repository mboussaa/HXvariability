...
class thx_TestObjects {
	...
	public function testObjects() {
		...
		while($_g1 < $_g) {
			...
			$tuples->sort(array(new _hx_lambda(array(), "thx_TestObjects_0"), 'execute'));
			...
			unset($values,$tuples,$tmp6,$tmp5,$tmp4,$tmp3,$tmp2,$tmp1,$tmp,$ob1,$ob,$fields);
		}
	}
...
function thx_TestObjects_0($a, $b) {
	{
		return thx_Strings::compare($a->_0, $b->_0);
	}
}
