...
class thx_Convert {
	...
	static function toString($value) {
		...
		case 4:{
			try {
				return haxe_Json::stringify($value, null, null);
		...
		case 6:{
			...
			default:{
				$tmp1 = thx_Maps::isMap($value);
				if($tmp1) {
					try {
						$tmp2 = thx_Maps::toObject($value);
						return haxe_Json::stringify($tmp2, null, null);
					}catch(Exception $__hx__e) {
						$_ex_ = ($__hx__e instanceof HException) && $__hx__e->getCode() == null ? $__hx__e->e : $__hx__e;
						$e1 = $_ex_;
						{
	...
	static function toInt($value) {
		...
		$_g = thx_Types::valueTypeToString($value);
		switch($_g) {
		case "Bool":{
			if($value) {
				return 1;
		...
		case "String":{
			$tmp = thx_Ints::canParse($value);
			if($tmp) {
				return thx_Ints::parse($value, null);
			} else {
				$tmp1 = Std::string($value);
				throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to Int", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 48, "className" => "thx.Convert", "methodName" => "toInt"))));
			}
		}break;
		default:{
	...
	static function toFloat($value) {
		...
		case "String":{
			$tmp = thx_Floats::canParse($value);
			if($tmp) {
				return thx_Floats::parse($value);
			} else {
				$tmp1 = Std::string($value);
				throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to Float", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 67, "className" => "thx.Convert", "methodName" => "toFloat"))));
			}
		}break;
		default:{
			$tmp2 = Std::string($value);
	...
	static function toBool($value) {
		...
		case "String":{
			$tmp = thx_Bools::canParse($value);
			if($tmp) {
				return thx_Bools::parse($value);
			} else {
				$tmp1 = Std::string($value);
				throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to Bool", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 84, "className" => "thx.Convert", "methodName" => "toBool"))));
			}
		}break;
		default:{
			$tmp2 = Std::string($value);
	...
	static function toDate($value) {
		...
		case "String":{
			try {
				...
				{
					$tmp = Std::string($value);
					throw new HException(new thx_Error("unable to convert string " . _hx_string_or_null($tmp) . " to Date", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 100, "className" => "thx.Convert", "methodName" => "toDate"))));
				}
			}
		}break;
		default:{
			$tmp1 = Std::string($value);
			throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to Date", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 104, "className" => "thx.Convert", "methodName" => "toDate"))));
		}break;
		}
	}
	...
	static function toDateTime($value) {
		...
		case "String":{
			try {
				...
				{
					$tmp = Std::string($value);
					throw new HException(new thx_Error("unable to convert string " . _hx_string_or_null($tmp) . " to DateTime", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 120, "className" => "thx.Convert", "methodName" => "toDateTime"))));
				}
			}
		}break;
		default:{
			$tmp1 = Std::string($value);
			throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to DateTime", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 124, "className" => "thx.Convert", "methodName" => "toDateTime"))));
		}break;
		}
	}
	...
	static function toDateTimeUtc($value) {
		...
		case "String":{
			try {
				...
				{
					$tmp = Std::string($value);
					throw new HException(new thx_Error("unable to convert string " . _hx_string_or_null($tmp) . " to DateTimeUtc", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 142, "className" => "thx.Convert", "methodName" => "toDateTimeUtc"))));
				}
			}
		}break;
		default:{
			$tmp1 = Std::string($value);
			throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp1) . " to DateTimeUtc", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 146, "className" => "thx.Convert", "methodName" => "toDateTimeUtc"))));
		}break;
		}
	}
	...
	static function toObject($value) {
		...
		if($_g === "String") {
			try {
				return haxe_Json::parse($value);
			}catch(Exception $__hx__e) {
				$_ex_ = ($__hx__e instanceof HException) && $__hx__e->getCode() == null ? $__hx__e->e : $__hx__e;
				$e = $_ex_;
				{
					$tmp1 = Std::string($value);
					throw new HException(new thx_Error("unable to convert string " . _hx_string_or_null($tmp1) . " to Object", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 165, "className" => "thx.Convert", "methodName" => "toObject"))));
				}
			}
		} else {
			$tmp2 = Std::string($value);
			throw new HException(new thx_Error("unable to convert " . _hx_string_or_null($tmp2) . " to Object", null, _hx_anonymous(array("fileName" => "Convert.hx", "lineNumber" => 167, "className" => "thx.Convert", "methodName" => "toObject"))));
		}
	}
