...
class thx_TestFloats {
	...
	public function testNormalize() {
		...
		while($_g1 < $_g) {
			++$_g1;
			utest_Assert::floatEquals(0.0, thx_Floats::normalize(0.0), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 20, "className" => "thx.TestFloats", "methodName" => "testNormalize")));
			utest_Assert::floatEquals(1.0, thx_Floats::normalize(1.0), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 21, "className" => "thx.TestFloats", "methodName" => "testNormalize")));
			utest_Assert::floatEquals(0.5, thx_Floats::normalize(0.5), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 22, "className" => "thx.TestFloats", "methodName" => "testNormalize")));
			utest_Assert::floatEquals(0.0, thx_Floats::normalize(-1.0), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 23, "className" => "thx.TestFloats", "methodName" => "testNormalize")));
			utest_Assert::floatEquals(1.0, thx_Floats::normalize(10.0), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 24, "className" => "thx.TestFloats", "methodName" => "testNormalize")));
		}
	}
	public function testClamp() {
		...
		while($_g1 < $_g) {
			++$_g1;
			utest_Assert::floatEquals(10, thx_Floats::clamp(0, 10, 100), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 29, "className" => "thx.TestFloats", "methodName" => "testClamp")));
			utest_Assert::floatEquals(10, thx_Floats::clamp(10, 10, 100), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 30, "className" => "thx.TestFloats", "methodName" => "testClamp")));
			utest_Assert::floatEquals(50, thx_Floats::clamp(50, 10, 100), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 31, "className" => "thx.TestFloats", "methodName" => "testClamp")));
			utest_Assert::floatEquals(100, thx_Floats::clamp(100, 10, 100), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 32, "className" => "thx.TestFloats", "methodName" => "testClamp")));
			utest_Assert::floatEquals(100, thx_Floats::clamp(110, 10, 100), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 33, "className" => "thx.TestFloats", "methodName" => "testClamp")));
		}
	}
	public function testClampSym() {
		...
		while($_g1 < $_g) {
			++$_g1;
			utest_Assert::floatEquals(-10, thx_Floats::clampSym(-100, 10), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 38, "className" => "thx.TestFloats", "methodName" => "testClampSym")));
			utest_Assert::floatEquals(10, thx_Floats::clampSym(100, 10), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 39, "className" => "thx.TestFloats", "methodName" => "testClampSym")));
			utest_Assert::floatEquals(0, thx_Floats::clampSym(0, 10), null, null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 40, "className" => "thx.TestFloats", "methodName" => "testClampSym")));
		}
	}
	public function testCompare() {
		...
		while($_g1 < $_g) {
			++$_g1;
			utest_Assert::equals(-1, thx_Floats::compare(1.0, 2.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 45, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(-1, thx_Floats::compare(1.0, 3.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 46, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(-1, thx_Floats::compare(-1.0, 3.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 47, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(-1, thx_Floats::compare(-2.0, -1.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 48, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			$tmp = thx_Floats::compare(-Math::$PI, Math::$PI);
			...
			utest_Assert::equals(0, thx_Floats::compare(1.0, 1.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 51, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(0, thx_Floats::compare(2.0, 2.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 52, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(0, thx_Floats::compare(-2.0, -2.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 53, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			$tmp1 = thx_Floats::compare(Math::$PI, Math::$PI);
			...
			utest_Assert::equals(1, thx_Floats::compare(1.0, -1.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 56, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(1, thx_Floats::compare(2.0, 1.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 57, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			utest_Assert::equals(1, thx_Floats::compare(-3.0, -56.0), null, _hx_anonymous(array("fileName" => "TestFloats.hx", "lineNumber" => 58, "className" => "thx.TestFloats", "methodName" => "testCompare")));
			$tmp2 = thx_Floats::compare(Math::$PI, -Math::$PI);
