...
class thx_TestAnonymousMap {
	...
	public function testFeatures() {
		...
		while($_g1 < $_g) {
			...
			$tmp5 = thx_Iterables::toArray($map);
			utest_Assert::same((new _hx_array(array("thx"))), $tmp5, null, null, null, _hx_anonymous(array("fileName" => "TestAnonymousMap.hx", "lineNumber" => 28, "className" => "thx.TestAnonymousMap", "methodName" => "testFeatures")));
			unset($tmp5,$tmp4,$tmp3,$tmp2,$tmp1,$tmp,$map);
		}
	}
