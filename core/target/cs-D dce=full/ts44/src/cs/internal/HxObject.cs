...
namespace haxe.lang {
	public class DynamicObject : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_lang_DynamicObject(global::haxe.lang.DynamicObject __temp_me21) {
			__temp_me21.__hx_hashes = new int[]{};
			__temp_me21.__hx_dynamics = new object[]{};
			__temp_me21.__hx_hashes_f = new int[]{};
			__temp_me21.__hx_dynamics_f = new double[]{};
		}
		
		
		public static void __hx_ctor_haxe_lang_DynamicObject(global::haxe.lang.DynamicObject __temp_me20, int[] __hx_hashes, object[] __hx_dynamics, int[] __hx_hashes_f, double[] __hx_dynamics_f) {
			...
			__temp_me20.__hx_length = __hx_hashes.Length;
			__temp_me20.__hx_length_f = __hx_hashes_f.Length;
		}
