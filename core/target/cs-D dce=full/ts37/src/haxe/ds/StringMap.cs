...
namespace haxe.ds {
	public class StringMap<T> : global::haxe.lang.HxObject, global::haxe.ds.StringMap, global::haxe.IMap<object, T> {
		...
		public static void __hx_ctor_haxe_ds_StringMap<T_c>(global::haxe.ds.StringMap<T_c> __temp_me31) {
			unchecked {
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr28 = new T_c[this.vals.Length];
								int __temp_i29 = -1;
								while ((  ++ __temp_i29 < this.vals.Length )) {
									object __temp_obj30 = ((object) (this.vals[__temp_i29]) );
									if (( __temp_obj30 != null )) {
										__temp_new_arr28[__temp_i29] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj30);
									}
									
								}
								
								new_me.vals = __temp_new_arr28;
							}
							else {
								new_me.vals = null;
							}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapKeyIterator<T_c>(global::haxe.ds._StringMap.StringMapKeyIterator<T_c> __temp_me32, global::haxe.ds.StringMap<T_c> m) {
			__temp_me32.m = m;
			__temp_me32.i = 0;
			__temp_me32.len = m.nBuckets;
		}
