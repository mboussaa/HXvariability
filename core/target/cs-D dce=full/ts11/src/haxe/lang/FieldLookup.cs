...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 102, 104, 105, 109, 113, 120, 4745537, 4846113, 4849249, 4947370, 4949376, 5144726, 5393365, 5442204, 5594513, 5594516, 5695307, 5741474, 5745035, 26061316, 52644165, 63559312, 67859554, 67859999, 69718249, 72452854, 74822897, 76061764, 78447857, 87367608, 99632527, 103479213, 109574339, 116192081, 142301684, 142895325, 143865495, 156956385, 160217260, 212244564, 240155668, 270118404, 286437776, 288025444, 302437830, 302979532, 307312293, 314003042, 328878574, 334695532, 345466806, 359333139, 399964207, 407283053, 409871691, 414504008, 418482770, 437335495, 440996547, 452737314, 478746067, 480756972, 482248426, 484018937, 501039929, 506461556, 509857466, 520590566, 528448451, 530261339, 596496232, 623100778, 625308696, 641357653, 641535602, 674203586, 691754853, 735026061, 735461151, 767112783, 815911746, 843587180, 872071561, 887574448, 891567758, 897845290, 922671056, 927738905, 934297389, 946786476, 961866285, 971992536, 985194240, 992442663, 993950564, 995006396, 999967216, 1002257126, 1018962181, 1046660463, 1067353468, 1071652316, 1084792286, 1102421591, 1103412149, 1111933837, 1113806382, 1114501250, 1158359328, 1170141094, 1170195731, 1171632074, 1172057283, 1181037546, 1202920542, 1204816148, 1224901875, 1232990044, 1245800482, 1246877401, 1247723251, 1247875546, 1269755426, 1275922997, 1280549057, 1280845662, 1282943179, 1313416818, 1324905541, 1329111435, 1352786672, 1365803947, 1395555037, 1413779326, 1428431209, 1428901784, 1429887281, 1447008734, 1457436259, 1492589217, 1503837296, 1504438184, 1516540973, 1531583505, 1532710347, 1537812987, 1547539107, 1548166113, 1553877950, 1568593144, 1604324540, 1614780307, 1620824029, 1621420777, 1622659719, 1623148745, 1639293562, 1640272491, 1648581351, 1669413332, 1675742188, 1705629508, 1723805383, 1768548618, 1771130534, 1781145963, 1800886518, 1801622666, 1813879407, 1830310359, 1861441745, 1864494649, 1867552145, 1870897157, 1894671199, 1914813385, 1915412854, 1916009602, 1926178603, 1981972957, 2022294396, 2025055113, 2048392659, 2049945213, 2082663554, 2084789794, 2113364337, 2127021138, 2140014923, 2143813817};
		
		protected static string[] fields = new string[]{"b", "f", "h", "i", "m", "q", "x", "__a", "add", "arr", "cls", "cur", "get", "len", "map", "pop", "pos", "run", "set", "sum", "teardown", "match", "addSuccesses", "start", "stats", "failures", "executeMethod", "successes", "remove", "packageName", "filter", "startTime", "progress", "hasSetup", "target", "resize", "result", "warnings", "method", "addErrors", "newline", "stackToString", "onPrecheck", "getPackage", "assertations", "_trace", "methodName", "hasErrors", "packageNames", "iterator", "indent", "dateutc", "lastIndexOf", "totals", "hasNext", "onAddFailures", "setHandler", "innerError", "message", "onStart", "reverse", "expireson", "nOccupied", "onTestComplete", "onAddWarnings", "insert", "dumpStack", "dispatch", "length", "getTime", "addAsync", "setupName", "hasTeardownError", "nextRun", "displaySuccessResults", "methods", "getClass", "addPackage", "onAddErrors", "setTimeout", "onAddSuccesses", "onTimeout", "asyncStack", "aggregator", "onTested", "addHeader", "addFailures", "cachedIndex", "checkTested", "globalPattern", "toString", "packages", "addWarnings", "getResults", "methodNames", "priority", "hashes", "runner", "hasAsyncError", "tomorrow", "displayHeader", "splice", "exists", "addResult", "addClass", "copy", "bindHandler", "date", "done", "head", "isOk", "item", "handler", "getOrCreateClass", "join", "list", "concat", "next", "hasTestError", "flattenPackage", "pack", "prev", "push", "root", "execute", "size", "sort", "quicksort", "vals", "wire", "completed", "spliceVoid", "errors", "cachedKey", "hasTeardown", "handlers", "stackItems", "tested", "runNext", "hasFailures", "timeout", "classNames", "addFixture", "createFixture", "hasWarnings", "concatNative", "nBuckets", "className", "hasTimeoutError", "runFixture", "onComplete", "existsClass", "offset", "__unsafe_get", "__unsafe_set", "indents", "indexOf", "lookup", "isMethod", "fileName", "unbindHandler", "onProgress", "toDynamic", "regex", "existsPackage", "classes", "__hx_constructs", "results", "fixtures", "teardownName", "customParams", "getOrCreatePackage", "addEvent", "onTestStart", "hasSetupError", "getPosition", "fixture", "__get", "__set", "testComplete", "lineNumber", "upperBound", "unshift", "_keys", "setup", "shift", "__hx_createEmpty", "addCase", "slice", "_handler", "complete"};
