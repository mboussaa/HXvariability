...
public class TS7 extends haxe.lang.HxObject
{
	...
	public TS7()
	{
		//line 4 "/HXvariability/core/test/TS7.hx"
	...
	{
		//line 7 "/HXvariability/core/test/TS7.hx"
		java.lang.String w = "";
		//line 8 "/HXvariability/core/test/TS7.hx"
		{
			//line 8 "/HXvariability/core/test/TS7.hx"
			int _g = 0;
			//line 8 "/HXvariability/core/test/TS7.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 8 "/HXvariability/core/test/TS7.hx"
				 ++ _g;
				//line 9 "/HXvariability/core/test/TS7.hx"
				w = arg;
			}
			
		}
		
		//line 10 "/HXvariability/core/test/TS7.hx"
		...
		//line 12 "/HXvariability/core/test/TS7.hx"
		int x = ((int) (haxe.lang.Runtime.toInt(haxe.root.Std.parseInt(w))) );
		//line 19 "/HXvariability/core/test/TS7.hx"
	...
	{
		//line 73 "/HXvariability/core/test/TS7.hx"
		utest.Runner runner = new utest.Runner();
		//line 74 "/HXvariability/core/test/TS7.hx"
		haxe.root.TS7.addTests(runner);
		//line 75 "/HXvariability/core/test/TS7.hx"
		utest.ui.Report.create(runner, null, null);
		//line 76 "/HXvariability/core/test/TS7.hx"
		runner.run();
	}
