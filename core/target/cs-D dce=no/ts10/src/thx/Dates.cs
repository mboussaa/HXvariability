...
namespace thx {
	public class Dates : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Dates(global::thx.Dates __temp_me93) {
		}
		...
		public static global::Date create(int year, global::haxe.lang.Null<int> month, global::haxe.lang.Null<int> day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second) {
			unchecked {
				global::haxe.lang.Null<int> __temp_second90 = ( ( ! (second.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (second) );
				global::haxe.lang.Null<int> __temp_minute89 = ( ( ! (minute.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (minute) );
				global::haxe.lang.Null<int> __temp_hour88 = ( ( ! (hour.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (hour) );
				global::haxe.lang.Null<int> __temp_day87 = ( ( ! (day.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (day) );
				global::haxe.lang.Null<int> __temp_month86 = ( ( ! (month.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (month) );
				__temp_minute89 = new global::haxe.lang.Null<int>(( (__temp_minute89).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_second90).@value) ) / 60 )) ))) ) ), true);
				__temp_second90 = new global::haxe.lang.Null<int>(((int) (( (__temp_second90).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_second90).@value < 0 )) {
					__temp_second90 = new global::haxe.lang.Null<int>(( (__temp_second90).@value + 60 ), true);
				}
				
				__temp_hour88 = new global::haxe.lang.Null<int>(( (__temp_hour88).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_minute89).@value) ) / 60 )) ))) ) ), true);
				__temp_minute89 = new global::haxe.lang.Null<int>(((int) (( (__temp_minute89).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_minute89).@value < 0 )) {
					__temp_minute89 = new global::haxe.lang.Null<int>(( (__temp_minute89).@value + 60 ), true);
				}
				
				__temp_day87 = new global::haxe.lang.Null<int>(( (__temp_day87).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_hour88).@value) ) / 24 )) ))) ) ), true);
				__temp_hour88 = new global::haxe.lang.Null<int>(((int) (( (__temp_hour88).@value % (new global::haxe.lang.Null<int>(24, true)).@value )) ), true);
				if (( (__temp_hour88).@value < 0 )) {
					__temp_hour88 = new global::haxe.lang.Null<int>(( (__temp_hour88).@value + 24 ), true);
				}
				
				if (global::haxe.lang.Runtime.eq((__temp_day87).toDynamic(), 0)) {
					{
						__temp_month86 = new global::haxe.lang.Null<int>(( (__temp_month86).@value - 1 ), true);
					}
					
					if (( (__temp_month86).@value < 0 )) {
						__temp_month86 = new global::haxe.lang.Null<int>(11, true);
						 -- year;
					}
					
					__temp_day87 = new global::haxe.lang.Null<int>(global::thx.Dates.daysInMonth(year, (__temp_month86).@value), true);
				}
				
				year += ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_month86).@value) ) / 12 )) ))) );
				__temp_month86 = new global::haxe.lang.Null<int>(((int) (( (__temp_month86).@value % (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
				if (( (__temp_month86).@value < 0 )) {
					__temp_month86 = new global::haxe.lang.Null<int>(( (__temp_month86).@value + 12 ), true);
				}
				
				int days = global::thx.Dates.daysInMonth(year, (__temp_month86).@value);
				while (( (__temp_day87).@value > days )) {
					if (( (__temp_day87).@value > days )) {
						__temp_day87 = new global::haxe.lang.Null<int>(((int) (( (__temp_day87).@value - (new global::haxe.lang.Null<int>(days, true)).@value )) ), true);
						{
							__temp_month86 = new global::haxe.lang.Null<int>(( (__temp_month86).@value + 1 ), true);
						}
					...
					if (( (__temp_month86).@value > 11 )) {
						__temp_month86 = new global::haxe.lang.Null<int>(((int) (( (__temp_month86).@value - (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
						 ++ year;
					}
					
					days = global::thx.Dates.daysInMonth(year, (__temp_month86).@value);
				}
				
				return new global::Date(year, (__temp_month86).@value, (__temp_day87).@value, (__temp_hour88).@value, (__temp_minute89).@value, (__temp_second90).@value);
			}
		}
		...
		public static bool nearEquals(global::Date self, global::Date other, global::haxe.lang.Null<int> units, global::thx.TimePeriod period) {
			unchecked {
				global::haxe.lang.Null<int> __temp_units91 = ( ( ! (units.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (units) );
				if (( null == period )) {
					period = global::thx.TimePeriod.Second;
				}
				
				if (( (__temp_units91).@value < 0 )) {
					__temp_units91 = new global::haxe.lang.Null<int>(( - ((__temp_units91).@value) ), true);
				}
				
				global::Date min = global::thx.Dates.jump(self, period, ( - ((__temp_units91).@value) ));
				global::Date max = global::thx.Dates.jump(self, period, (__temp_units91).@value);
		...
		public static global::Date snapToWeekDay(global::Date date, int day, global::haxe.lang.Null<int> firstDayOfWk) {
			unchecked {
				global::haxe.lang.Null<int> __temp_firstDayOfWk92 = ( ( ! (firstDayOfWk.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (firstDayOfWk) );
				int d = ((int) (global::haxe.lang.Runtime.toInt(((object) (date.date.DayOfWeek) ))) );
				int s = day;
				if (( s < (__temp_firstDayOfWk92).@value )) {
					s += 7;
				}
				
				if (( d < (__temp_firstDayOfWk92).@value )) {
					d += 7;
				}
