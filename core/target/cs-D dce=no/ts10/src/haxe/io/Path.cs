...
namespace haxe.io {
	public class Path : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_io_Path(global::haxe.io.Path __temp_me83, string path) {
			unchecked {
				switch (path) {
					case ".":
					case "..":
					{
						__temp_me83.dir = path;
						__temp_me83.file = "";
						return;
					}
				...
				if (( c1 < c2 )) {
					__temp_me83.dir = global::haxe.lang.StringExt.substr(path, 0, new global::haxe.lang.Null<int>(c2, true));
					path = global::haxe.lang.StringExt.substr(path, ( c2 + 1 ), default(global::haxe.lang.Null<int>));
					__temp_me83.backslash = true;
				}
				else if (( c2 < c1 )) {
					__temp_me83.dir = global::haxe.lang.StringExt.substr(path, 0, new global::haxe.lang.Null<int>(c1, true));
					path = global::haxe.lang.StringExt.substr(path, ( c1 + 1 ), default(global::haxe.lang.Null<int>));
				}
				else {
					__temp_me83.dir = null;
				}
				
				int cp = global::haxe.lang.StringExt.lastIndexOf(path, ".", default(global::haxe.lang.Null<int>));
				if (( cp != -1 )) {
					__temp_me83.ext = global::haxe.lang.StringExt.substr(path, ( cp + 1 ), default(global::haxe.lang.Null<int>));
					__temp_me83.file = global::haxe.lang.StringExt.substr(path, 0, new global::haxe.lang.Null<int>(cp, true));
				}
				else {
					__temp_me83.ext = null;
					__temp_me83.file = path;
				}
