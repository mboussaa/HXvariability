...
namespace haxe.io {
	public class BytesBuffer : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_io_BytesBuffer(global::haxe.io.BytesBuffer __temp_me78) {
			__temp_me78.b = new global::System.IO.MemoryStream();
		}
		
		
		public static new object __hx_createEmpty() {
			return new global::haxe.io.BytesBuffer(global::haxe.lang.EmptyObject.EMPTY);
		}
		...
		public void addString(string v) {
			global::haxe.io.Bytes src = global::haxe.io.Bytes.ofString(v);
			( this.b as global::System.IO.Stream ).Write(((byte[]) (src.b) ), ((int) (0) ), ((int) (src.length) ));
		}
		...
		public override object __hx_invokeField(string field, int hash, global::Array dynargs) {
			unchecked {
				switch (hash) {
					...
					case 1230265810:
					{
						this.addString(global::haxe.lang.Runtime.toString(dynargs[0]));
						break;
					}
