...
namespace haxe.ds {
	public class IntMap<T> : global::haxe.lang.HxObject, global::haxe.ds.IntMap, global::haxe.IMap<int, T> {
		...
		public static void __hx_ctor_haxe_ds_IntMap<T_c>(global::haxe.ds.IntMap<T_c> __temp_me58) {
			unchecked {
				__temp_me58.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr55 = new T_c[this.vals.Length];
								int __temp_i56 = -1;
								while ((  ++ __temp_i56 < this.vals.Length )) {
									object __temp_obj57 = ((object) (this.vals[__temp_i56]) );
									if (( __temp_obj57 != null )) {
										__temp_new_arr55[__temp_i56] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj57);
									}
									
								}
								
								new_me.vals = __temp_new_arr55;
							}
							else {
								new_me.vals = null;
							}
...
namespace haxe.ds._IntMap {
	public sealed class IntMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._IntMap.IntMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__IntMap_IntMapKeyIterator<T_c>(global::haxe.ds._IntMap.IntMapKeyIterator<T_c> __temp_me59, global::haxe.ds.IntMap<T_c> m) {
			__temp_me59.i = 0;
			__temp_me59.m = m;
			__temp_me59.len = m.nBuckets;
		}
...
namespace haxe.ds._IntMap {
	public sealed class IntMapValueIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._IntMap.IntMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__IntMap_IntMapValueIterator<T_c>(global::haxe.ds._IntMap.IntMapValueIterator<T_c> __temp_me60, global::haxe.ds.IntMap<T_c> m) {
			__temp_me60.i = 0;
			__temp_me60.m = m;
			__temp_me60.len = m.nBuckets;
		}
