...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me67) {
			unchecked {
				__temp_me67.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr61 = new V_c[this.vals.Length];
								int __temp_i62 = -1;
								while ((  ++ __temp_i62 < this.vals.Length )) {
									object __temp_obj63 = ((object) (this.vals[__temp_i62]) );
									if (( __temp_obj63 != null )) {
										__temp_new_arr61[__temp_i62] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj63);
									}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr64 = new K_c[this._keys.Length];
								int __temp_i65 = -1;
								while ((  ++ __temp_i65 < this._keys.Length )) {
									object __temp_obj66 = ((object) (this._keys[__temp_i65]) );
									if (( __temp_obj66 != null )) {
										__temp_new_arr64[__temp_i65] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj66);
									}
									
								}
								
								new_me._keys = __temp_new_arr64;
							}
							else {
								new_me._keys = null;
							}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me68, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me68.i = 0;
			__temp_me68.m = m;
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me69, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me69.i = 0;
			__temp_me69.m = m;
			__temp_me69.len = m.nBuckets;
		}
