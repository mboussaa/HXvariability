...
namespace sys.io {
	public class Process : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_sys_io_Process(global::sys.io.Process __temp_me85, string cmd, global::Array<object> args) {
			__temp_me85.native = global::sys.io.Process.createNativeProcess(cmd, args);
			__temp_me85.native.Start();
			__temp_me85.stdout = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me85.native.StandardOutput.BaseStream) ));
			__temp_me85.stderr = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me85.native.StandardError.BaseStream) ));
			__temp_me85.stdin = new global::cs.io.NativeOutput(((global::System.IO.Stream) (__temp_me85.native.StandardInput.BaseStream) ));
		}
