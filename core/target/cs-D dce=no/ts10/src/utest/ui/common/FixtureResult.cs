...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me119, string methodName) {
			__temp_me119.methodName = methodName;
			__temp_me119.list = new global::List<object>();
			__temp_me119.hasTestError = false;
			__temp_me119.hasSetupError = false;
			__temp_me119.hasTeardownError = false;
			__temp_me119.hasTimeoutError = false;
			__temp_me119.hasAsyncError = false;
			__temp_me119.stats = new global::utest.ui.common.ResultStats();
		}
