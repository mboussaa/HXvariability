...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me126) {
			__temp_me126.assertations = 0;
			__temp_me126.successes = 0;
			__temp_me126.failures = 0;
			__temp_me126.errors = 0;
			__temp_me126.warnings = 0;
			__temp_me126.isOk = true;
			__temp_me126.hasFailures = false;
			__temp_me126.hasErrors = false;
			__temp_me126.hasWarnings = false;
			__temp_me126.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me126.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me126.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me126.onAddWarnings = new global::utest.Dispatcher<int>();
		}
