...
namespace haxe {
	public class Timer : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_Timer(global::haxe.Timer __temp_me47, int time_ms) {
			unchecked {
				__temp_me47.run = ( (( global::haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current != null )) ? (global::haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current) : (global::haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current = ((global::haxe.Timer___hx_ctor_haxe_Timer_123__Fun) (new global::haxe.Timer___hx_ctor_haxe_Timer_123__Fun()) )) );
				global::haxe.Timer _gthis = __temp_me47;
				double dt = ( ((double) (time_ms) ) / 1000 );
				__temp_me47.@event = global::haxe.MainLoop.@add(new global::haxe.Timer___hx_ctor_haxe_Timer_72__Fun(dt, _gthis), default(global::haxe.lang.Null<int>));
				__temp_me47.@event.delay(new global::haxe.lang.Null<double>(dt, true));
			}
		}
