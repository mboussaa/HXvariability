...
namespace sys.io {
	public class Process : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_sys_io_Process(global::sys.io.Process __temp_me84, string cmd, global::Array<object> args) {
			__temp_me84.native = global::sys.io.Process.createNativeProcess(cmd, args);
			__temp_me84.native.Start();
			__temp_me84.stdout = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me84.native.StandardOutput.BaseStream) ));
			__temp_me84.stderr = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me84.native.StandardError.BaseStream) ));
			__temp_me84.stdin = new global::cs.io.NativeOutput(((global::System.IO.Stream) (__temp_me84.native.StandardInput.BaseStream) ));
		}
