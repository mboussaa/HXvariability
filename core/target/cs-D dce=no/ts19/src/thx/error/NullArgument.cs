...
namespace thx.error {
	public class NullArgument : global::thx.Error {
		...
		public static void __hx_ctor_thx_error_NullArgument(global::thx.error.NullArgument __temp_me90, string message, object posInfo) {
			global::thx.Error.__hx_ctor_thx_Error(__temp_me90, message, null, posInfo);
		}
