...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me111) {
			__temp_me111.assertations = 0;
			__temp_me111.successes = 0;
			__temp_me111.failures = 0;
			__temp_me111.errors = 0;
			__temp_me111.warnings = 0;
			__temp_me111.isOk = true;
			__temp_me111.hasFailures = false;
			__temp_me111.hasErrors = false;
			__temp_me111.hasWarnings = false;
			__temp_me111.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me111.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me111.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me111.onAddWarnings = new global::utest.Dispatcher<int>();
		}
