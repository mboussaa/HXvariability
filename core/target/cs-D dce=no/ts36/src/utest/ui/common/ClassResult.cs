...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me174, string className, string setupName, string teardownName) {
			__temp_me174.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me174.className = className;
			__temp_me174.setupName = setupName;
			__temp_me174.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me174.teardownName = teardownName;
			__temp_me174.hasTeardown =  ! (string.Equals(teardownName, null)) ;
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority173 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
