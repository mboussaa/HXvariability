...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me115) {
			__temp_me115.assertations = 0;
			__temp_me115.successes = 0;
			__temp_me115.failures = 0;
			__temp_me115.errors = 0;
			__temp_me115.warnings = 0;
			__temp_me115.isOk = true;
			__temp_me115.hasFailures = false;
			__temp_me115.hasErrors = false;
			__temp_me115.hasWarnings = false;
			__temp_me115.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me115.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me115.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me115.onAddWarnings = new global::utest.Dispatcher<int>();
		}
