...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me107, string className, string setupName, string teardownName) {
			__temp_me107.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me107.className = className;
			__temp_me107.setupName = setupName;
			__temp_me107.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me107.teardownName = teardownName;
			__temp_me107.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me107.methods = 0;
			__temp_me107.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority106 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority106) {
