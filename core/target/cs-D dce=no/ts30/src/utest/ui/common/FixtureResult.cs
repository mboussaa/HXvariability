...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me108, string methodName) {
			__temp_me108.methodName = methodName;
			__temp_me108.list = new global::List<object>();
			__temp_me108.hasTestError = false;
			__temp_me108.hasSetupError = false;
			__temp_me108.hasTeardownError = false;
			__temp_me108.hasTimeoutError = false;
			__temp_me108.hasAsyncError = false;
			__temp_me108.stats = new global::utest.ui.common.ResultStats();
		}
