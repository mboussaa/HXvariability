...
namespace utest {
	public class TestFixture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_TestFixture(global::utest.TestFixture __temp_me99, object target, string method, string setup, string teardown) {
			__temp_me99.target = target;
			__temp_me99.method = method;
			__temp_me99.setup = setup;
			__temp_me99.teardown = teardown;
		}
