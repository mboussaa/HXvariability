...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public static void __hx_ctor__Array<T_c>(global::Array<T_c> __temp_me6, T_c[] native) {
		__temp_me6.length = ( native as global::System.Array ).Length;
		__temp_me6.__a = native;
	}
	
	
	public static void __hx_ctor__Array<T_c>(global::Array<T_c> __temp_me5) {
		__temp_me5.length = 0;
		__temp_me5.__a = new T_c[0];
	}
		...
		unchecked {
			...
			while (( i < fields.length )) {
				...
				switch (field) {
					...
					{
						if (( this.__a != null )) {
							T_c[] __temp_new_arr2 = new T_c[this.__a.Length];
							int __temp_i3 = -1;
							while ((  ++ __temp_i3 < this.__a.Length )) {
								object __temp_obj4 = ((object) (this.__a[__temp_i3]) );
								if (( __temp_obj4 != null )) {
									__temp_new_arr2[__temp_i3] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj4);
								}
								
							}
							
							new_me.__a = __temp_new_arr2;
						}
						else {
							new_me.__a = null;
						}
...
namespace _Array {
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		...
		public static void __hx_ctor__Array_ArrayIterator<T_c>(global::_Array.ArrayIterator<T_c> __temp_me7, global::Array<T_c> a) {
			__temp_me7.arr = a;
			__temp_me7.len = a.length;
			__temp_me7.i = 0;
		}
