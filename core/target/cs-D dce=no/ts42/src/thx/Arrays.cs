...
namespace thx {
	public class Arrays : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Arrays(global::thx.Arrays __temp_me95) {
		}
		...
		public static global::Array<T> applyIndexes<T>(global::Array<T> array, global::Array<int> indexes, global::haxe.lang.Null<bool> incrementDuplicates) {
			unchecked {
				global::haxe.lang.Null<bool> __temp_incrementDuplicates92 = ( ( ! (incrementDuplicates.hasValue) ) ? (new global::haxe.lang.Null<bool>(false, true)) : (incrementDuplicates) );
				...
				if (((__temp_incrementDuplicates92)).@value) {
		...
		public static global::Array<int> rank<T>(global::Array<T> array, global::haxe.lang.Function compare, global::haxe.lang.Null<bool> incrementDuplicates) {
			global::haxe.lang.Null<bool> __temp_incrementDuplicates93 = ( ( ! (incrementDuplicates.hasValue) ) ? (new global::haxe.lang.Null<bool>(true, true)) : (incrementDuplicates) );
			...
			if (((__temp_incrementDuplicates93)).@value) {
				global::haxe.ds.IntMap<bool> usedIndexes = global::thx._Set.Set_Impl_.createInt(null);
		...
		public static global::Array<T> withSlice<T>(global::Array<T> arr, global::Array<T> other, int start, global::haxe.lang.Null<int> length) {
			global::haxe.lang.Null<int> __temp_length94 = ( ( ! (length.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (length) );
			return arr.slice(0, new global::haxe.lang.Null<int>(start, true)).concat(((global::Array<T>) (other) )).concat(arr.slice(( start + (__temp_length94).@value ), default(global::haxe.lang.Null<int>)));
		}
...
namespace thx {
	public class ArrayFloats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_ArrayFloats(global::thx.ArrayFloats __temp_me97) {
		}
		...
		public static global::Array<double> resize(global::Array<double> array, int length, global::haxe.lang.Null<double> fill) {
			double __temp_fill96 = ( ( ! (fill.hasValue) ) ? (0.0) : ((fill).@value) );
			while (( array.length < length )) {
				array.push(__temp_fill96);
			}
...
namespace thx {
	public class ArrayInts : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_ArrayInts(global::thx.ArrayInts __temp_me99) {
		}
		...
		public static global::Array<int> resize(global::Array<int> array, int length, global::haxe.lang.Null<int> fill) {
			int __temp_fill98 = ( ( ! (fill.hasValue) ) ? (0) : ((fill).@value) );
			while (( array.length < length )) {
...
namespace thx {
	public class ArrayStrings : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_ArrayStrings(global::thx.ArrayStrings __temp_me100) {
		}
