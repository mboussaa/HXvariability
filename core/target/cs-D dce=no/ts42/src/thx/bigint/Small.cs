...
namespace thx.bigint {
	public class Small : global::haxe.lang.HxObject, global::thx.bigint.BigIntImpl {
		...
		public static void __hx_ctor_thx_bigint_Small(global::thx.bigint.Small __temp_me104, int @value) {
			__temp_me104.sign = ( @value < 0 );
			__temp_me104.@value = @value;
			__temp_me104.isSmall = true;
		}
