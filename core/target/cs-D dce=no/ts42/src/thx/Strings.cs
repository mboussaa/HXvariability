...
namespace thx {
	public class Strings : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Strings(global::thx.Strings __temp_me189) {
		}
		...
		public static string capitalizeWords(string @value, global::haxe.lang.Null<bool> whiteSpaceOnly) {
			unchecked {
				global::haxe.lang.Null<bool> __temp_whiteSpaceOnly184 = ( ( ! (whiteSpaceOnly.hasValue) ) ? (new global::haxe.lang.Null<bool>(false, true)) : (whiteSpaceOnly) );
				if (((__temp_whiteSpaceOnly184)).@value) {
		...
		public static string ellipsis(string s, global::haxe.lang.Null<int> maxlen, string symbol) {
			unchecked {
				...
				global::haxe.lang.Null<int> __temp_maxlen185 = ( ( ! (maxlen.hasValue) ) ? (new global::haxe.lang.Null<int>(20, true)) : (maxlen) );
				int sl = s.Length;
				int symboll = symbol.Length;
				if (( sl > (__temp_maxlen185).@value )) {
					if (( (__temp_maxlen185).@value < symboll )) {
						return global::haxe.lang.StringExt.substr(symbol, ( symboll - (__temp_maxlen185).@value ), __temp_maxlen185);
					}
					else {
						return global::haxe.lang.Runtime.concat(global::haxe.lang.StringExt.substr(s, 0, new global::haxe.lang.Null<int>(( (__temp_maxlen185).@value - symboll ), true)), symbol);
					}
		...
		public static string ellipsisMiddle(string s, global::haxe.lang.Null<int> maxlen, string symbol) {
			unchecked {
				...
				global::haxe.lang.Null<int> __temp_maxlen186 = ( ( ! (maxlen.hasValue) ) ? (new global::haxe.lang.Null<int>(20, true)) : (maxlen) );
				int sl = s.Length;
				int symboll = symbol.Length;
				if (( sl > (__temp_maxlen186).@value )) {
					if (( (__temp_maxlen186).@value <= symboll )) {
						return global::thx.Strings.ellipsis(s, __temp_maxlen186, symbol);
					}
					
					int hll = ((int) (global::System.Math.Ceiling(((double) (( ((double) ((( (__temp_maxlen186).@value - symboll ))) ) / 2 )) ))) );
					int hlr = ((int) (global::System.Math.Floor(((double) (( ((double) ((( (__temp_maxlen186).@value - symboll ))) ) / 2 )) ))) );
		...
		public static string random(string @value, global::haxe.lang.Null<int> length) {
			unchecked {
				int __temp_length187 = ( ( ! (length.hasValue) ) ? (1) : ((length).@value) );
				return global::haxe.lang.StringExt.substr(@value, ((int) (global::System.Math.Floor(((double) (( (( ( @value.Length - __temp_length187 ) + 1 )) * global::Math.rand.NextDouble() )) ))) ), new global::haxe.lang.Null<int>(__temp_length187, true));
			}
		}
		...
		public static string wrapColumns(string s, global::haxe.lang.Null<int> columns, string indent, string newline) {
			unchecked {
				...
				int __temp_columns188 = ( ( ! (columns.hasValue) ) ? (78) : ((columns).@value) );
				return global::thx.Strings.SPLIT_LINES.split(s).map<object>(((global::haxe.lang.Function) (new global::thx.Strings_wrapColumns_609__Fun(newline, indent, __temp_columns188)) )).@join(newline);
			}
		}
...
namespace thx {
	public class Strings_wrapColumns_609__Fun : global::haxe.lang.Function {
		...
		public Strings_wrapColumns_609__Fun(string newline, string indent, int __temp_columns188) : base(1, 0) {
			this.newline = newline;
			this.indent = indent;
			this.__temp_columns188 = __temp_columns188;
		}
		...
		public override object __hx_invoke1_o(double __fn_float1, object __fn_dyn1) {
			...
			return global::thx.Strings.wrapLine(global::thx.Strings.WSG.replace(part, " ").Trim(), this.__temp_columns188, this.indent, this.newline);
		}
