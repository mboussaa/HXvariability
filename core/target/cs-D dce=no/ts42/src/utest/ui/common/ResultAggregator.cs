...
namespace utest.ui.common {
	public class ResultAggregator : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultAggregator(global::utest.ui.common.ResultAggregator __temp_me228, global::utest.Runner runner, global::haxe.lang.Null<bool> flattenPackage) {
			bool __temp_flattenPackage227 = ( ( ! (flattenPackage.hasValue) ) ? (false) : ((flattenPackage).@value) );
			if (( runner == null )) {
				throw global::haxe.lang.HaxeException.wrap("runner argument is null");
			}
			
			__temp_me228.flattenPackage = __temp_flattenPackage227;
			__temp_me228.runner = runner;
			runner.onStart.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me228, "start", 67859554)) ));
			runner.onProgress.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me228, "progress", 103479213)) ));
			runner.onComplete.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me228, "complete", 2143813817)) ));
			__temp_me228.onStart = new global::utest.Notifier();
			__temp_me228.onComplete = new global::utest.Dispatcher<object>();
			__temp_me228.onProgress = new global::utest.Dispatcher<object>();
		}
