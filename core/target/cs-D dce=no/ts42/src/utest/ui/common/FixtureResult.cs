...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me222, string methodName) {
			__temp_me222.methodName = methodName;
			__temp_me222.list = new global::List<object>();
			__temp_me222.hasTestError = false;
			__temp_me222.hasSetupError = false;
			__temp_me222.hasTeardownError = false;
			__temp_me222.hasTimeoutError = false;
			__temp_me222.hasAsyncError = false;
			__temp_me222.stats = new global::utest.ui.common.ResultStats();
		}
