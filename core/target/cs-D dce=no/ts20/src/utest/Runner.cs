...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me100) {
			__temp_me100.globalPattern = null;
			__temp_me100.fixtures = new global::Array<object>();
			__temp_me100.onProgress = new global::utest.Dispatcher<object>();
			__temp_me100.onStart = new global::utest.Dispatcher<object>();
			__temp_me100.onComplete = new global::utest.Dispatcher<object>();
			__temp_me100.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me100.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me100.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me100.length = 0;
		}
