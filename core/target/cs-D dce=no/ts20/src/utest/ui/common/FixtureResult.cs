...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me110, string methodName) {
			__temp_me110.methodName = methodName;
			__temp_me110.list = new global::List<object>();
			__temp_me110.hasTestError = false;
			__temp_me110.hasSetupError = false;
			__temp_me110.hasTeardownError = false;
			__temp_me110.hasTimeoutError = false;
			__temp_me110.hasAsyncError = false;
			__temp_me110.stats = new global::utest.ui.common.ResultStats();
		}
