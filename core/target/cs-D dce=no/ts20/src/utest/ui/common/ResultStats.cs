...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me117) {
			__temp_me117.assertations = 0;
			__temp_me117.successes = 0;
			__temp_me117.failures = 0;
			__temp_me117.errors = 0;
			__temp_me117.warnings = 0;
			__temp_me117.isOk = true;
			__temp_me117.hasFailures = false;
			__temp_me117.hasErrors = false;
			__temp_me117.hasWarnings = false;
			__temp_me117.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me117.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me117.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me117.onAddWarnings = new global::utest.Dispatcher<int>();
		}
