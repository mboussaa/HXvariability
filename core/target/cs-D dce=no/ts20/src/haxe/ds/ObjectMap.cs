...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me66) {
			unchecked {
				__temp_me66.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr60 = new V_c[this.vals.Length];
								int __temp_i61 = -1;
								while ((  ++ __temp_i61 < this.vals.Length )) {
									object __temp_obj62 = ((object) (this.vals[__temp_i61]) );
									if (( __temp_obj62 != null )) {
										__temp_new_arr60[__temp_i61] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj62);
									}
									
								}
								
								new_me.vals = __temp_new_arr60;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr63 = new K_c[this._keys.Length];
								int __temp_i64 = -1;
								while ((  ++ __temp_i64 < this._keys.Length )) {
									object __temp_obj65 = ((object) (this._keys[__temp_i64]) );
									if (( __temp_obj65 != null )) {
										__temp_new_arr63[__temp_i64] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj65);
									}
									
								}
								
								new_me._keys = __temp_new_arr63;
							}
							else {
								new_me._keys = null;
							}
		...
		public virtual string toString() {
			...
			while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(it, "hasNext", 407283053, null))) {
				K i = global::haxe.lang.Runtime.genericCast<K>(global::haxe.lang.Runtime.callField(it, "next", 1224901875, null));
				s_b.Append(((string) (global::Std.@string(global::Std.@string(i))) ));
				s_b.Append(((string) (" => ") ));
				s_b.Append(((string) (global::Std.@string(global::Std.@string((this.@get(i)).toDynamic()))) ));
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me67, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me67.i = 0;
			__temp_me67.m = m;
			__temp_me67.len = m.nBuckets;
		}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me68, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me68.i = 0;
			__temp_me68.m = m;
			__temp_me68.len = m.nBuckets;
		}
