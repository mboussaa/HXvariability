...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me188) {
			__temp_me188.assertations = 0;
			__temp_me188.successes = 0;
			__temp_me188.failures = 0;
			__temp_me188.errors = 0;
			__temp_me188.warnings = 0;
			__temp_me188.isOk = true;
			__temp_me188.hasFailures = false;
			__temp_me188.hasErrors = false;
			__temp_me188.hasWarnings = false;
			__temp_me188.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me188.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me188.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me188.onAddWarnings = new global::utest.Dispatcher<int>();
		}
