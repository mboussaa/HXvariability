...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me180, string className, string setupName, string teardownName) {
			__temp_me180.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me180.className = className;
			__temp_me180.setupName = setupName;
			__temp_me180.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me180.teardownName = teardownName;
			__temp_me180.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me180.methods = 0;
			__temp_me180.stats = new global::utest.ui.common.ResultStats();
		}
