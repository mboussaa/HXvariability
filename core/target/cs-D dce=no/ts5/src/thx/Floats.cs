...
namespace thx {
	public class Floats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Floats(global::thx.Floats __temp_me130) {
		}
		...
		public static double angleDifference(double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				double r = ( (( b - a )) % (__temp_turn121).@value );
				if (( r < 0 )) {
					r += (__temp_turn121).@value;
				}
				
				if (( r > ( (__temp_turn121).@value / 2 ) )) {
					r -= (__temp_turn121).@value;
				}
		...
		public static double interpolateAngle(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, ( a + global::thx.Floats.angleDifference(a, b, new global::haxe.lang.Null<double>(__temp_turn122, true)) )), __temp_turn122);
			}
		}
		...
		public static double interpolateAngleWidest(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				return global::thx.Floats.wrapCircular(( global::thx.Floats.interpolateAngle(f, a, b, new global::haxe.lang.Null<double>(__temp_turn123, true)) - ( __temp_turn123 / 2 ) ), __temp_turn123);
			}
		}
		...
		public static double interpolateAngleCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				a = global::thx.Floats.wrapCircular(a, __temp_turn124);
				b = global::thx.Floats.wrapCircular(b, __temp_turn124);
				if (( b < a )) {
					b += __temp_turn124;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn124);
			}
		}
		...
		public static double interpolateAngleCCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				a = global::thx.Floats.wrapCircular(a, __temp_turn125);
				b = global::thx.Floats.wrapCircular(b, __temp_turn125);
				if (( b > a )) {
					b -= __temp_turn125;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn125);
			}
		}
		...
		public static bool nearEquals(double a, double b, global::haxe.lang.Null<double> tollerance) {
			...
			if ((  ! (global::System.Double.IsInfinity(((double) (a) )))  &&  ! (global::System.Double.IsNaN(((double) (a) )))  )) {
				return ( global::System.Math.Abs(((double) (( a - b )) )) <= (__temp_tollerance126).@value );
			}
		...
		public static bool nearEqualAngles(double a, double b, global::haxe.lang.Null<double> turn, global::haxe.lang.Null<double> tollerance) {
			...
			global::haxe.lang.Null<double> __temp_turn127 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
			return ( global::System.Math.Abs(((double) (global::thx.Floats.angleDifference(a, b, __temp_turn127)) )) <= (__temp_tollerance128).@value );
		}
		
		
		public static bool nearZero(double n, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance129 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			return ( global::System.Math.Abs(((double) (n) )) <= (__temp_tollerance129).@value );
		}
