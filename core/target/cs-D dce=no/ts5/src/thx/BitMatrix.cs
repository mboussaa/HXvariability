...
namespace thx._BitMatrix {
	public sealed class BitMatrix_Impl_ {
		...
		public static global::Array<object> _new(global::haxe.lang.Null<int> bitSetCount, global::haxe.lang.Null<int> length) {
			global::haxe.lang.Null<int> __temp_length101 = ( ( ! (length.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (length) );
			global::haxe.lang.Null<int> __temp_bitSetCount100 = ( ( ! (bitSetCount.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (bitSetCount) );
			return global::thx._BitMatrix.BitMatrix_Impl_.empty(__temp_bitSetCount100, __temp_length101);
		}
		
		
		public static global::Array<object> empty(global::haxe.lang.Null<int> bitSetCount, global::haxe.lang.Null<int> length) {
			unchecked {
				global::haxe.lang.Null<int> __temp_length103 = ( ( ! (length.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (length) );
				global::haxe.lang.Null<int> __temp_bitSetCount102 = ( ( ! (bitSetCount.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (bitSetCount) );
				global::Array<object> bitMatrix = new global::Array<object>(new object[]{});
				{
					int _g1 = 0;
					int _g = (__temp_bitSetCount102).@value;
					while (( _g1 < _g )) {
						int bitSetIndex = _g1++;
						int length1 = (__temp_length103).@value;
