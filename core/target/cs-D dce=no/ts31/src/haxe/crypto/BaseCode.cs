...
namespace haxe.crypto {
	public class BaseCode : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_crypto_BaseCode(global::haxe.crypto.BaseCode __temp_me53, global::haxe.io.Bytes @base) {
			unchecked {
				int len = @base.length;
				int nbits = 1;
				while (( len > ( 1 << nbits ) )) {
				...
				__temp_me53.@base = @base;
				__temp_me53.nbits = nbits;
			}
		}
		
		
		public static string encode(string s, string @base) {
			return new global::haxe.crypto.BaseCode(((global::haxe.io.Bytes) (global::haxe.io.Bytes.ofString(@base)) )).encodeString(s);
		}
		
		
		public static string decode(string s, string @base) {
			return new global::haxe.crypto.BaseCode(((global::haxe.io.Bytes) (global::haxe.io.Bytes.ofString(@base)) )).decodeString(s);
		}
		
		
		public static new object __hx_createEmpty() {
			return new global::haxe.crypto.BaseCode(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) ));
		}
		
		
		public static new object __hx_create(global::Array arr) {
			return new global::haxe.crypto.BaseCode(((global::haxe.io.Bytes) (arr[0]) ));
		}
		...
		public virtual string encodeString(string s) {
			return this.encodeBytes(global::haxe.io.Bytes.ofString(s)).toString();
		}
		
		
		public virtual string decodeString(string s) {
			return this.decodeBytes(global::haxe.io.Bytes.ofString(s)).toString();
		}
