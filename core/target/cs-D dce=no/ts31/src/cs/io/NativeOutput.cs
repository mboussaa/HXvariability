...
namespace cs.io {
	public class NativeOutput : global::haxe.io.Output {
		...
		public static void __hx_ctor_cs_io_NativeOutput(global::cs.io.NativeOutput __temp_me36, global::System.IO.Stream stream) {
			__temp_me36.stream = stream;
			if ( ! (stream.CanWrite) ) {
		...
		public virtual void seek(int p, global::sys.io.FileSeek pos) {
			unchecked {
				global::System.IO.SeekOrigin p1 = default(global::System.IO.SeekOrigin);
				switch (pos.index) {
					case 0:
					{
						p1 = global::System.IO.SeekOrigin.Begin;
						break;
					}
					...
					case 1:
					{
						p1 = global::System.IO.SeekOrigin.Current;
						break;
					}
					...
					case 2:
					{
						p1 = global::System.IO.SeekOrigin.End;
						break;
					}
				...
				this.stream.Seek(((long) (((object) (p1) )) ), ((global::System.IO.SeekOrigin) (p1) ));
			}
		}
