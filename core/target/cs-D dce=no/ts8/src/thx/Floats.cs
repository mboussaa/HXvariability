...
namespace thx {
	public class Floats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Floats(global::thx.Floats __temp_me127) {
		}
		...
		public static double angleDifference(double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				global::haxe.lang.Null<double> __temp_turn118 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
				double r = ( (( b - a )) % (__temp_turn118).@value );
				if (( r < 0 )) {
					r += (__temp_turn118).@value;
				}
				
				if (( r > ( (__temp_turn118).@value / 2 ) )) {
					r -= (__temp_turn118).@value;
				}
		...
		public static double interpolateAngle(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn119 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, ( a + global::thx.Floats.angleDifference(a, b, new global::haxe.lang.Null<double>(__temp_turn119, true)) )), __temp_turn119);
			}
		}
		...
		public static double interpolateAngleWidest(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn120 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				return global::thx.Floats.wrapCircular(( global::thx.Floats.interpolateAngle(f, a, b, new global::haxe.lang.Null<double>(__temp_turn120, true)) - ( __temp_turn120 / 2 ) ), __temp_turn120);
			}
		}
		...
		public static double interpolateAngleCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn121 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				a = global::thx.Floats.wrapCircular(a, __temp_turn121);
				b = global::thx.Floats.wrapCircular(b, __temp_turn121);
				if (( b < a )) {
					b += __temp_turn121;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn121);
			}
		}
		...
		public static double interpolateAngleCCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn122 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				a = global::thx.Floats.wrapCircular(a, __temp_turn122);
				b = global::thx.Floats.wrapCircular(b, __temp_turn122);
				if (( b > a )) {
					b -= __temp_turn122;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn122);
			}
		}
		...
		public static bool nearEquals(double a, double b, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance123 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			if ((  ! (global::System.Double.IsInfinity(((double) (a) )))  &&  ! (global::System.Double.IsNaN(((double) (a) )))  )) {
				return ( global::System.Math.Abs(((double) (( a - b )) )) <= (__temp_tollerance123).@value );
			}
		...
		public static bool nearEqualAngles(double a, double b, global::haxe.lang.Null<double> turn, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance125 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			global::haxe.lang.Null<double> __temp_turn124 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
			return ( global::System.Math.Abs(((double) (global::thx.Floats.angleDifference(a, b, __temp_turn124)) )) <= (__temp_tollerance125).@value );
		}
		
		
		public static bool nearZero(double n, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance126 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			return ( global::System.Math.Abs(((double) (n) )) <= (__temp_tollerance126).@value );
		}
