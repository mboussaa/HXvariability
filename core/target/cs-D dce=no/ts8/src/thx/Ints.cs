...
namespace thx {
	public class Ints : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Ints(global::thx.Ints __temp_me142) {
		}
		...
		public static int random(global::haxe.lang.Null<int> min, int max) {
			unchecked {
				int __temp_min139 = ( ( ! (min.hasValue) ) ? (0) : ((min).@value) );
				return ( global::Std.random(( max + 1 )) + __temp_min139 );
			}
		}
		...
		public static global::Array<int> range(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				...
				if (( ( ((double) ((( (stop).@value - start ))) ) / __temp_step140 ) == global::Math.POSITIVE_INFINITY )) {
		...
		public static object rangeIter(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				...
				return new global::thx.RangeIterator(start, stop, new global::haxe.lang.Null<int>(__temp_step141, true));
			}
		}
...
namespace thx {
	public class RangeIterator : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_RangeIterator(global::thx.RangeIterator __temp_me144, int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step143 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				__temp_me144.current = start;
				__temp_me144.stop = stop;
				__temp_me144.step = __temp_step143;
			}
		}
