...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me201) {
			__temp_me201.assertations = 0;
			__temp_me201.successes = 0;
			__temp_me201.failures = 0;
			__temp_me201.errors = 0;
			__temp_me201.warnings = 0;
			__temp_me201.isOk = true;
			__temp_me201.hasFailures = false;
			__temp_me201.hasErrors = false;
			__temp_me201.hasWarnings = false;
			__temp_me201.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me201.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me201.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me201.onAddWarnings = new global::utest.Dispatcher<int>();
		}
