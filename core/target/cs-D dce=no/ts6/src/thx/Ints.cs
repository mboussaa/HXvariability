...
namespace thx {
	public class Ints : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Ints(global::thx.Ints __temp_me141) {
		}
		...
		public static int random(global::haxe.lang.Null<int> min, int max) {
			unchecked {
				int __temp_min138 = ( ( ! (min.hasValue) ) ? (0) : ((min).@value) );
				return ( global::Std.random(( max + 1 )) + __temp_min138 );
			}
		}
		...
		public static global::Array<int> range(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step139 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				if ( ! (stop.hasValue) ) {
					stop = new global::haxe.lang.Null<int>(start, true);
					start = 0;
				}
				
				if (( ( ((double) ((( (stop).@value - start ))) ) / __temp_step139 ) == global::Math.POSITIVE_INFINITY )) {
		...
		public static object rangeIter(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step140 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				return new global::thx.RangeIterator(start, stop, new global::haxe.lang.Null<int>(__temp_step140, true));
			}
		}
...
namespace thx {
	public class RangeIterator : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_RangeIterator(global::thx.RangeIterator __temp_me143, int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step142 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				__temp_me143.current = start;
				__temp_me143.stop = stop;
				__temp_me143.step = __temp_step142;
			}
		}
