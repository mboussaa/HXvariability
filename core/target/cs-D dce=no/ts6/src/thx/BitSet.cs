...
namespace thx._BitSet {
	public sealed class BitSet_Impl_ {
		...
		public static global::Array<int> empty(global::haxe.lang.Null<int> length) {
			unchecked {
				global::haxe.lang.Null<int> __temp_length100 = ( ( ! (length.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (length) );
				int length1 = (__temp_length100).@value;
		...
		public static global::Array<int> setAll(global::Array<int> this1, global::haxe.lang.Null<bool> @value) {
			global::haxe.lang.Null<bool> __temp_value101 = ( ( ! (@value.hasValue) ) ? (new global::haxe.lang.Null<bool>(true, true)) : (@value) );
			{
				int _g1 = 0;
				int _g = global::thx._BitSet.BitSet_Impl_.get_length(this1);
				while (( _g1 < _g )) {
					global::thx._BitSet.BitSet_Impl_.setAt(this1, _g1++, (__temp_value101).@value);
				}
