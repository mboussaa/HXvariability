...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me184) {
			__temp_me184.assertations = 0;
			__temp_me184.successes = 0;
			__temp_me184.failures = 0;
			__temp_me184.errors = 0;
			__temp_me184.warnings = 0;
			__temp_me184.isOk = true;
			__temp_me184.hasFailures = false;
			__temp_me184.hasErrors = false;
			__temp_me184.hasWarnings = false;
			__temp_me184.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me184.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me184.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me184.onAddWarnings = new global::utest.Dispatcher<int>();
		}
