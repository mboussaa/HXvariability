...
namespace thx {
	public class Ints : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Ints(global::thx.Ints __temp_me149) {
		}
		...
		public static int random(global::haxe.lang.Null<int> min, int max) {
			unchecked {
				int __temp_min146 = ( ( ! (min.hasValue) ) ? (0) : ((min).@value) );
				return ( global::Std.random(( max + 1 )) + __temp_min146 );
			}
		}
		...
		public static global::Array<int> range(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				...
				if (( ( ((double) ((( (stop).@value - start ))) ) / __temp_step147 ) == global::Math.POSITIVE_INFINITY )) {
		...
		public static object rangeIter(int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step148 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				return new global::thx.RangeIterator(start, stop, new global::haxe.lang.Null<int>(__temp_step148, true));
			}
		}
...
namespace thx {
	public class RangeIterator : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_RangeIterator(global::thx.RangeIterator __temp_me151, int start, global::haxe.lang.Null<int> stop, global::haxe.lang.Null<int> step) {
			unchecked {
				int __temp_step150 = ( ( ! (step.hasValue) ) ? (1) : ((step).@value) );
				__temp_me151.current = start;
				__temp_me151.stop = stop;
				__temp_me151.step = __temp_step150;
			}
		}
