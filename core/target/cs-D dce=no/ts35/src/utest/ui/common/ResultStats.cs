...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me194) {
			__temp_me194.assertations = 0;
			__temp_me194.successes = 0;
			__temp_me194.failures = 0;
			__temp_me194.errors = 0;
			__temp_me194.warnings = 0;
			__temp_me194.isOk = true;
			__temp_me194.hasFailures = false;
			__temp_me194.hasErrors = false;
			__temp_me194.hasWarnings = false;
			__temp_me194.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me194.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me194.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me194.onAddWarnings = new global::utest.Dispatcher<int>();
		}
