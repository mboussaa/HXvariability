...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me186, string className, string setupName, string teardownName) {
			__temp_me186.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me186.className = className;
			__temp_me186.setupName = setupName;
			__temp_me186.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me186.teardownName = teardownName;
			__temp_me186.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me186.methods = 0;
