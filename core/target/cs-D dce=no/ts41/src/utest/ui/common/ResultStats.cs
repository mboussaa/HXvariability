...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me200) {
			__temp_me200.assertations = 0;
			__temp_me200.successes = 0;
			__temp_me200.failures = 0;
			__temp_me200.errors = 0;
			__temp_me200.warnings = 0;
			__temp_me200.isOk = true;
			__temp_me200.hasFailures = false;
			__temp_me200.hasErrors = false;
			__temp_me200.hasWarnings = false;
			__temp_me200.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me200.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me200.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me200.onAddWarnings = new global::utest.Dispatcher<int>();
		}
