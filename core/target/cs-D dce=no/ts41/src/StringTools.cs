...
public class StringTools : global::haxe.lang.HxObject {
	...
	static StringTools() {
		unchecked {
			global::StringTools.winMetaCharacters = new global::Array<int>(new int[]{32, 40, 41, 37, 33, 94, 34, 60, 62, 38, 124, 10, 13});
		}
	}
	...
	public static void __hx_ctor__StringTools(global::StringTools __temp_me20) {
	}
		...
		unchecked {
			if ( ! (new global::EReg("^[^ \t\\\\\"]+$", "").match(argument)) ) {
				...
				global::StringBuf bs_buf = new global::StringBuf();
				{
					...
					while (( _g1 < _g )) {
						global::haxe.lang.Null<int> _g2 = global::haxe.lang.StringExt.charCodeAt(argument, _g1++);
						if ( ! (_g2.hasValue) ) {
							...
							result_b.Append(((char) ((_g2).@value) ));
						}
						else {
							switch (((_g2)).@value) {
								case 34:
			...
			if (escapeMetaCharacters) {
				global::System.Text.StringBuilder result_b1 = new global::System.Text.StringBuilder();
				{
					...
					while (( _g11 < _g3 )) {
						global::haxe.lang.Null<int> c = global::haxe.lang.StringExt.charCodeAt(argument, _g11++);
						if (( global::StringTools.winMetaCharacters.indexOf((c).@value, default(global::haxe.lang.Null<int>)) >= 0 )) {
							result_b1.Append(((char) (94) ));
						}
						
						result_b1.Append(((char) ((c).@value) ));
					}
