...
namespace utest {
	public class TestFixture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_TestFixture(global::utest.TestFixture __temp_me188, object target, string method, string setup, string teardown) {
			__temp_me188.target = target;
			__temp_me188.method = method;
			__temp_me188.setup = setup;
			__temp_me188.teardown = teardown;
		}
