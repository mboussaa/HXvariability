...
namespace utest.ui.text {
	public class PlainTextReport : global::haxe.lang.HxObject, global::utest.ui.common.IReport<object> {
		...
		public static void __hx_ctor_utest_ui_text_PlainTextReport(global::utest.ui.text.PlainTextReport __temp_me205, global::utest.Runner runner, global::haxe.lang.Function outputHandler) {
			__temp_me205.aggregator = new global::utest.ui.common.ResultAggregator(runner, new global::haxe.lang.Null<bool>(true, true));
			runner.onStart.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me205, "start", 67859554)) ));
			__temp_me205.aggregator.onComplete.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me205, "complete", 2143813817)) ));
			if (( null != outputHandler )) {
				__temp_me205.setHandler(outputHandler);
			}
			
			__temp_me205.displaySuccessResults = global::utest.ui.common.SuccessResultsDisplayMode.AlwaysShowSuccessResults;
			__temp_me205.displayHeader = global::utest.ui.common.HeaderDisplayMode.AlwaysShowHeader;
		}
