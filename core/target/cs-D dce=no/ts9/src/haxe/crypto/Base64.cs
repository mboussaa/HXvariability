...
namespace haxe.crypto {
	public class Base64 : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_crypto_Base64(global::haxe.crypto.Base64 __temp_me53) {
		}
		...
		public static global::haxe.io.Bytes decode(string str, global::haxe.lang.Null<bool> complement) {
			unchecked {
				bool __temp_complement52 = ( ( ! (complement.hasValue) ) ? (true) : ((complement).@value) );
				if (__temp_complement52) {
