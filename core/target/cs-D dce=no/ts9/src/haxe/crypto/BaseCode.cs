...
namespace haxe.crypto {
	public class BaseCode : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_crypto_BaseCode(global::haxe.crypto.BaseCode __temp_me54, global::haxe.io.Bytes @base) {
			unchecked {
				int len = @base.length;
				int nbits = 1;
				while (( len > ( 1 << nbits ) )) {
				...
				__temp_me54.@base = @base;
				__temp_me54.nbits = nbits;
			}
		}
