...
namespace haxe.format {
	public class JsonPrinter : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_format_JsonPrinter(global::haxe.format.JsonPrinter __temp_me85, global::haxe.lang.Function replacer, string space) {
			__temp_me85.replacer = replacer;
			__temp_me85.indent = space;
			__temp_me85.pretty =  ! (string.Equals(space, null)) ;
			__temp_me85.nind = 0;
			__temp_me85.buf = new global::StringBuf();
		}
