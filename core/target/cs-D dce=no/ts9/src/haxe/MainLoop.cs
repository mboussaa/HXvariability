...
namespace haxe {
	public class MainEvent : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_MainEvent(global::haxe.MainEvent __temp_me45, global::haxe.lang.Function f, int p) {
			unchecked {
				__temp_me45.f = f;
				__temp_me45.priority = p;
				__temp_me45.nextRun = ((double) (-1) );
			}
		}
...
namespace haxe {
	public class MainLoop : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_MainLoop(global::haxe.MainLoop __temp_me47) {
		}
		...
		public static global::haxe.MainEvent @add(global::haxe.lang.Function f, global::haxe.lang.Null<int> priority) {
			int __temp_priority46 = ( ( ! (priority.hasValue) ) ? (0) : ((priority).@value) );
			if (( f == null )) {
				throw global::haxe.lang.HaxeException.wrap("Event function is null");
			}
			
			global::haxe.MainEvent e = new global::haxe.MainEvent(f, __temp_priority46);
