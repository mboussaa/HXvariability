...
namespace haxe.ds {
	public class IntMap<T> : global::haxe.lang.HxObject, global::haxe.ds.IntMap, global::haxe.IMap<int, T> {
		...
		public static void __hx_ctor_haxe_ds_IntMap<T_c>(global::haxe.ds.IntMap<T_c> __temp_me65) {
			unchecked {
				__temp_me65.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr62 = new T_c[this.vals.Length];
								int __temp_i63 = -1;
								while ((  ++ __temp_i63 < this.vals.Length )) {
									object __temp_obj64 = ((object) (this.vals[__temp_i63]) );
									if (( __temp_obj64 != null )) {
										__temp_new_arr62[__temp_i63] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj64);
									}
									
								}
								
								new_me.vals = __temp_new_arr62;
							}
							else {
								new_me.vals = null;
							}
		...
		public virtual string toString() {
			...
			while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(it, "hasNext", 407283053, null))) {
				int i = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(it, "next", 1224901875, null))) );
...
namespace haxe.ds._IntMap {
	public sealed class IntMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._IntMap.IntMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__IntMap_IntMapKeyIterator<T_c>(global::haxe.ds._IntMap.IntMapKeyIterator<T_c> __temp_me66, global::haxe.ds.IntMap<T_c> m) {
			__temp_me66.i = 0;
			__temp_me66.m = m;
			__temp_me66.len = m.nBuckets;
		}
...
namespace haxe.ds._IntMap {
	public sealed class IntMapValueIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._IntMap.IntMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__IntMap_IntMapValueIterator<T_c>(global::haxe.ds._IntMap.IntMapValueIterator<T_c> __temp_me67, global::haxe.ds.IntMap<T_c> m) {
			__temp_me67.i = 0;
			__temp_me67.m = m;
