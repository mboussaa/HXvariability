...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me74) {
			unchecked {
				__temp_me74.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr68 = new V_c[this.vals.Length];
								int __temp_i69 = -1;
								while ((  ++ __temp_i69 < this.vals.Length )) {
									object __temp_obj70 = ((object) (this.vals[__temp_i69]) );
									if (( __temp_obj70 != null )) {
										__temp_new_arr68[__temp_i69] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj70);
									}
									
								}
								
								new_me.vals = __temp_new_arr68;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr71 = new K_c[this._keys.Length];
								int __temp_i72 = -1;
								while ((  ++ __temp_i72 < this._keys.Length )) {
									object __temp_obj73 = ((object) (this._keys[__temp_i72]) );
									if (( __temp_obj73 != null )) {
										__temp_new_arr71[__temp_i72] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj73);
									}
									
								}
								
								new_me._keys = __temp_new_arr71;
							}
							else {
								new_me._keys = null;
							}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me75, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me75.i = 0;
			__temp_me75.m = m;
			__temp_me75.len = m.nBuckets;
		}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me76, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me76.i = 0;
			__temp_me76.m = m;
			__temp_me76.len = m.nBuckets;
		}
