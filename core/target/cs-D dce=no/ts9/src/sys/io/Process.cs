...
namespace sys.io {
	public class Process : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_sys_io_Process(global::sys.io.Process __temp_me93, string cmd, global::Array<object> args) {
			__temp_me93.native = global::sys.io.Process.createNativeProcess(cmd, args);
			__temp_me93.native.Start();
			__temp_me93.stdout = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me93.native.StandardOutput.BaseStream) ));
			__temp_me93.stderr = new global::cs.io.NativeInput(((global::System.IO.Stream) (__temp_me93.native.StandardError.BaseStream) ));
			__temp_me93.stdin = new global::cs.io.NativeOutput(((global::System.IO.Stream) (__temp_me93.native.StandardInput.BaseStream) ));
		}
