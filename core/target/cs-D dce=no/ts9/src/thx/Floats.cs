...
namespace thx {
	public class Floats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Floats(global::thx.Floats __temp_me138) {
		}
		...
		public static double angleDifference(double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				...
				double r = ( (( b - a )) % (__temp_turn129).@value );
				if (( r < 0 )) {
					r += (__temp_turn129).@value;
				}
				
				if (( r > ( (__temp_turn129).@value / 2 ) )) {
					r -= (__temp_turn129).@value;
				}
		...
		public static double interpolateAngle(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn130 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, ( a + global::thx.Floats.angleDifference(a, b, new global::haxe.lang.Null<double>(__temp_turn130, true)) )), __temp_turn130);
			}
		}
		...
		public static double interpolateAngleWidest(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn131 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				return global::thx.Floats.wrapCircular(( global::thx.Floats.interpolateAngle(f, a, b, new global::haxe.lang.Null<double>(__temp_turn131, true)) - ( __temp_turn131 / 2 ) ), __temp_turn131);
			}
		}
		...
		public static double interpolateAngleCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn132 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				a = global::thx.Floats.wrapCircular(a, __temp_turn132);
				b = global::thx.Floats.wrapCircular(b, __temp_turn132);
				if (( b < a )) {
					b += __temp_turn132;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn132);
			}
		}
		...
		public static double interpolateAngleCCW(double f, double a, double b, global::haxe.lang.Null<double> turn) {
			unchecked {
				double __temp_turn133 = ( ( ! (turn.hasValue) ) ? (((double) (360) )) : ((turn).@value) );
				a = global::thx.Floats.wrapCircular(a, __temp_turn133);
				b = global::thx.Floats.wrapCircular(b, __temp_turn133);
				if (( b > a )) {
					b -= __temp_turn133;
				}
				
				return global::thx.Floats.wrapCircular(global::thx.Floats.interpolate(f, a, b), __temp_turn133);
			}
		}
		...
		public static bool nearEquals(double a, double b, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance134 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			if ((  ! (global::System.Double.IsInfinity(((double) (a) )))  &&  ! (global::System.Double.IsNaN(((double) (a) )))  )) {
				return ( global::System.Math.Abs(((double) (( a - b )) )) <= (__temp_tollerance134).@value );
			}
		...
		public static bool nearEqualAngles(double a, double b, global::haxe.lang.Null<double> turn, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance136 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			global::haxe.lang.Null<double> __temp_turn135 = ( ( ! (turn.hasValue) ) ? (new global::haxe.lang.Null<double>(360.0, true)) : (turn) );
			return ( global::System.Math.Abs(((double) (global::thx.Floats.angleDifference(a, b, __temp_turn135)) )) <= (__temp_tollerance136).@value );
		}
		
		
		public static bool nearZero(double n, global::haxe.lang.Null<double> tollerance) {
			global::haxe.lang.Null<double> __temp_tollerance137 = ( ( ! (tollerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tollerance) );
			return ( global::System.Math.Abs(((double) (n) )) <= (__temp_tollerance137).@value );
		}
