...
namespace thx._DateTimeUtc {
	public sealed class DateTimeUtc_Impl_ {
		...
		public static long create(int year, int month, int day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second, global::haxe.lang.Null<int> millisecond) {
			unchecked {
				global::haxe.lang.Null<int> __temp_millisecond113 = ( ( ! (millisecond.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (millisecond) );
				global::haxe.lang.Null<int> __temp_second112 = ( ( ! (second.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (second) );
				global::haxe.lang.Null<int> __temp_minute111 = ( ( ! (minute.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (minute) );
				global::haxe.lang.Null<int> __temp_hour110 = ( ( ! (hour.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (hour) );
				__temp_second112 = new global::haxe.lang.Null<int>(( (__temp_second112).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_millisecond113).@value) ) / 1000 )) ))) ) ), true);
				__temp_millisecond113 = new global::haxe.lang.Null<int>(((int) (( (__temp_millisecond113).@value % (new global::haxe.lang.Null<int>(1000, true)).@value )) ), true);
				if (( (__temp_millisecond113).@value < 0 )) {
					__temp_millisecond113 = new global::haxe.lang.Null<int>(( (__temp_millisecond113).@value + 1000 ), true);
				}
				
				long ticks = ((long) (( ((long) (( ((long) (global::thx._DateTimeUtc.DateTimeUtc_Impl_.dateToTicks(year, month, day)) ) + ((long) (global::thx._Time.Time_Impl_.timeToTicks((__temp_hour110).@value, (__temp_minute111).@value, (__temp_second112).@value)) ) )) ) + ((long) (( ((long) ((__temp_millisecond113).@value) ) * ((long) (global::thx._DateTimeUtc.DateTimeUtc_Impl_.ticksPerMillisecondI64) ) )) ) )) );
				return ((long) (ticks) );
			}
		}
		...
		public static long snapToWeekDay(long this1, int weekday, global::haxe.lang.Null<int> firstDayOfWk) {
			unchecked {
				global::haxe.lang.Null<int> __temp_firstDayOfWk114 = ( ( ! (firstDayOfWk.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (firstDayOfWk) );
				int d = global::thx._DateTimeUtc.DateTimeUtc_Impl_.get_dayOfWeek(this1);
				int s = weekday;
				if (( s < (__temp_firstDayOfWk114).@value )) {
					s += 7;
				}
				
				if (( d < (__temp_firstDayOfWk114).@value )) {
					d += 7;
				}
