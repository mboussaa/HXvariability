...
namespace thx {
	public class Objects : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Objects(global::thx.Objects __temp_me164) {
		}
		...
		public static object copyTo(object src, object dst, global::haxe.lang.Null<bool> cloneInstances) {
			bool __temp_cloneInstances162 = ( ( ! (cloneInstances.hasValue) ) ? (false) : ((cloneInstances).@value) );
			{
				int _g = 0;
				...
				while (( _g < _g1.length )) {
					string field = global::haxe.lang.Runtime.toString(_g1[_g]);
					 ++ _g;
					object sv = global::thx.Dynamics.clone(global::Reflect.field(src, field), new global::haxe.lang.Null<bool>(__temp_cloneInstances162, true));
		...
		public static T clone<T>(T src, global::haxe.lang.Null<bool> cloneInstances) {
			bool __temp_cloneInstances163 = ( ( ! (cloneInstances.hasValue) ) ? (false) : ((cloneInstances).@value) );
			return global::haxe.lang.Runtime.genericCast<T>(global::thx.Dynamics.clone(src, new global::haxe.lang.Null<bool>(__temp_cloneInstances163, true)));
		}
