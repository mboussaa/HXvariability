...
namespace utest {
	public class TestHandler<T> : global::haxe.lang.HxObject, global::utest.TestHandler {
		...
		public static void __hx_ctor_utest_TestHandler<T_c>(global::utest.TestHandler<T_c> __temp_me170, global::utest.TestFixture fixture) {
			if (( fixture == null )) {
				throw global::haxe.lang.HaxeException.wrap("fixture argument is null");
			}
			
			__temp_me170.fixture = fixture;
			__temp_me170.results = new global::List<object>();
			__temp_me170.asyncStack = new global::List<object>();
			__temp_me170.onTested = new global::utest.Dispatcher<object>();
			__temp_me170.onTimeout = new global::utest.Dispatcher<object>();
			__temp_me170.onComplete = new global::utest.Dispatcher<object>();
			__temp_me170.onPrecheck = new global::utest.Dispatcher<object>();
		}
		...
		public static global::Array<object> exceptionStack(global::haxe.lang.Null<int> pops) {
			unchecked {
				int __temp_pops169 = ( ( ! (pops.hasValue) ) ? (2) : ((pops).@value) );
