...
namespace haxe.io {
	public class BytesInput : global::haxe.io.Input {
		...
		public static void __hx_ctor_haxe_io_BytesInput(global::haxe.io.BytesInput __temp_me84, global::haxe.io.Bytes b, global::haxe.lang.Null<int> pos, global::haxe.lang.Null<int> len) {
			if ( ! (pos.hasValue) ) {
			...
			__temp_me84.b = b.b;
			__temp_me84.pos = (pos).@value;
			__temp_me84.len = (len).@value;
			__temp_me84.totlen = (len).@value;
		}
