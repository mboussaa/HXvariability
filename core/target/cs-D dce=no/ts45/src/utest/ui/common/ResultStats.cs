...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me106) {
			__temp_me106.assertations = 0;
			__temp_me106.successes = 0;
			__temp_me106.failures = 0;
			__temp_me106.errors = 0;
			__temp_me106.warnings = 0;
			__temp_me106.isOk = true;
			__temp_me106.hasFailures = false;
			__temp_me106.hasErrors = false;
			__temp_me106.hasWarnings = false;
			__temp_me106.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me106.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me106.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me106.onAddWarnings = new global::utest.Dispatcher<int>();
		}
