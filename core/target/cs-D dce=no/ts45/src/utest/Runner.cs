...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me89) {
			__temp_me89.globalPattern = null;
			__temp_me89.fixtures = new global::Array<object>();
			__temp_me89.onProgress = new global::utest.Dispatcher<object>();
			__temp_me89.onStart = new global::utest.Dispatcher<object>();
			__temp_me89.onComplete = new global::utest.Dispatcher<object>();
			__temp_me89.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me89.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me89.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me89.length = 0;
		}
