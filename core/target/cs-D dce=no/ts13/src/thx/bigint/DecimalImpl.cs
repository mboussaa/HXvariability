...
namespace thx.bigint {
	public class DecimalImpl : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_bigint_DecimalImpl(global::thx.bigint.DecimalImpl __temp_me117, global::thx.bigint.BigIntImpl @value, int scale) {
			__temp_me117.@value = @value;
			__temp_me117.scale = scale;
		}
		...
		public virtual global::thx.bigint.DecimalImpl trim(global::haxe.lang.Null<int> min) {
			unchecked {
				global::haxe.lang.Null<int> __temp_min116 = ( ( ! (min.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (min) );
				if (( this.scale == 0 )) {
					return this;
				}
				...
				string dec = global::thx.Strings.rpad(global::thx.Strings.trimCharsRight(global::haxe.lang.Runtime.toString(parts[1]), "0"), "0", (__temp_min116).@value);
				if (( dec.Length > 0 )) {
