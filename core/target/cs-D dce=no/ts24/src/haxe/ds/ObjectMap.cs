...
namespace haxe.ds {
	public class ObjectMap<K, V> : global::haxe.lang.HxObject, global::haxe.ds.ObjectMap, global::haxe.IMap<K, V> {
		...
		public static void __hx_ctor_haxe_ds_ObjectMap<K_c, V_c>(global::haxe.ds.ObjectMap<K_c, V_c> __temp_me73) {
			unchecked {
				__temp_me73.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr67 = new V_c[this.vals.Length];
								int __temp_i68 = -1;
								while ((  ++ __temp_i68 < this.vals.Length )) {
									object __temp_obj69 = ((object) (this.vals[__temp_i68]) );
									if (( __temp_obj69 != null )) {
										__temp_new_arr67[__temp_i68] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj69);
									}
									
								}
								
								new_me.vals = __temp_new_arr67;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr70 = new K_c[this._keys.Length];
								int __temp_i71 = -1;
								while ((  ++ __temp_i71 < this._keys.Length )) {
									object __temp_obj72 = ((object) (this._keys[__temp_i71]) );
									if (( __temp_obj72 != null )) {
										__temp_new_arr70[__temp_i71] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj72);
									}
									
								}
								
								new_me._keys = __temp_new_arr70;
							}
							else {
								new_me._keys = null;
							}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapKeyIterator<T, V> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapKeyIterator<T_c, V_c>(global::haxe.ds._ObjectMap.ObjectMapKeyIterator<T_c, V_c> __temp_me74, global::haxe.ds.ObjectMap<T_c, V_c> m) {
			__temp_me74.i = 0;
			__temp_me74.m = m;
			__temp_me74.len = m.nBuckets;
		}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __temp_me75, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__temp_me75.i = 0;
			__temp_me75.m = m;
