...
namespace utest {
	public class TestFixture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_TestFixture(global::utest.TestFixture __temp_me184, object target, string method, string setup, string teardown) {
			__temp_me184.target = target;
			__temp_me184.method = method;
			__temp_me184.setup = setup;
			__temp_me184.teardown = teardown;
		}
