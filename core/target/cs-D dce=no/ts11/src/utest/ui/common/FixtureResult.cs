...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me193, string methodName) {
			__temp_me193.methodName = methodName;
			__temp_me193.list = new global::List<object>();
			__temp_me193.hasTestError = false;
			__temp_me193.hasSetupError = false;
			__temp_me193.hasTeardownError = false;
			__temp_me193.hasTimeoutError = false;
			__temp_me193.hasAsyncError = false;
