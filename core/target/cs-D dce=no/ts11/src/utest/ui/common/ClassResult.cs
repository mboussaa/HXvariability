...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me192, string className, string setupName, string teardownName) {
			__temp_me192.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me192.className = className;
			__temp_me192.setupName = setupName;
			__temp_me192.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me192.teardownName = teardownName;
			__temp_me192.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me192.methods = 0;
			__temp_me192.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority191 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority191) {
