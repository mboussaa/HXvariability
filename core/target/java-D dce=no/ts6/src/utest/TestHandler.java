...
public class TestHandler<T> extends haxe.lang.HxObject
{
	...
	public static <T_c> void __hx_ctor_utest_TestHandler(utest.TestHandler<T_c> __temp_me136, utest.TestFixture fixture)
	{
		...
		__temp_me136.fixture = fixture;
		//line 21 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.results = new haxe.root.List<utest.Assertation>();
		//line 22 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.asyncStack = new haxe.root.List();
		//line 23 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.onTested = new utest.Dispatcher<utest.TestHandler<T_c>>();
		//line 24 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.onTimeout = new utest.Dispatcher<utest.TestHandler<T_c>>();
		//line 25 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.onComplete = new utest.Dispatcher<utest.TestHandler<T_c>>();
		//line 26 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/TestHandler.hx"
		__temp_me136.onPrecheck = new utest.Dispatcher<utest.TestHandler<T_c>>();
	}
	...
	public static haxe.root.Array<haxe.StackItem> exceptionStack(java.lang.Object pops)
	{
		...
		int __temp_pops135 = ( (haxe.lang.Runtime.eq(pops, null)) ? (2) : (((int) (haxe.lang.Runtime.toInt(pops)) )) );
	...
	public <EventArg> haxe.lang.Function addEvent(haxe.lang.Function f, java.lang.Object timeout)
	{
		...
		int __temp_timeout134 = ( (haxe.lang.Runtime.eq(timeout, null)) ? (250) : (((int) (haxe.lang.Runtime.toInt(timeout)) )) );
		...
		this.setTimeout(__temp_timeout134);
