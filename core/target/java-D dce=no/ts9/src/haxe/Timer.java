...
public class Timer extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_haxe_Timer(haxe.Timer __temp_me22, int time_ms)
	{
		//line 123 "/usr/lib/haxe/std/haxe/Timer.hx"
		__temp_me22.run = ( (( haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current != null )) ? (haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current) : (haxe.Timer___hx_ctor_haxe_Timer_123__Fun.__hx_current = ((haxe.Timer___hx_ctor_haxe_Timer_123__Fun) (new haxe.Timer___hx_ctor_haxe_Timer_123__Fun()) )) );
		//line 68 "/usr/lib/haxe/std/haxe/Timer.hx"
		__temp_me22.timer = new java.util.Timer();
		//line 69 "/usr/lib/haxe/std/haxe/Timer.hx"
		__temp_me22.timer.scheduleAtFixedRate(((java.util.TimerTask) (__temp_me22.task = new haxe._Timer.TimerTask(__temp_me22)) ), ((long) (time_ms) ), ((long) (time_ms) ));
	}
	...
	{
		//line 157 "/usr/lib/haxe/std/haxe/Timer.hx"
		double t0 = haxe.Timer.stamp();
		//line 158 "/usr/lib/haxe/std/haxe/Timer.hx"
		T r = ((T) (f.__hx_invoke0_o()) );
		//line 159 "/usr/lib/haxe/std/haxe/Timer.hx"
		haxe.Log.trace.__hx_invoke2_o(0.0, ( haxe.lang.Runtime.toString(( haxe.Timer.stamp() - t0 )) + "s" ), 0.0, pos);
		//line 160 "/usr/lib/haxe/std/haxe/Timer.hx"
		return r;
	}
