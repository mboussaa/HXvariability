...
public class Base64 extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_haxe_crypto_Base64(haxe.crypto.Base64 __temp_me27)
	{
	}
	...
	public static java.lang.String encode(haxe.io.Bytes bytes, java.lang.Object complement)
	{
		...
		boolean __temp_complement25 = ( (haxe.lang.Runtime.eq(complement, null)) ? (true) : (haxe.lang.Runtime.toBool(complement)) );
		...
		if (__temp_complement25) 
		{
			...
			switch (_g)
			{
				...
				case 2:
				{
					//line 39 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
					str += "=";
					//line 39 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
					break;
				}
	...
	{
		//line 45 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
		boolean __temp_complement26 = ( (haxe.lang.Runtime.eq(complement, null)) ? (true) : (haxe.lang.Runtime.toBool(complement)) );
		//line 46 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
		if (__temp_complement26) 
		{
			//line 47 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
			while (haxe.lang.Runtime.eq(haxe.lang.StringExt.charCodeAt(str, ( str.length() - 1 )), 61))
			{
				//line 48 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
				str = haxe.lang.StringExt.substr(str, 0, -1);
			}
			
		}
		
		//line 49 "/usr/lib/haxe/std/haxe/crypto/Base64.hx"
