...
public class ObjectMap<K, V> extends haxe.lang.HxObject implements haxe.IMap<K, V>
{
	...
	public static <K_c, V_c> void __hx_ctor_haxe_ds_ObjectMap(haxe.ds.ObjectMap<K_c, V_c> __temp_me37)
	{
	...
	{
		//line 292 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		int idx = -1;
		//line 293 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		boolean tmp = false;
		//line 293 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		if (haxe.lang.Runtime.eq(this.cachedKey, key)) 
		{
		...
		if (tmp) 
		{
			//line 295 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			return this.vals[idx];
		}
		
		//line 298 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		idx = this.lookup(key);
		//line 299 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		if (( idx != -1 )) 
		{
			//line 301 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			this.cachedKey = key;
			//line 302 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			this.cachedIndex = idx;
			//line 304 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			return this.vals[idx];
		}
		
		//line 307 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		return def;
	}
	...
	{
		//line 418 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		haxe.root.StringBuf s = new haxe.root.StringBuf();
		//line 419 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		s.add(haxe.lang.Runtime.toString("{"));
		//line 420 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		java.lang.Object it = this.keys();
		//line 421 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null)))
		{
			//line 421 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			K i = ((K) (haxe.lang.Runtime.callField(it, "next", null)) );
			//line 422 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			s.add(haxe.lang.Runtime.toString(haxe.root.Std.string(i)));
			//line 423 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			s.add(haxe.lang.Runtime.toString(" => "));
			//line 424 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			s.add(haxe.lang.Runtime.toString(haxe.root.Std.string(this.get(i))));
			//line 425 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
			if (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null))) 
			{
				//line 426 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
				s.add(haxe.lang.Runtime.toString(", "));
			}
			
		}
		
		//line 428 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		s.add(haxe.lang.Runtime.toString("}"));
		//line 429 "/usr/lib/haxe/std/java/_std/haxe/ds/ObjectMap.hx"
		return s.toString();
	}
