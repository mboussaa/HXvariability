...
public class HashMapData<K, V> extends haxe.lang.HxObject
{
	...
	public static <K_c, V_c> void __hx_ctor_haxe_ds__HashMap_HashMapData(haxe.ds._HashMap.HashMapData<K_c, V_c> __temp_me35)
	{
		//line 88 "/usr/lib/haxe/std/haxe/ds/HashMap.hx"
		__temp_me35.keys = new haxe.ds.IntMap<K_c>();
		//line 89 "/usr/lib/haxe/std/haxe/ds/HashMap.hx"
		__temp_me35.values = new haxe.ds.IntMap<V_c>();
	}
