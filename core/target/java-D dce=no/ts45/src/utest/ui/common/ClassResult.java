...
public class ClassResult extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_utest_ui_common_ClassResult(utest.ui.common.ClassResult __temp_me62, java.lang.String className, java.lang.String setupName, java.lang.String teardownName)
	{
		//line 17 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/ui/common/ClassResult.hx"
		__temp_me62.fixtures = new haxe.ds.StringMap<utest.ui.common.FixtureResult>();
		...
		__temp_me62.hasSetup = ( setupName != null );
		...
		__temp_me62.hasTeardown = ( teardownName != null );
		...
		__temp_me62.stats = new utest.ui.common.ResultStats();
	}
	...
	public haxe.root.Array<java.lang.String> methodNames(java.lang.Object errorsHavePriority)
	{
		...
		boolean __temp_errorsHavePriority61 = ( (haxe.lang.Runtime.eq(errorsHavePriority, null)) ? (true) : (haxe.lang.Runtime.toBool(errorsHavePriority)) );
