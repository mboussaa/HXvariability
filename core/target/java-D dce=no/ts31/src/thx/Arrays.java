...
public class Arrays extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Arrays(thx.Arrays __temp_me58)
	{
	}
	...
	public static <T> haxe.root.Array<T> applyIndexes(haxe.root.Array<T> array, haxe.root.Array<java.lang.Object> indexes, java.lang.Object incrementDuplicates)
	{
		...
		java.lang.Object __temp_incrementDuplicates55 = ( (haxe.lang.Runtime.eq(incrementDuplicates, null)) ? (((java.lang.Object) (false) )) : (incrementDuplicates) );
		...
		if (haxe.lang.Runtime.toBool((__temp_incrementDuplicates55))) 
		{
	...
	public static <T> haxe.root.Array<java.lang.Object> rank(haxe.root.Array<T> array, haxe.lang.Function compare, java.lang.Object incrementDuplicates)
	{
		...
		java.lang.Object __temp_incrementDuplicates56 = ( (haxe.lang.Runtime.eq(incrementDuplicates, null)) ? (((java.lang.Object) (true) )) : (incrementDuplicates) );
	...
	public static <T> haxe.root.Array<T> withSlice(haxe.root.Array<T> arr, haxe.root.Array<T> other, int start, java.lang.Object length)
	{
		...
		//line 1116 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Arrays.hx"
		return arr.slice(0, start).concat(((haxe.root.Array<T>) (other) )).concat(arr.slice(((int) (haxe.lang.Runtime.toInt(haxe.lang.Runtime.plus(start, __temp_length57))) ), null));
	}
