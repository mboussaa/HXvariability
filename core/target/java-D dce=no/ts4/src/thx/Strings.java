...
public class Strings extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Strings(thx.Strings __temp_me126)
	{
	}
	...
	public static java.lang.String capitalizeWords(java.lang.String value, java.lang.Object whiteSpaceOnly)
	{
		...
		java.lang.Object __temp_whiteSpaceOnly121 = ( (haxe.lang.Runtime.eq(whiteSpaceOnly, null)) ? (((java.lang.Object) (false) )) : (whiteSpaceOnly) );
		//line 52 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
		if (haxe.lang.Runtime.toBool((__temp_whiteSpaceOnly121))) 
		{
	...
	public static java.lang.String ellipsis(java.lang.String s, java.lang.Object maxlen, java.lang.String symbol)
	{
		...
		if (( haxe.lang.Runtime.compare(sl, __temp_maxlen122) > 0 )) 
		{
			...
			if (( haxe.lang.Runtime.compare(__temp_maxlen122, symboll) < 0 )) 
			{
				...
				return haxe.lang.StringExt.substr(symbol, ( ((int) (symboll) ) - ((int) (haxe.lang.Runtime.toInt(__temp_maxlen122)) ) ), __temp_maxlen122);
			}
			else
			{
				//line 205 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
				return ( haxe.lang.StringExt.substr(s, 0, ( ((int) (haxe.lang.Runtime.toInt(__temp_maxlen122)) ) - ((int) (symboll) ) )) + symbol );
			}
	...
	public static java.lang.String ellipsisMiddle(java.lang.String s, java.lang.Object maxlen, java.lang.String symbol)
	{
		...
		if (( haxe.lang.Runtime.compare(sl, __temp_maxlen123) > 0 )) 
		{
			...
			if (( haxe.lang.Runtime.compare(__temp_maxlen123, symboll) <= 0 )) 
			{
				...
				return thx.Strings.ellipsis(s, __temp_maxlen123, symbol);
			}
			
			//line 225 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
			int hll = ((int) (java.lang.Math.ceil(( ((double) ((( ((int) (haxe.lang.Runtime.toInt(__temp_maxlen123)) ) - ((int) (symboll) ) ))) ) / 2 ))) );
			//line 225 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
			int hlr = ((int) (java.lang.Math.floor(( ((double) ((( ((int) (haxe.lang.Runtime.toInt(__temp_maxlen123)) ) - ((int) (symboll) ) ))) ) / 2 ))) );
	...
	public static java.lang.String random(java.lang.String value, java.lang.Object length)
	{
		...
		int __temp_length124 = ( (haxe.lang.Runtime.eq(length, null)) ? (1) : (((int) (haxe.lang.Runtime.toInt(length)) )) );
		//line 358 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
		return haxe.lang.StringExt.substr(value, ((int) (java.lang.Math.floor(( (( ( value.length() - __temp_length124 ) + 1 )) * java.lang.Math.random() ))) ), __temp_length124);
	}
	...
	public static java.lang.String wrapColumns(java.lang.String s, java.lang.Object columns, java.lang.String indent, java.lang.String newline)
	{
		...
		//line 609 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
		int __temp_columns125 = ( (haxe.lang.Runtime.eq(columns, null)) ? (78) : (((int) (haxe.lang.Runtime.toInt(columns)) )) );
		//line 609 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Strings.hx"
		return ((haxe.root.Array<java.lang.String>) (((haxe.root.Array) (thx.Strings.SPLIT_LINES.split(s).map(((haxe.lang.Function) (new thx.Strings_wrapColumns_609__Fun(newline, indent, __temp_columns125)) ))) )) ).join(newline);
	}
