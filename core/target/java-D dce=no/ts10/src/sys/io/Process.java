...
public class Process extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_sys_io_Process(sys.io.Process __temp_me48, java.lang.String cmd, haxe.root.Array<java.lang.String> args)
	{
		//line 81 "/usr/lib/haxe/std/java/_std/sys/io/Process.hx"
		try 
		{
			//line 82 "/usr/lib/haxe/std/java/_std/sys/io/Process.hx"
			java.lang.Process p = __temp_me48.proc = sys.io.Process.createProcessBuilder(cmd, args).start();
			//line 83 "/usr/lib/haxe/std/java/_std/sys/io/Process.hx"
			__temp_me48.stderr = new sys.io._Process.ProcessInput(((java.io.InputStream) (p.getErrorStream()) ));
			//line 84 "/usr/lib/haxe/std/java/_std/sys/io/Process.hx"
			__temp_me48.stdout = new sys.io._Process.ProcessInput(((java.io.InputStream) (p.getInputStream()) ));
			//line 85 "/usr/lib/haxe/std/java/_std/sys/io/Process.hx"
			__temp_me48.stdin = new haxe.java.io.NativeOutput(((java.io.OutputStream) (p.getOutputStream()) ));
		}
