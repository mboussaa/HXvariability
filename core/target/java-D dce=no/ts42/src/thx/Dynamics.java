...
public class Dynamics extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Dynamics(thx.Dynamics __temp_me95)
	{
	}
	...
	public static java.lang.Object clone(java.lang.Object v, java.lang.Object cloneInstances)
	{
		...
		java.lang.Object __temp_cloneInstances94 = ( (haxe.lang.Runtime.eq(cloneInstances, null)) ? (((java.lang.Object) (false) )) : (cloneInstances) );
		//line 168 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dynamics.hx"
		...
		switch (_g.index)
		{
			...
			case 6:
			{
				...
				//line 177 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dynamics.hx"
				{
					...
					switch (__temp_hash3)
					{
						case 63537721:
						{
							...
							if (__temp_svar1.equals("Array")) 
							{
								...
								return ((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (v) ).map(((haxe.lang.Function) (new thx.Dynamics_clone_179__Fun(__temp_cloneInstances94)) ))) );
							}
					...
					{
						//line 185 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dynamics.hx"
						if (haxe.lang.Runtime.toBool((__temp_cloneInstances94))) 
						{
							...
							//line 187 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dynamics.hx"
							{
								...
								while (( _g1 < _g11.length ))
								{
									...
									haxe.root.Reflect.setField(o, field, thx.Dynamics.clone(haxe.root.Reflect.field(v, field), __temp_cloneInstances94));
								}
