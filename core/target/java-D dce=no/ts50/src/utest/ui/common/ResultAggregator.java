...
public class ResultAggregator extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_utest_ui_common_ResultAggregator(utest.ui.common.ResultAggregator __temp_me154, utest.Runner runner, java.lang.Object flattenPackage)
	{
		//line 16 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/ui/common/ResultAggregator.hx"
		boolean __temp_flattenPackage153 = ( (haxe.lang.Runtime.eq(flattenPackage, null)) ? (false) : (haxe.lang.Runtime.toBool(flattenPackage)) );
		...
		runner.onProgress.add(((haxe.lang.Function) (new haxe.lang.Closure(__temp_me154, "progress")) ));
		//line 22 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/ui/common/ResultAggregator.hx"
		runner.onComplete.add(((haxe.lang.Function) (new haxe.lang.Closure(__temp_me154, "complete")) ));
		//line 24 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/ui/common/ResultAggregator.hx"
		__temp_me154.onStart = new utest.Notifier();
		//line 25 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/ui/common/ResultAggregator.hx"
		__temp_me154.onComplete = new utest.Dispatcher<utest.ui.common.PackageResult>();
