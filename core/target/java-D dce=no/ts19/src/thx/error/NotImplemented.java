...
public class NotImplemented extends thx.Error
{
	...
	public static void __hx_ctor_thx_error_NotImplemented(thx.error.NotImplemented __temp_me53, java.lang.Object posInfo)
	{
		//line 17 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/error/NotImplemented.hx"
		thx.Error.__hx_ctor_thx_Error(__temp_me53, ( ( ( ( "method " + haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(posInfo, "className", true)) ) + "." ) + haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(posInfo, "methodName", true)) ) + "() needs to be implemented" ), null, posInfo);
	}
