...
public class JsonPrinter extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_haxe_format_JsonPrinter(haxe.format.JsonPrinter __temp_me34, haxe.lang.Function replacer, java.lang.String space)
	{
		//line 57 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		__temp_me34.replacer = replacer;
		//line 58 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		__temp_me34.indent = space;
		//line 59 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		__temp_me34.pretty = ( space != null );
		//line 60 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		__temp_me34.nind = 0;
		//line 67 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		__temp_me34.buf = new haxe.root.StringBuf();
	}
	...
	public void ipad()
	{
		//line 72 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		if (this.pretty) 
		{
			//line 72 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
	...
	public void newl()
	{
		//line 76 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
		if (this.pretty) 
		{
			//line 76 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
			this.buf.addChar(10);
	...
	public void objString(java.lang.Object v)
	{
		//line 164 "/usr/lib/haxe/std/haxe/format/JsonPrinter.hx"
	...
	public void quote(java.lang.String s)
	{
		...
		while (true)
		{
			...
			int c = haxe.root.StringTools.fastCodeAt(s, i++);
