...
public class IntMap<T> extends haxe.lang.HxObject implements haxe.IMap<java.lang.Object, T>
{
	...
	public void set(int key, T value)
	{
		...
		//line 67 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
		{
			...
			if (haxe.ds.IntMap.flagIsEmpty(flags, i)) 
			{
			...
			else
			{
				...
				int inc = haxe.ds.IntMap.getInc(k, mask);
				//line 80 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				while ( ! ((( haxe.ds.IntMap.flagIsEmpty(flags, i) || ( _keys[i] == key ) ))) )
				{
					//line 82 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
					if (( haxe.ds.IntMap.flagIsDel(flags, i) && ( delKey == -1 ) )) 
					{
				...
				if (( haxe.ds.IntMap.flagIsEmpty(flags, i) && ( delKey != -1 ) )) 
				{
		...
		if (haxe.ds.IntMap.flagIsEmpty(flags, x)) 
		{
			...
			haxe.ds.IntMap.setIsBothFalse(flags, x);
		...
		else
		{
			...
			if (haxe.ds.IntMap.flagIsDel(flags, x)) 
			{
			...
			{
				//line 113 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				haxe.ds.IntMap._assert(( _keys[x] == key ));
	...
	public int lookup(int key)
	{
		...
		if (( this.nBuckets != 0 )) 
		{
			...
			while ((  ! (haxe.ds.IntMap.flagIsEmpty(flags, i))  && (( haxe.ds.IntMap.flagIsDel(flags, i) || ( _keys[i] != key ) )) ))
			{
			...
			if (haxe.ds.IntMap.isEither(flags, i)) 
			{
				//line 134 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				return -1;
			}
	...
	public boolean remove(int key)
	{
		...
		else
		{
			...
			if ( ! (haxe.ds.IntMap.isEither(this.flags, idx)) ) 
			{
				//line 217 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				haxe.ds.IntMap.setIsDelTrue(this.flags, idx);
	...
	public void resize(int newNBuckets)
	{
		...
		//line 233 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
		{
			...
			newNBuckets = haxe.ds.IntMap.roundUp(newNBuckets);
			...
			else
			{
				...
				int nfSize = haxe.ds.IntMap.flagsSize(newNBuckets);
				...
				if (( this.nBuckets < newNBuckets )) 
				{
					...
					if (( this._keys != null )) 
					{
						...
						haxe.ds.IntMap.arrayCopy(this._keys, 0, k, 0, this.nBuckets);
					}
					...
					if (( this.vals != null )) 
					{
						...
						haxe.ds.IntMap.arrayCopy(this.vals, 0, v, 0, this.nBuckets);
					}
		...
		if (( j != 0 )) 
		{
			...
			while ((  ++ j < nBuckets ))
			{
				...
				if ( ! (haxe.ds.IntMap.isEither(flags, j)) ) 
				{
					...
					while (true)
					{
						...
						haxe.ds.IntMap.setIsEmptyFalse(newFlags, i1);
						//line 286 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
						if (( ( i1 < nBuckets ) &&  ! (haxe.ds.IntMap.isEither(flags, i1))  )) 
						{
							...
							haxe.ds.IntMap.setIsDelTrue(flags, i1);
						}
						else
						{
			...
			if (( nBuckets > newNBuckets )) 
			{
				//line 311 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				{
					...
					haxe.ds.IntMap.arrayCopy(_keys, 0, k2, 0, newNBuckets);
				...
				//line 316 "/usr/lib/haxe/std/java/_std/haxe/ds/IntMap.hx"
				{
					...
					haxe.ds.IntMap.arrayCopy(vals, 0, v1, 0, newNBuckets);
