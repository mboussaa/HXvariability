...
public class Types extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Types(thx.Types __temp_me134)
	{
	}
	...
	public static <A, B> boolean sameType(A a, B b)
	{
		...
		return haxe.lang.Runtime.valEq(haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((A) (a) ))), haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((B) (b) ))));
	}
	...
	public static java.lang.String anyValueToString(java.lang.Object value)
	{
		...
		return haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((java.lang.Object) (value) )));
	}
