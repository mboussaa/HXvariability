...
public class Assert extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_utest_Assert(utest.Assert __temp_me137)
	{
	}
						...
						//line 277 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Assert.hx"
						{
							...
							while (( _g14 < _g5 ))
							{
								...
								if (( ebytes.get(i3) != vbytes.get(i3) )) 
								{
									...
									haxe.lang.Runtime.setField(status, "error", ( ( ( ( "expected byte " + ebytes.get(i3) ) + " but it is " ) + vbytes.get(i3) ) + (( (haxe.lang.Runtime.valEq(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(status, "path", true)), "")) ? ("") : (( " for field " + haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(status, "path", true)) )) )) ));
