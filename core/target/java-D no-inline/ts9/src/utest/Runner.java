...
public class Runner extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_utest_Runner(utest.Runner __temp_me140)
	{
		...
		__temp_me140.fixtures = new haxe.root.Array<utest.TestFixture>();
		...
		__temp_me140.onStart = new utest.Dispatcher<utest.Runner>();
		//line 66 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me140.onComplete = new utest.Dispatcher<utest.Runner>();
		//line 67 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me140.onPrecheck = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
		//line 68 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me140.onTestStart = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
		//line 69 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me140.onTestComplete = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
	...
	public void addCase(java.lang.Object test, java.lang.String setup, java.lang.String teardown, java.lang.String prefix, haxe.root.EReg pattern)
	{
		...
		if (( ( this.globalPattern == null ) && ( pattern == null ) )) 
		{
			...
			while (( _g < fields.length ))
			{
				...
				if ( ! (haxe.root.StringTools.startsWith(field, prefix)) ) 
				{
					//line 91 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
					continue;
				}
