...
public class Dates extends haxe.lang.HxObject
{
	...
	public static int compare(haxe.root.Date a, haxe.root.Date b)
	{
		...
		return thx.Floats.compare(a.getTime(), b.getTime());
	}
	...
	public static boolean nearEquals(haxe.root.Date self, haxe.root.Date other, java.lang.Object units, thx.TimePeriod period)
	{
		...
		if (thx.Dates.lessEquals(min, other)) 
		{
			//line 109 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dates.hx"
			return thx.Dates.greaterEquals(max, other);
		}
		else
		{
			//line 109 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Dates.hx"
	...
	public static boolean more(haxe.root.Date self, haxe.root.Date other)
	{
		...
		return thx.Dates.greater(self, other);
	}
	...
	public static boolean moreEqual(haxe.root.Date self, haxe.root.Date other)
	{
		...
		return thx.Dates.greaterEquals(self, other);
	}
	...
	public static boolean lessEqual(haxe.root.Date self, haxe.root.Date other)
	{
		...
		return thx.Dates.lessEquals(self, other);
	}
	...
	public static boolean isInLeapYear(haxe.root.Date d)
	{
		...
		return thx.Dates.isLeapYear(d.getFullYear());
	}
	...
	public static int daysInThisMonth(haxe.root.Date d)
	{
		...
		return thx.Dates.daysInMonth(d.getFullYear(), d.getMonth());
	}
	...
	public static haxe.root.Date snapNext(haxe.root.Date date, thx.TimePeriod period)
	{
		...
		return haxe.root.Date.fromTime(((double) (thx._Timestamp.Timestamp_Impl_.snapNext(((double) (date.getTime()) ), period)) ));
	}
	...
	public static haxe.root.Date snapPrev(haxe.root.Date date, thx.TimePeriod period)
	{
		...
		return haxe.root.Date.fromTime(((double) (thx._Timestamp.Timestamp_Impl_.snapPrev(((double) (date.getTime()) ), period)) ));
	}
	...
	public static haxe.root.Date snapTo(haxe.root.Date date, thx.TimePeriod period)
	{
		...
		return haxe.root.Date.fromTime(((double) (thx._Timestamp.Timestamp_Impl_.snapTo(((double) (date.getTime()) ), period)) ));
	}
	...
	public static haxe.root.Date withYear(haxe.root.Date date, int year)
	{
		...
		return thx.Dates.create(year, date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds());
	}
	...
	public static haxe.root.Date withMonth(haxe.root.Date date, int month)
	{
		...
		return thx.Dates.create(date.getFullYear(), month, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds());
	}
	...
	public static haxe.root.Date withDay(haxe.root.Date date, int day)
	{
		...
		return thx.Dates.create(date.getFullYear(), date.getMonth(), day, date.getHours(), date.getMinutes(), date.getSeconds());
	}
	...
	public static haxe.root.Date withHour(haxe.root.Date date, int hour)
	{
		...
		return thx.Dates.create(date.getFullYear(), date.getMonth(), date.getDate(), hour, date.getMinutes(), date.getSeconds());
	}
	...
	public static haxe.root.Date withMinute(haxe.root.Date date, int minute)
	{
		...
		return thx.Dates.create(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), minute, date.getSeconds());
	}
	...
	public static haxe.root.Date withSecond(haxe.root.Date date, int second)
	{
		...
		return thx.Dates.create(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), second);
	}
