...
public class TestChar extends haxe.lang.HxObject
{
	...
	{
		//line 14 "/HXvariability/core/test/thx/TestChar.hx"
		int _g1 = 0;
		//line 14 "/HXvariability/core/test/thx/TestChar.hx"
		int _g = this.x;
		//line 14 "/HXvariability/core/test/thx/TestChar.hx"
		while (( _g1 < _g ))
		{
			//line 14 "/HXvariability/core/test/thx/TestChar.hx"
			 ++ _g1;
			//line 15 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 15 "/HXvariability/core/test/thx/TestChar.hx"
			int _char = ((int) (120) );
			//line 17 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 18 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 20 "/HXvariability/core/test/thx/TestChar.hx"
			int i = haxe.Utf8.charCodeAt("y", 0);
			//line 20 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 20 "/HXvariability/core/test/thx/TestChar.hx"
			_char = ((int) (i) );
			//line 22 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 23 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 25 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 26 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 28 "/HXvariability/core/test/thx/TestChar.hx"
			_char = thx._Char.Char_Impl_.next(_char);
			//line 30 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 31 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 33 "/HXvariability/core/test/thx/TestChar.hx"
	...
	{
		//line 37 "/HXvariability/core/test/thx/TestChar.hx"
		int _g1 = 0;
		//line 37 "/HXvariability/core/test/thx/TestChar.hx"
		int _g = this.x;
		//line 37 "/HXvariability/core/test/thx/TestChar.hx"
		while (( _g1 < _g ))
		{
			//line 37 "/HXvariability/core/test/thx/TestChar.hx"
			 ++ _g1;
			//line 38 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 39 "/HXvariability/core/test/thx/TestChar.hx"
			int i = haxe.Utf8.charCodeAt("x", 0);
			//line 39 "/HXvariability/core/test/thx/TestChar.hx"
			thx.Assert.isTrue(( i >= 0 ), ( "Char value should be greater than zero: " + i ), new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx._Char.Char_Impl_", "Char.hx", "fromInt"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (19) )) )}));
			//line 39 "/HXvariability/core/test/thx/TestChar.hx"
	...
	{
		//line 43 "/HXvariability/core/test/thx/TestChar.hx"
		int _g1 = 0;
		//line 43 "/HXvariability/core/test/thx/TestChar.hx"
		int _g = this.x;
		//line 43 "/HXvariability/core/test/thx/TestChar.hx"
		while (( _g1 < _g ))
		{
			//line 43 "/HXvariability/core/test/thx/TestChar.hx"
			 ++ _g1;
			//line 44 "/HXvariability/core/test/thx/TestChar.hx"
			int i = haxe.Utf8.charCodeAt("\u263a", 0);
			//line 44 "/HXvariability/core/test/thx/TestChar.hx"
			thx.Assert.isTrue(( i >= 0 ), ( "Char value should be greater than zero: " + i ), new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx._Char.Char_Impl_", "Char.hx", "fromInt"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (19) )) )}));
			//line 44 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 45 "/HXvariability/core/test/thx/TestChar.hx"
	...
	{
		//line 49 "/HXvariability/core/test/thx/TestChar.hx"
		int _g1 = 0;
		//line 49 "/HXvariability/core/test/thx/TestChar.hx"
		int _g = this.x;
		//line 49 "/HXvariability/core/test/thx/TestChar.hx"
		while (( _g1 < _g ))
		{
			//line 49 "/HXvariability/core/test/thx/TestChar.hx"
			 ++ _g1;
			//line 50 "/HXvariability/core/test/thx/TestChar.hx"
			thx.Assert.isTrue(true, ( "Char value should be greater than zero: " + 120 ), new haxe.lang.DynamicObject(new java.lang.String[]{"className", "fileName", "methodName"}, new java.lang.Object[]{"thx._Char.Char_Impl_", "Char.hx", "fromInt"}, new java.lang.String[]{"lineNumber"}, new double[]{((double) (((double) (19) )) )}));
			//line 50 "/HXvariability/core/test/thx/TestChar.hx"
			int tmp = ((int) (120) );
			//line 50 "/HXvariability/core/test/thx/TestChar.hx"
			...
			//line 51 "/HXvariability/core/test/thx/TestChar.hx"
