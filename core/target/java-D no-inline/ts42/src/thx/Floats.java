...
public class Floats extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_Floats(thx.Floats __temp_me104)
	{
	}
	...
	public static double angleDifference(double a, double b, java.lang.Object turn)
	{
		...
		java.lang.Object __temp_turn95 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((java.lang.Object) (360.0) )) : (turn) );
		//line 19 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		double r = ( ((double) ((( b - a ))) ) % ((double) (haxe.lang.Runtime.toDouble(__temp_turn95)) ) );
		//line 20 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		if (( r < 0 )) 
		{
			//line 21 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
			r = ((double) (haxe.lang.Runtime.toDouble(haxe.lang.Runtime.plus(r, __temp_turn95))) );
		}
		
		//line 22 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		if (( r > ( ((double) (haxe.lang.Runtime.toDouble(__temp_turn95)) ) / ((double) (2) ) ) )) 
		{
			//line 23 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
			r = ( ((double) (r) ) - ((double) (haxe.lang.Runtime.toDouble(__temp_turn95)) ) );
		}
	...
	public static double clampSym(double v, double max)
	{
		...
		return thx.Floats.clamp(v,  - (max) , max);
	}
	...
	public static double interpolateAngle(double f, double a, double b, java.lang.Object turn)
	{
		...
		double __temp_turn96 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((double) (360) )) : (((double) (haxe.lang.Runtime.toDouble(turn)) )) );
		//line 86 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, ( a + thx.Floats.angleDifference(a, b, __temp_turn96) )), __temp_turn96);
	}
	...
	public static double interpolateAngleWidest(double f, double a, double b, java.lang.Object turn)
	{
		...
		double __temp_turn97 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((double) (360) )) : (((double) (haxe.lang.Runtime.toDouble(turn)) )) );
		//line 94 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return thx.Floats.wrapCircular(( thx.Floats.interpolateAngle(f, a, b, __temp_turn97) - ( __temp_turn97 / 2 ) ), __temp_turn97);
	}
	...
	public static double interpolateAngleCW(double f, double a, double b, java.lang.Object turn)
	{
		...
		double __temp_turn98 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((double) (360) )) : (((double) (haxe.lang.Runtime.toDouble(turn)) )) );
		//line 101 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		a = thx.Floats.wrapCircular(a, __temp_turn98);
		//line 102 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		b = thx.Floats.wrapCircular(b, __temp_turn98);
		...
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, b), __temp_turn98);
	}
	...
	public static double interpolateAngleCCW(double f, double a, double b, java.lang.Object turn)
	{
		...
		double __temp_turn99 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((double) (360) )) : (((double) (haxe.lang.Runtime.toDouble(turn)) )) );
		//line 112 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		a = thx.Floats.wrapCircular(a, __temp_turn99);
		//line 113 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		b = thx.Floats.wrapCircular(b, __temp_turn99);
		...
		return thx.Floats.wrapCircular(thx.Floats.interpolate(f, a, b), __temp_turn99);
	}
	...
	public static boolean nearEquals(double a, double b, java.lang.Object tollerance)
	{
		...
		java.lang.Object __temp_tollerance100 = ( (haxe.lang.Runtime.eq(tollerance, null)) ? (((java.lang.Object) (1e-9) )) : (tollerance) );
		...
		if (haxe.lang.Runtime.isFinite(a)) 
		{
			...
			return ( haxe.lang.Runtime.compare(java.lang.Math.abs(( a - b )), __temp_tollerance100) <= 0 );
		}
	...
	public static boolean nearEqualAngles(double a, double b, java.lang.Object turn, java.lang.Object tollerance)
	{
		...
		java.lang.Object __temp_tollerance102 = ( (haxe.lang.Runtime.eq(tollerance, null)) ? (((java.lang.Object) (1e-9) )) : (tollerance) );
		//line 161 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		java.lang.Object __temp_turn101 = ( (haxe.lang.Runtime.eq(turn, null)) ? (((java.lang.Object) (360.0) )) : (turn) );
		//line 161 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return ( haxe.lang.Runtime.compare(java.lang.Math.abs(thx.Floats.angleDifference(a, b, __temp_turn101)), __temp_tollerance102) <= 0 );
	}
	...
	public static boolean nearZero(double n, java.lang.Object tollerance)
	{
		...
		java.lang.Object __temp_tollerance103 = ( (haxe.lang.Runtime.eq(tollerance, null)) ? (((java.lang.Object) (1e-9) )) : (tollerance) );
		//line 168 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Floats.hx"
		return ( haxe.lang.Runtime.compare(java.lang.Math.abs(n), __temp_tollerance103) <= 0 );
	}
	...
	public static double normalize(double v)
	{
		...
		return thx.Floats.clamp(v, ((double) (0) ), ((double) (1) ));
	}
