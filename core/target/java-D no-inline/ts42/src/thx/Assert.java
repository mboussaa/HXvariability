...
public class Assert extends haxe.lang.HxObject
{
	...
	public static void is(java.lang.Object value, java.lang.Object type, java.lang.String msg, java.lang.Object pos)
	{
		...
		{
			//line 142 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
			msg = ( ( ( "expected type " + thx.Types.anyValueToString(type) ) + " but it is " ) + haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((java.lang.Object) (value) ))) );
		}
	...
	public static void raises(haxe.lang.Function method, java.lang.Object type, java.lang.String msgNotThrown, java.lang.String msgWrongType, java.lang.Object pos)
	{
		...
		try 
		{
			...
			if (( null == msgNotThrown )) 
			{
				...
				java.lang.String name = ( (( null == type )) ? ("Dynamic") : (thx.Types.anyValueToString(type)) );
			...
			//line 294 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
			{
				...
				else
				{
					...
					if (( null == msgWrongType )) 
					{
						...
						java.lang.String name1 = thx.Types.anyValueToString(type);
	...
	public static boolean sameAs(java.lang.Object expected, java.lang.Object value, java.lang.Object status)
	{
		...
		if ( ! (((boolean) (thx.Types.sameType(((java.lang.Object) (expected) ), ((java.lang.Object) (value) ))) )) ) 
		{
			...
			java.lang.String texpected = haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((java.lang.Object) (expected) )));
			//line 405 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
			java.lang.String tvalue = haxe.lang.Runtime.toString(thx.Types.valueTypeToString(((java.lang.Object) (value) )));
		...
		switch (_g.index)
		{
			...
			case 4:
			{
				...
				if (thx.Iterables.isIterable(expected)) 
				{
					...
					if (( haxe.lang.Runtime.toBool(haxe.lang.Runtime.getField(status, "recursive", true)) || ((boolean) (haxe.lang.Runtime.valEq(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(status, "path", true)), "")) ) )) 
					{
						...
						haxe.root.Array evalues1 = ((haxe.root.Array) (thx.Iterables.toArray(((java.lang.Object) (expected) ))) );
						//line 641 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
						haxe.root.Array vvalues1 = ((haxe.root.Array) (thx.Iterables.toArray(((java.lang.Object) (value) ))) );
			...
			case 6:
			{
				...
				if (( expected instanceof haxe.root.Date )) 
				{
					...
					if (( ((haxe.root.Date) (expected) ).getTime() != ((haxe.root.Date) (value) ).getTime() )) 
					{
						...
						//line 471 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
						{
							...
							while (( _g14 < _g5 ))
							{
								...
								if (( ebytes.get(i3) != vbytes.get(i3) )) 
								{
									...
									haxe.lang.Runtime.setField(status, "error", haxe.lang.Runtime.toString(withPath.__hx_invoke1_o(0.0, ( ( ( "expected byte " + ebytes.get(i3) ) + " but it is " ) + vbytes.get(i3) ))));
				...
				if (thx.Iterables.isIterable(expected)) 
				{
					...
					if (( haxe.lang.Runtime.toBool(haxe.lang.Runtime.getField(status, "recursive", true)) || ((boolean) (haxe.lang.Runtime.valEq(haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(status, "path", true)), "")) ) )) 
					{
						...
						haxe.root.Array evalues3 = ((haxe.root.Array) (thx.Iterables.toArray(((java.lang.Object) (expected) ))) );
						//line 528 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Assert.hx"
						haxe.root.Array vvalues3 = ((haxe.root.Array) (thx.Iterables.toArray(((java.lang.Object) (value) ))) );
