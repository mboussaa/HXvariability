...
public class Small extends haxe.lang.HxObject implements thx.bigint.BigIntImpl
{
	...
	public thx.bigint.BigIntImpl addSmall(thx.bigint.Small small)
	{
		...
		else
		{
			...
			return new thx.bigint.Big(thx.bigint.Bigs.addSmall(thx.bigint.Bigs.smallToArray(thx.Ints.abs(small.value)), thx.Ints.abs(this.value)), this.sign);
		}
	...
	public thx.bigint.BigIntImpl addBig(thx.bigint.Big big)
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.addSmall(big.value, thx.Ints.abs(this.value)), this.sign);
	}
	...
	public thx.bigint.BigIntImpl subtractBig(thx.bigint.Big big)
	{
		...
		return thx.bigint.Bigs.subtractSmall(big.value, thx.Ints.abs(this.value), ( this.value >= 0 ));
	}
	...
	public java.lang.Object divModSmall(thx.bigint.Small small)
	{
		//line 82 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Small.hx"
		{
			...
			thx.bigint.BigIntImpl __temp_odecl1 = ((thx.bigint.BigIntImpl) (new thx.bigint.Small(((int) (thx.Floats.trunc(( ((double) (this.value) ) / small.value ))) ))) );
	...
	public java.lang.Object divModBig(thx.bigint.Big big)
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value)), ( this.value < 0 )).divModBig(big);
	}
	...
	public thx.bigint.BigIntImpl multiplySmall(thx.bigint.Small small)
	{
		...
		haxe.root.Array<java.lang.Object> arr = thx.bigint.Bigs.smallToArray(thx.Ints.abs(small.value));
		//line 101 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Small.hx"
		int abs = thx.Ints.abs(this.value);
	...
	public thx.bigint.BigIntImpl multiplyBig(thx.bigint.Big big)
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.multiplyLong(big.value, thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value))), ( this.sign != big.sign ));
	}
	...
	public thx.bigint.BigIntImpl abs()
	{
		...
		return new thx.bigint.Small(((int) (thx.Ints.abs(this.value)) ));
	}
	...
	public thx.bigint.BigIntImpl pow(thx.bigint.BigIntImpl exp)
	{
		...
		if (thx.bigint.Bigs.canPower(this.value, b)) 
		{
			...
			return new thx.bigint.Small(((int) (((int) (java.lang.Math.pow(((double) (this.value) ), ((double) (b) ))) )) ));
		}
		
		//line 145 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Small.hx"
		return new thx.bigint.Big(thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value)), this.sign).pow(exp);
	}
	...
	public thx.bigint.BigIntImpl square()
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.square(thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value))), false);
	}
	...
	public boolean isUnit()
	{
		...
		return ( thx.Ints.abs(this.value) == 1 );
	}
	...
	public int compareToSmall(thx.bigint.Small small)
	{
		...
		return thx.Ints.compare(this.value, small.value);
	}
	...
	public int compareToBig(thx.bigint.Big big)
	{
		...
		return ( thx.bigint.Bigs.compareToAbs(thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value)), big.value) * (( (this.sign) ? (-1) : (1) )) );
	}
	...
	public int compareToAbsSmall(thx.bigint.Small small)
	{
		...
		return thx.Ints.compare(thx.Ints.abs(this.value), thx.Ints.abs(small.value));
	}
	...
	public int compareToAbsBig(thx.bigint.Big big)
	{
		...
		return thx.bigint.Bigs.compareToAbs(thx.bigint.Bigs.smallToArray(thx.Ints.abs(this.value)), big.value);
	}
