...
public class Big extends haxe.lang.HxObject implements thx.bigint.BigIntImpl
{
	...
	public static void __hx_ctor_thx_bigint_Big(thx.bigint.Big __temp_me85, haxe.root.Array<java.lang.Object> value, boolean sign)
	{
		//line 12 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Big.hx"
		__temp_me85.sign = sign;
		//line 13 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Big.hx"
		__temp_me85.value = value;
		//line 14 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Big.hx"
		__temp_me85.isSmall = false;
	}
	...
	public thx.bigint.BigIntImpl addSmall(thx.bigint.Small small)
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.addSmall(this.value, thx.Ints.abs(small.value)), this.sign);
	}
	...
	public thx.bigint.BigIntImpl subtractSmall(thx.bigint.Small small)
	{
		...
		return thx.bigint.Bigs.subtractSmall(this.value, thx.Ints.abs(small.value), this.sign);
	}
	...
	public java.lang.Object divModSmall(thx.bigint.Small small)
	{
		...
		java.lang.Object values = thx.bigint.Bigs.divModSmall(this.value, thx.Ints.abs(small.value));
	...
	public thx.bigint.BigIntImpl multiplySmall(thx.bigint.Small small)
	{
		...
		return new thx.bigint.Big(thx.bigint.Bigs.multiplyLong(this.value, thx.bigint.Bigs.smallToArray(thx.Ints.abs(small.value))), ( this.sign != small.sign ));
	}
	...
	public thx.bigint.BigIntImpl random()
	{
		...
		while (( i >= 0 ))
		{
			...
			digit = thx.Floats.trunc(( java.lang.Math.random() * top ));
	...
	public int compareToSmall(thx.bigint.Small small)
	{
		...
		return ( thx.bigint.Bigs.compareToAbs(this.value, thx.bigint.Bigs.smallToArray(thx.Ints.abs(small.value))) * (( (this.sign) ? (-1) : (1) )) );
	}
	...
	public int compareToAbsSmall(thx.bigint.Small small)
	{
		...
		return thx.bigint.Bigs.compareToAbs(this.value, thx.bigint.Bigs.smallToArray(thx.Ints.abs(small.value)));
	}
