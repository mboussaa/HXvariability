...
public class Bigs extends haxe.lang.HxObject
{
			...
			while (( _g1 < a_l ))
			{
				...
				//line 227 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
				{
					...
					while (( _g3 < b_l ))
					{
						...
						carry = thx.Floats.ftrunc(( product / 10000000 ));
						//line 231 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
						r.__set(( i + j ), thx.Floats.ftrunc(( product - ( carry * 10000000 ) )));
	...
	public static haxe.root.Array<java.lang.Object> multiplySmall(haxe.root.Array<java.lang.Object> a, int b)
	{
		...
		while (( carry > 0 ))
		{
			...
			carry = thx.Floats.ftrunc(( carry / 10000000 ));
		}
	...
	public static haxe.root.Array<java.lang.Object> multiplyKaratsuba(haxe.root.Array<java.lang.Object> x, haxe.root.Array<java.lang.Object> y)
	{
		...
		int n = thx.Ints.max(x.length, y.length);
		...
		haxe.root.Array<java.lang.Object> b = ((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (x.slice(n, null)) )) );
		//line 275 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
		haxe.root.Array<java.lang.Object> a = ((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (x.slice(0, n)) )) );
		//line 275 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
		...
		haxe.root.Array<java.lang.Object> ac = thx.bigint.Bigs.multiplyKaratsuba(a, c);
		//line 280 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
		haxe.root.Array<java.lang.Object> bd = thx.bigint.Bigs.multiplyKaratsuba(b, d);
		//line 280 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
		haxe.root.Array<java.lang.Object> abcd = thx.bigint.Bigs.multiplyKaratsuba(thx.bigint.Bigs.addAny(a, b), thx.bigint.Bigs.addAny(c, d));
		...
		while (( shift >= 0 ))
		{
			...
			//line 368 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
			{
				...
				while (( _g1 < l ))
				{
					...
					q = thx.Floats.ftrunc(( carry / 10000000 ));
	...
	public static java.lang.Object divModSmall(haxe.root.Array<java.lang.Object> value, int lambda)
	{
		...
		while (( i >= 0 ))
		{
			...
			q = thx.Floats.ftrunc(( divisor / lambda ));
		...
		{
			//line 466 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
			int __temp_odecl1 = thx.Floats.trunc(remainder);
			//line 466 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/bigint/Bigs.hx"
	...
	public static thx.bigint.BigIntImpl parseBase(java.lang.String text, int base)
	{
		...
		if (tmp) 
		{
			...
			java.lang.Object exp = ( (haxe.root.StringTools.startsWith(sexp, "+")) ? (haxe.root.Std.parseInt(haxe.lang.StringExt.substring(sexp, 1, null))) : (haxe.root.Std.parseInt(sexp)) );
