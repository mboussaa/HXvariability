...
public class Future<T> extends haxe.lang.HxObject
{
	...
	public Future()
	{
		//line 64 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future.__hx_ctor_thx_promise_Future(((thx.promise.Future<T>) (this) ));
	}
	
	
	public static <T_c> void __hx_ctor_thx_promise_Future(thx.promise.Future<T_c> __temp_me126)
	{
		//line 65 "/HXvariability/promise/src/thx/promise/Future.hx"
		__temp_me126.handlers = new haxe.root.Array<haxe.lang.Function>(( (haxe.lang.Function[]) (new haxe.lang.Function[] {}) ));
		//line 66 "/HXvariability/promise/src/thx/promise/Future.hx"
		__temp_me126.state = haxe.ds.Option.None;
	}
	
	
	public static <T1> thx.promise.Future<haxe.root.Array<T1>> sequence(haxe.root.Array<thx.promise.Future<T1>> arr)
	{
		//line 12 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 28 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 46 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 49 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future<T4> future = new thx.promise.Future<T4>();
		//line 50 "/HXvariability/promise/src/thx/promise/Future.hx"
		handler.__hx_invoke1_o(0.0, ((haxe.lang.Function) (new haxe.lang.Closure(future, "setState")) ));
		//line 51 "/HXvariability/promise/src/thx/promise/Future.hx"
		return future;
	}
	...
	{
		//line 55 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 60 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 10 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 79 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 81 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future<T> _gthis = this;
		//line 82 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 85 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future<T> _gthis = this;
		//line 86 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 90 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future<T> _gthis = this;
		//line 91 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 98 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 102 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 104 "/HXvariability/promise/src/thx/promise/Future.hx"
		thx.promise.Future<T> _gthis = this;
		//line 105 "/HXvariability/promise/src/thx/promise/Future.hx"
	...
	{
		//line 109 "/HXvariability/promise/src/thx/promise/Future.hx"
		this.handlers.push(handler);
		//line 110 "/HXvariability/promise/src/thx/promise/Future.hx"
		this.update();
		//line 111 "/HXvariability/promise/src/thx/promise/Future.hx"
		return this;
	}
	...
	{
		//line 114 "/HXvariability/promise/src/thx/promise/Future.hx"
		return "Future";
	}
	...
	{
		//line 117 "/HXvariability/promise/src/thx/promise/Future.hx"
		{
			//line 117 "/HXvariability/promise/src/thx/promise/Future.hx"
			...
			switch (_g.index)
			{
				case 0:
				{
					//line 120 "/HXvariability/promise/src/thx/promise/Future.hx"
					T r = ((T) (_g.params[0]) );
					//line 121 "/HXvariability/promise/src/thx/promise/Future.hx"
				...
				case 1:
				{
					//line 119 "/HXvariability/promise/src/thx/promise/Future.hx"
		...
		//line 123 "/HXvariability/promise/src/thx/promise/Future.hx"
		this.update();
		//line 124 "/HXvariability/promise/src/thx/promise/Future.hx"
		return this;
	}
	...
	public void update()
	{
		//line 128 "/HXvariability/promise/src/thx/promise/Future.hx"
		haxe.ds.Option _g = this.state;
		//line 128 "/HXvariability/promise/src/thx/promise/Future.hx"
		switch (_g.index)
		{
			case 0:
			{
				//line 130 "/HXvariability/promise/src/thx/promise/Future.hx"
				T result = ((T) (_g.params[0]) );
				//line 130 "/HXvariability/promise/src/thx/promise/Future.hx"
				{
					//line 131 "/HXvariability/promise/src/thx/promise/Future.hx"
					int index = -1;
					//line 132 "/HXvariability/promise/src/thx/promise/Future.hx"
					while ((  ++ index < this.handlers.length ))
					{
						//line 133 "/HXvariability/promise/src/thx/promise/Future.hx"
						haxe.lang.Function handler = this.handlers.__get(index);
						//line 134 "/HXvariability/promise/src/thx/promise/Future.hx"
						handler.__hx_invoke1_o(0.0, result);
					}
					
					//line 136 "/HXvariability/promise/src/thx/promise/Future.hx"
			...
			case 1:
			{
				//line 129 "/HXvariability/promise/src/thx/promise/Future.hx"
				break;
			}
