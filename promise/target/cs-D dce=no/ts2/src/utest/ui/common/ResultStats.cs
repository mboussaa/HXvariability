...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me198) {
			__temp_me198.assertations = 0;
			__temp_me198.successes = 0;
			__temp_me198.failures = 0;
			__temp_me198.errors = 0;
			__temp_me198.warnings = 0;
			__temp_me198.isOk = true;
			__temp_me198.hasFailures = false;
			__temp_me198.hasErrors = false;
			__temp_me198.hasWarnings = false;
			__temp_me198.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me198.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me198.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me198.onAddWarnings = new global::utest.Dispatcher<int>();
		}
