...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me190, string className, string setupName, string teardownName) {
			__temp_me190.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me190.className = className;
			__temp_me190.setupName = setupName;
			__temp_me190.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me190.teardownName = teardownName;
			__temp_me190.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me190.methods = 0;
			__temp_me190.stats = new global::utest.ui.common.ResultStats();
		}
