...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me191, string methodName) {
			__temp_me191.methodName = methodName;
			__temp_me191.list = new global::List<object>();
			__temp_me191.hasTestError = false;
			__temp_me191.hasSetupError = false;
			__temp_me191.hasTeardownError = false;
			__temp_me191.hasTimeoutError = false;
			__temp_me191.hasAsyncError = false;
