...
public class TestFuture extends haxe.lang.HxObject
{
	...
	{
		//line 11 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	{
		//line 12 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		__temp_me130.x = i;
	}
	...
	{
		//line 9 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	{
		//line 16 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 16 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 16 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 16 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 17 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	public void testMap()
	{
		//line 55 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 55 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 55 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 55 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 56 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	{
		//line 62 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 62 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 62 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 62 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 63 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	{
		//line 69 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 69 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 69 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 69 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 70 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			((thx.promise.Future<java.lang.Object>) (((thx.promise.Future) (thx.promise.Future.flatten(((thx.promise.Future<thx.promise.Future<java.lang.Object>>) (((thx.promise.Future) (((thx.promise.Future<thx.promise.Future<java.lang.Object>>) (thx.promise.Future.value(((thx.promise.Future<java.lang.Object>) (((thx.promise.Future) (thx.promise.Future.value(((java.lang.Object) (1) ))) )) ))) )) )) ))) )) ).then(( (( thx.promise.TestFuture_testFlatten_72__Fun.__hx_current != null )) ? (thx.promise.TestFuture_testFlatten_72__Fun.__hx_current) : (thx.promise.TestFuture_testFlatten_72__Fun.__hx_current = ((thx.promise.TestFuture_testFlatten_72__Fun) (new thx.promise.TestFuture_testFlatten_72__Fun()) )) ));
		}
	...
	{
		//line 76 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 76 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 76 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 76 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 77 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
	...
	{
		//line 108 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g1 = 0;
		//line 108 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		int _g = this.x;
		//line 108 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
		while (( _g1 < _g ))
		{
			//line 108 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			 ++ _g1;
			//line 109 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			haxe.lang.Function done = ((haxe.lang.Function) (utest.Assert.createAsync.__hx_invoke2_o(0.0, null, 0.0, null)) );
			//line 111 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
			...
			//line 110 "/HXvariability/promise/test/thx/promise/TestFuture.hx"
