...
public class Sys extends haxe.lang.HxObject
{
	...
	public static java.lang.String programPath()
	{
		...
		{
			//line 161 "/usr/lib/haxe/std/java/_std/Sys.hx"
			return ((java.lang.Class) (((java.lang.Class) (haxe.java.Lib.toNativeType(((java.lang.Class) (haxe.root.Sys.class) ))) )) ).getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
		}
		catch (java.lang.Throwable typedException)
		{
