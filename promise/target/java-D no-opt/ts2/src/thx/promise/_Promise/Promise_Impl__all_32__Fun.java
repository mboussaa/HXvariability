...
public class Promise_Impl__all_32__Fun<T> extends haxe.lang.Function
{
	...
	{
		//line 32 "/HXvariability/promise/src/thx/promise/Promise.hx"
		super(2, 0);
		//line 32 "/HXvariability/promise/src/thx/promise/Promise.hx"
		this.arr = arr;
	}
	...
	@Override public java.lang.Object __hx_invoke2_o(double __fn_float1, java.lang.Object __fn_dyn1, double __fn_float2, java.lang.Object __fn_dyn2)
	{
		...
		//line 33 "/HXvariability/promise/src/thx/promise/Promise.hx"
		haxe.root.Array<T> results = new haxe.root.Array<T>(( (T[]) (new java.lang.Object[] {}) ));
		//line 33 "/HXvariability/promise/src/thx/promise/Promise.hx"
		int[] counter = new int[]{0};
		//line 33 "/HXvariability/promise/src/thx/promise/Promise.hx"
		boolean[] hasError = new boolean[]{false};
		//line 40 "/HXvariability/promise/src/thx/promise/Promise.hx"
		{
			//line 40 "/HXvariability/promise/src/thx/promise/Promise.hx"
			int _g1 = 0;
			//line 40 "/HXvariability/promise/src/thx/promise/Promise.hx"
			...
			while (( _g1 < _g ))
			{
				//line 40 "/HXvariability/promise/src/thx/promise/Promise.hx"
				int i = _g1++;
				//line 41 "/HXvariability/promise/src/thx/promise/Promise.hx"
