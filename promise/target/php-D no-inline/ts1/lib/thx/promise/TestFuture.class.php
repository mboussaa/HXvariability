...
class thx_promise_TestFuture {
	...
	public function testFlatten() {
		...
		while($_g1 < $_g) {
			...
			$tmp1 = thx_promise_Future::value($tmp);
			thx_promise_Future::flatten($tmp1)->then(array(new _hx_lambda(array(), "thx_promise_TestFuture_5"), 'execute'));
			unset($tmp1,$tmp);
		}
	}
	public function testFlatMap() {
		...
		while($_g1 < $_g) {
			++$_g1;
			thx_promise_Future::value(1)->flatMap(array(new _hx_lambda(array(), "thx_promise_TestFuture_6"), 'execute'))->then(array(new _hx_lambda(array(), "thx_promise_TestFuture_7"), 'execute'));
		}
	}
	public function testTuple3() {
		...
		while($_g1 < $_g) {
			...
			thx_promise_FutureTuple3::tuple($tmp, array(new _hx_lambda(array(&$done), "thx_promise_TestFuture_8"), 'execute'));
			unset($tmp,$done);
		}
	}
...
function thx_promise_TestFuture_5($a2) {
	{
...
function thx_promise_TestFuture_6($v) {
	{
		return thx_promise_Future::value("" . _hx_string_rec($v, ""));
	}
}
function thx_promise_TestFuture_7($a2) {
	{
...
function thx_promise_TestFuture_8(&$done, $a, $b, $c) {
	{
