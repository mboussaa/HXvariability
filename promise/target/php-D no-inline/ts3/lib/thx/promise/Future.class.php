	...
	public function setState($newstate) {
		{
			...
			case 0:{
				$tmp = Std::string(_hx_deref($_g)->params[0]);
				$tmp1 = "future was already \"" . _hx_string_or_null($tmp) . "\", can't apply the new state \"";
				$tmp2 = Std::string($newstate);
				throw new HException(new thx_Error(_hx_string_or_null($tmp1) . _hx_string_or_null($tmp2) . "\"", null, _hx_anonymous(array("fileName" => "Future.hx", "lineNumber" => 121, "className" => "thx.promise.Future", "methodName" => "setState"))));
			}break;
			case 1:{
