...
namespace haxe.ds {
	public class BalancedTree<K, V> : global::haxe.lang.HxObject, global::haxe.ds.BalancedTree {
		...
		public static void __hx_ctor_haxe_ds_BalancedTree<K_c, V_c>(global::haxe.ds.BalancedTree<K_c, V_c> __temp_me47) {
		}
...
namespace haxe.ds {
	public class TreeNode<K, V> : global::haxe.lang.HxObject, global::haxe.ds.TreeNode {
		...
		public static void __hx_ctor_haxe_ds_TreeNode<K_c, V_c>(global::haxe.ds.TreeNode<K_c, V_c> __temp_me49, global::haxe.ds.TreeNode<K_c, V_c> l, K_c k, V_c v, global::haxe.ds.TreeNode<K_c, V_c> r, global::haxe.lang.Null<int> h) {
			unchecked {
				int __temp_h48 = ( ( ! (h.hasValue) ) ? (-1) : ((h).@value) );
				__temp_me49.left = l;
				__temp_me49.key = k;
				__temp_me49.@value = v;
				__temp_me49.right = r;
				if (( __temp_h48 == -1 )) {
					int tmp = default(int);
					global::haxe.ds.TreeNode<K_c, V_c> _this = __temp_me49.left;
					int tmp1 = ( (( _this == null )) ? (0) : (_this._height) );
					global::haxe.ds.TreeNode<K_c, V_c> _this1 = __temp_me49.right;
					if (( tmp1 > (( (( _this1 == null )) ? (0) : (_this1._height) )) )) {
						global::haxe.ds.TreeNode<K_c, V_c> _this2 = __temp_me49.left;
						if (( _this2 == null )) {
							tmp = 0;
						}
						else {
						...
						global::haxe.ds.TreeNode<K_c, V_c> _this3 = __temp_me49.right;
						if (( _this3 == null )) {
							tmp = 0;
						}
						else {
					...
					__temp_me49._height = ( tmp + 1 );
				}
				else {
					__temp_me49._height = __temp_h48;
				}
