...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me86, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me86.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me86.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me86.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me86.groupSizesCurrency = groupSizesCurrency;
			__temp_me86.groupSizesNumber = groupSizesNumber;
			__temp_me86.groupSizesPercent = groupSizesPercent;
			__temp_me86.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me86.patternNegativeNumber = patternNegativeNumber;
			__temp_me86.patternNegativePercent = patternNegativePercent;
			__temp_me86.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me86.patternPositivePercent = patternPositivePercent;
			__temp_me86.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me86.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me86.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me86.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me86.separatorGroupNumber = separatorGroupNumber;
			__temp_me86.separatorGroupPercent = separatorGroupPercent;
			__temp_me86.signNegative = signNegative;
			__temp_me86.signPositive = signPositive;
			__temp_me86.symbolCurrency = symbolCurrency;
			__temp_me86.symbolNaN = symbolNaN;
			__temp_me86.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me86.symbolPercent = symbolPercent;
			__temp_me86.symbolPermille = symbolPermille;
			__temp_me86.symbolPositiveInfinity = symbolPositiveInfinity;
		}
