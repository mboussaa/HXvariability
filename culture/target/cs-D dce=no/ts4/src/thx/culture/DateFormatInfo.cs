...
namespace thx.culture {
	public class DateFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_DateFormatInfo(global::thx.culture.DateFormatInfo __temp_me85, int calendarWeekRuleIndex, string calendarWeekRuleName, string designatorAm, string designatorPm, int firstDayOfWeekIndex, string firstDayOfWeekName, string nameCalendar, string nameCalendarNative, global::Array<object> nameDays, global::Array<object> nameDaysAbbreviated, global::Array<object> nameDaysShortest, global::Array<object> nameMonths, global::Array<object> nameMonthsAbbreviated, global::Array<object> nameMonthGenitives, global::Array<object> nameMonthGenitivesAbbreviated, string patternDateLong, string patternDateShort, string patternDateTimeFull, string patternDateTimeSortable, string patternMonthDay, string patternRfc1123, string patternTimeLong, string patternTimeShort, string patternUniversalSortable, string patternYearMonth, string separatorDate, string separatorTime) {
			__temp_me85.calendarWeekRuleIndex = calendarWeekRuleIndex;
			__temp_me85.calendarWeekRuleName = calendarWeekRuleName;
			__temp_me85.designatorAm = designatorAm;
			__temp_me85.designatorPm = designatorPm;
			__temp_me85.firstDayOfWeekIndex = firstDayOfWeekIndex;
			__temp_me85.firstDayOfWeekName = firstDayOfWeekName;
			__temp_me85.nameCalendar = nameCalendar;
			__temp_me85.nameCalendarNative = nameCalendarNative;
			__temp_me85.nameDays = nameDays;
			__temp_me85.nameDaysAbbreviated = nameDaysAbbreviated;
			__temp_me85.nameDaysShortest = nameDaysShortest;
			__temp_me85.nameMonths = nameMonths;
			__temp_me85.nameMonthsAbbreviated = nameMonthsAbbreviated;
			__temp_me85.nameMonthGenitives = nameMonthGenitives;
			__temp_me85.nameMonthGenitivesAbbreviated = nameMonthGenitivesAbbreviated;
			__temp_me85.patternDateLong = patternDateLong;
			__temp_me85.patternDateShort = patternDateShort;
			__temp_me85.patternDateTimeFull = patternDateTimeFull;
			__temp_me85.patternDateTimeSortable = patternDateTimeSortable;
			__temp_me85.patternMonthDay = patternMonthDay;
			__temp_me85.patternRfc1123 = patternRfc1123;
			__temp_me85.patternTimeLong = patternTimeLong;
			__temp_me85.patternTimeShort = patternTimeShort;
			__temp_me85.patternUniversalSortable = patternUniversalSortable;
			__temp_me85.patternYearMonth = patternYearMonth;
			__temp_me85.separatorDate = separatorDate;
			__temp_me85.separatorTime = separatorTime;
		}
