...
namespace thx.culture {
	public class Culture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_Culture(global::thx.culture.Culture __temp_me87, string code, global::thx.culture.DateFormatInfo dateTime, string ietf, bool isNeutral, string iso2, string iso3, bool isRightToLeft, int lcid, string nameCalendar, string nameEnglish, string nameNative, string nameRegionEnglish, string nameRegionNative, global::thx.culture.NumberFormatInfo number, string separatorList, string win3) {
			__temp_me87.code = code;
			__temp_me87.dateTime = dateTime;
			__temp_me87.ietf = ietf;
			__temp_me87.isNeutral = isNeutral;
			__temp_me87.iso2 = iso2;
			__temp_me87.iso3 = iso3;
			__temp_me87.isRightToLeft = isRightToLeft;
			__temp_me87.lcid = lcid;
			__temp_me87.nameCalendar = nameCalendar;
			__temp_me87.nameEnglish = nameEnglish;
			__temp_me87.nameNative = nameNative;
			__temp_me87.nameRegionEnglish = nameRegionEnglish;
			__temp_me87.nameRegionNative = nameRegionNative;
			__temp_me87.number = number;
			__temp_me87.separatorList = separatorList;
			__temp_me87.win3 = win3;
		}
