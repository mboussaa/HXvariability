...
namespace cs._NativeArray {
	public class NativeArrayIterator<T> : global::haxe.lang.HxObject, global::cs._NativeArray.NativeArrayIterator {
		...
		public static void __hx_ctor_cs__NativeArray_NativeArrayIterator<T_c>(global::cs._NativeArray.NativeArrayIterator<T_c> __temp_me28, T_c[] arr) {
			__temp_me28.arr = arr;
			__temp_me28.idx = ((uint) (0) );
		}
		
		
		public static object __hx_cast<T_c_c>(global::cs._NativeArray.NativeArrayIterator me) {
			return ( (( me != null )) ? (me.cs__NativeArray_NativeArrayIterator_cast<T_c_c>()) : (null) );
		}
		
		
		public static new object __hx_createEmpty() {
			return new global::cs._NativeArray.NativeArrayIterator<object>(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) ));
		}
		
		
		public static new object __hx_create(global::Array arr) {
			return new global::cs._NativeArray.NativeArrayIterator<object>(((object[]) (arr[0]) ));
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.arr != null )) {
								T_c[] __temp_new_arr25 = new T_c[this.arr.Length];
								int __temp_i26 = -1;
								while ((  ++ __temp_i26 < this.arr.Length )) {
									object __temp_obj27 = ((object) (this.arr[__temp_i26]) );
									if (( __temp_obj27 != null )) {
										__temp_new_arr25[__temp_i26] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj27);
									}
									
								}
								
								new_me.arr = __temp_new_arr25;
							}
							else {
								new_me.arr = null;
							}
