...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me110) {
			__temp_me110.assertations = 0;
			__temp_me110.successes = 0;
			__temp_me110.failures = 0;
			__temp_me110.errors = 0;
			__temp_me110.warnings = 0;
			__temp_me110.isOk = true;
			__temp_me110.hasFailures = false;
			__temp_me110.hasErrors = false;
			__temp_me110.hasWarnings = false;
			__temp_me110.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me110.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me110.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me110.onAddWarnings = new global::utest.Dispatcher<int>();
		}
