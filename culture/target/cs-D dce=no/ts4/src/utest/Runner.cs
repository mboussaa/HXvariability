...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me93) {
			__temp_me93.globalPattern = null;
			__temp_me93.fixtures = new global::Array<object>();
			__temp_me93.onProgress = new global::utest.Dispatcher<object>();
			__temp_me93.onStart = new global::utest.Dispatcher<object>();
			__temp_me93.onComplete = new global::utest.Dispatcher<object>();
			__temp_me93.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me93.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me93.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me93.length = 0;
		}
