...
namespace thx.culture {
	public class NumberFormatInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_culture_NumberFormatInfo(global::thx.culture.NumberFormatInfo __temp_me85, int decimalDigitsCurrency, int decimalDigitsNumber, int decimalDigitsPercent, global::Array<int> groupSizesCurrency, global::Array<int> groupSizesNumber, global::Array<int> groupSizesPercent, int patternNegativeCurrency, int patternNegativeNumber, int patternNegativePercent, int patternPositiveCurrency, int patternPositivePercent, string separatorDecimalCurrency, string separatorDecimalNumber, string separatorDecimalPercent, string separatorGroupCurrency, string separatorGroupNumber, string separatorGroupPercent, string signNegative, string signPositive, string symbolCurrency, string symbolNaN, string symbolNegativeInfinity, string symbolPercent, string symbolPermille, string symbolPositiveInfinity) {
			__temp_me85.decimalDigitsCurrency = decimalDigitsCurrency;
			__temp_me85.decimalDigitsNumber = decimalDigitsNumber;
			__temp_me85.decimalDigitsPercent = decimalDigitsPercent;
			__temp_me85.groupSizesCurrency = groupSizesCurrency;
			__temp_me85.groupSizesNumber = groupSizesNumber;
			__temp_me85.groupSizesPercent = groupSizesPercent;
			__temp_me85.patternNegativeCurrency = patternNegativeCurrency;
			__temp_me85.patternNegativeNumber = patternNegativeNumber;
			__temp_me85.patternNegativePercent = patternNegativePercent;
			__temp_me85.patternPositiveCurrency = patternPositiveCurrency;
			__temp_me85.patternPositivePercent = patternPositivePercent;
			__temp_me85.separatorDecimalCurrency = separatorDecimalCurrency;
			__temp_me85.separatorDecimalNumber = separatorDecimalNumber;
			__temp_me85.separatorDecimalPercent = separatorDecimalPercent;
			__temp_me85.separatorGroupCurrency = separatorGroupCurrency;
			__temp_me85.separatorGroupNumber = separatorGroupNumber;
			__temp_me85.separatorGroupPercent = separatorGroupPercent;
			__temp_me85.signNegative = signNegative;
			__temp_me85.signPositive = signPositive;
			__temp_me85.symbolCurrency = symbolCurrency;
			__temp_me85.symbolNaN = symbolNaN;
			__temp_me85.symbolNegativeInfinity = symbolNegativeInfinity;
			__temp_me85.symbolPercent = symbolPercent;
			__temp_me85.symbolPermille = symbolPermille;
			__temp_me85.symbolPositiveInfinity = symbolPositiveInfinity;
		}
