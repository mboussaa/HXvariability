...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me109) {
			__temp_me109.assertations = 0;
			__temp_me109.successes = 0;
			__temp_me109.failures = 0;
			__temp_me109.errors = 0;
			__temp_me109.warnings = 0;
			__temp_me109.isOk = true;
			__temp_me109.hasFailures = false;
			__temp_me109.hasErrors = false;
			__temp_me109.hasWarnings = false;
			__temp_me109.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me109.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me109.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me109.onAddWarnings = new global::utest.Dispatcher<int>();
		}
