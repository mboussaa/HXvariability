...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me101, string className, string setupName, string teardownName) {
			__temp_me101.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me101.className = className;
			__temp_me101.setupName = setupName;
			__temp_me101.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me101.teardownName = teardownName;
			__temp_me101.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me101.methods = 0;
			__temp_me101.stats = new global::utest.ui.common.ResultStats();
		}
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority100 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority100) {
