...
public class EReg extends haxe.lang.HxObject
{
	...
	{
		//line 141 "/usr/lib/haxe/std/java/_std/EReg.hx"
	...
	{
		//line 146 "/usr/lib/haxe/std/java/_std/EReg.hx"
			...
			switch (field.hashCode())
			{
				...
				case 107029:
				{
					...
					if (field.equals("len")) 
					{
						...
						__temp_executeDef1 = false;
						//line 24 "/usr/lib/haxe/std/java/_std/EReg.hx"
						return this.len(((int) (haxe.lang.Runtime.toInt(dynargs.__get(0))) ));
					}
				...
				case 109757538:
				{
					...
					if (field.equals("start")) 
					{
						...
						__temp_executeDef1 = false;
						//line 24 "/usr/lib/haxe/std/java/_std/EReg.hx"
						return this.start(((int) (haxe.lang.Runtime.toInt(dynargs.__get(0))) ));
					}
