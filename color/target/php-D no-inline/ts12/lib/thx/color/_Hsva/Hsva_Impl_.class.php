...
class thx_color__Hsva_Hsva_Impl_ {
	...
	static function normalize($this1) {
		return (new _hx_array(array(thx_Floats::wrapCircular($this1[0], 360), thx_Floats::normalize($this1[1]), thx_Floats::normalize($this1[2]), thx_Floats::normalize($this1[3]))));
	}
	...
	static function nearEquals($this1, $other, $tolerance = null) {
		...
		$tmp = null;
		$tmp1 = null;
		$tmp2 = thx_Floats::nearEqualAngles($this1[0], $other[0], null, $tolerance);
		if($tmp2) {
