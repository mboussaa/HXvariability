...
class thx_color__Rgb_Rgb_Impl_ {
	...
	static function min($this1, $other) {
		return (thx_Ints::min(thx_color__Rgb_Rgb_Impl_::get_red($this1), thx_color__Rgb_Rgb_Impl_::get_red($other)) & 255) << 16 | (thx_Ints::min(thx_color__Rgb_Rgb_Impl_::get_green($this1), thx_color__Rgb_Rgb_Impl_::get_green($other)) & 255) << 8 | thx_Ints::min(thx_color__Rgb_Rgb_Impl_::get_blue($this1), thx_color__Rgb_Rgb_Impl_::get_blue($other)) & 255;
	}
	static function max($this1, $other) {
		return (thx_Ints::max(thx_color__Rgb_Rgb_Impl_::get_red($this1), thx_color__Rgb_Rgb_Impl_::get_red($other)) & 255) << 16 | (thx_Ints::max(thx_color__Rgb_Rgb_Impl_::get_green($this1), thx_color__Rgb_Rgb_Impl_::get_green($other)) & 255) << 8 | thx_Ints::max(thx_color__Rgb_Rgb_Impl_::get_blue($this1), thx_color__Rgb_Rgb_Impl_::get_blue($other)) & 255;
	}
