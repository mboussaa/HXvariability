...
class thx_color__LCh_LCh_Impl_ {
	...
	static function normalize($this1) {
		return (new _hx_array(array(thx_Floats::clamp($this1[0], 0, 1), thx_Floats::clamp($this1[1], 0, 1), thx_Floats::wrapCircular($this1[2], 360))));
	}
	...
	static function nearEquals($this1, $other, $tolerance = null) {
		...
		$tmp = null;
		$tmp1 = thx_Floats::nearEqualAngles($this1[0], $other[0], null, $tolerance);
		if($tmp1) {
