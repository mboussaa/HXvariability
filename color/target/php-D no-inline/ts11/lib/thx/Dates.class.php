...
class thx_Dates {
	...
	static function compare($a, $b) {
		$tmp = $a->getTime();
		$tmp1 = $b->getTime();
		return thx_Floats::compare($tmp, $tmp1);
	}
	...
	static function nearEquals($self, $other, $units = null, $period = null) {
		...
		$tmp2 = thx_Dates::lessEquals($min, $other);
		if($tmp2) {
			return thx_Dates::greaterEquals($max, $other);
		} else {
			return false;
		}
	}
	...
	static function more($self, $other) {
		return thx_Dates::greater($self, $other);
	}
	...
	static function moreEqual($self, $other) {
		return thx_Dates::greaterEquals($self, $other);
	}
	...
	static function lessEqual($self, $other) {
		return thx_Dates::lessEquals($self, $other);
	}
