...
class thx_Ints {
	...
	static function lpad($v, $pad = null, $len) {
		...
		$tmp2 = StringTools::lpad("" . _hx_string_rec($v, ""), $pad, $len);
	...
	static function lcm($m, $n) {
		...
		$tmp = Std::int($n / thx_Ints::gcd($m, $n));
		return $m * $tmp;
	}
	static function rpad($v, $pad = null, $len) {
		...
		return StringTools::rpad("" . _hx_string_rec($v, ""), $pad, $len);
	}
	...
	static function parse($s, $base = null) {
		...
		$s = strtolower(StringTools::trim($s));
		$sign = null;
