...
public final class Timestamp_Impl_
{
	public static double create(int year, java.lang.Object month, java.lang.Object day, java.lang.Object hour, java.lang.Object minute, java.lang.Object second)
	{
		...
		return thx.Dates.create(year, month, day, hour, minute, second).getTime();
	}
	...
	public static double now()
	{
		...
		return haxe.root.Date.now().getTime();
	}
	...
	public static double fromString(java.lang.String s)
	{
		...
		return haxe.root.Date.fromString(s).getTime();
	}
	...
	public static double snapNext(double this1, thx.TimePeriod period)
	{
		...
		switch (period)
		{
			...
			case Day:
			{
				...
				//line 49 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d.getFullYear(), d.getMonth(), ( d.getDate() + 1 ), 0, 0, 0).getTime();
			}
			...
			case Week:
			{
				...
				int wd = d1.getDay();
				//line 49 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d1.getFullYear(), d1.getMonth(), ( ( d1.getDate() + 7 ) - wd ), 0, 0, 0).getTime();
			}
			...
			case Month:
			{
				...
				//line 49 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d2.getFullYear(), ( d2.getMonth() + 1 ), 1, 0, 0, 0).getTime();
			}
			...
			case Year:
			{
				...
				//line 49 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(( d3.getFullYear() + 1 ), 0, 1, 0, 0, 0).getTime();
			}
	...
	public static double snapPrev(double this1, thx.TimePeriod period)
	{
		...
		switch (period)
		{
			...
			case Day:
			{
				...
				haxe.root.Date d = haxe.root.Date.fromTime(((double) (this1) ));
				//line 79 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d.getFullYear(), d.getMonth(), d.getDate(), 0, 0, 0).getTime();
			}
			...
			case Week:
			{
				...
				int wd = d1.getDay();
				//line 79 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d1.getFullYear(), d1.getMonth(), ( d1.getDate() - wd ), 0, 0, 0).getTime();
			}
			...
			case Month:
			{
				...
				haxe.root.Date d2 = haxe.root.Date.fromTime(((double) (this1) ));
				//line 79 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d2.getFullYear(), d2.getMonth(), 1, 0, 0, 0).getTime();
			}
			...
			case Year:
			{
				...
				haxe.root.Date d3 = haxe.root.Date.fromTime(((double) (this1) ));
				//line 79 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d3.getFullYear(), 0, 1, 0, 0, 0).getTime();
			}
	...
	public static double snapTo(double this1, thx.TimePeriod period)
	{
		...
		switch (period)
		{
			...
			case Day:
			{
				...
				haxe.root.Date d = haxe.root.Date.fromTime(((double) (this1) ));
				//line 115 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				int mod = ( (( d.getHours() >= 12 )) ? (1) : (0) );
				//line 107 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d.getFullYear(), d.getMonth(), ( d.getDate() + mod ), 0, 0, 0).getTime();
			}
			...
			case Week:
			{
				...
				int wd = d1.getDay();
				//line 119 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				int mod1 = ( (( wd < 3 )) ? ( - (wd) ) : (( (( wd > 3 )) ? (( 7 - wd )) : (( (( d1.getHours() < 12 )) ? ( - (wd) ) : (( 7 - wd )) )) )) );
				//line 107 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d1.getFullYear(), d1.getMonth(), ( d1.getDate() + mod1 ), 0, 0, 0).getTime();
			}
			...
			case Month:
			{
				...
				haxe.root.Date d2 = haxe.root.Date.fromTime(((double) (this1) ));
				//line 124 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				int mod2 = ( (( d2.getDate() > ((int) (java.lang.Math.round(( ((double) (haxe.root.DateTools.getMonthDays(d2)) ) / 2 ))) ) )) ? (1) : (0) );
				//line 107 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(d2.getFullYear(), ( d2.getMonth() + mod2 ), 1, 0, 0, 0).getTime();
			}
			...
			case Year:
			{
				...
				haxe.root.Date d3 = haxe.root.Date.fromTime(((double) (this1) ));
				//line 128 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				int mod3 = ( (( this1 > new haxe.root.Date(d3.getFullYear(), 6, 2, 0, 0, 0).getTime() )) ? (1) : (0) );
				//line 107 "/usr/lib/haxe/lib/thx,core/0,40,1/src/thx/Timestamp.hx"
				return thx.Dates.create(( d3.getFullYear() + mod3 ), 0, 1, 0, 0, 0).getTime();
			}
