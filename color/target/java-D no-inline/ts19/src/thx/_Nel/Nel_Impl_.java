...
public final class Nel_Impl_
{
	...
	public static <B, A> thx.NonEmptyList map(thx.NonEmptyList this1, haxe.lang.Function f)
	{
		...
		return ((thx.NonEmptyList) (thx._Nel.Nel_Impl_.flatMap(((thx.NonEmptyList) (this1) ), ((haxe.lang.Function) (thx.Functions1.compose(((haxe.lang.Function) (new haxe.lang.Closure(thx._Nel.Nel_Impl_.class, "pure")) ), ((haxe.lang.Function) (f) ))) ))) );
	}
	...
	public static <A> haxe.root.Array<A> toArray(thx.NonEmptyList this1)
	{
		...
		return ((haxe.root.Array<A>) (thx.Arrays.reversed(((haxe.root.Array<A>) (go1.__hx_invoke2_o(0.0, new haxe.root.Array<A>(( (A[]) (new java.lang.Object[] {}) )), 0.0, this1)) ))) );
	}
