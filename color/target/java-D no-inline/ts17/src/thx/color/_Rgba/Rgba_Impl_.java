...
public final class Rgba_Impl_
{
	...
	{
		//line 16 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 19 "/HXvariability/color/src/thx/color/Rgba.hx"
		...
		//line 20 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 24 "/HXvariability/color/src/thx/color/Rgba.hx"
		return rgba;
	}
	...
	{
		//line 27 "/HXvariability/color/src/thx/color/Rgba.hx"
		thx.ArrayInts.resize(arr, 4, null);
		//line 28 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 32 "/HXvariability/color/src/thx/color/Rgba.hx"
		thx.color.parse.ColorInfo info = thx.color.parse.ColorParser.parseHex(color);
		//line 33 "/HXvariability/color/src/thx/color/Rgba.hx"
		if (( null == info )) 
		{
			//line 34 "/HXvariability/color/src/thx/color/Rgba.hx"
			info = thx.color.parse.ColorParser.parseColor(color);
		}
		
		//line 35 "/HXvariability/color/src/thx/color/Rgba.hx"
		if (( null == info )) 
		{
			//line 36 "/HXvariability/color/src/thx/color/Rgba.hx"
			return null;
		}
		
		//line 38 "/HXvariability/color/src/thx/color/Rgba.hx"
		try 
		{
			//line 38 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 53 "/HXvariability/color/src/thx/color/Rgba.hx"
		return ((int) (rgba) );
	}
	...
	{
		//line 62 "/HXvariability/color/src/thx/color/Rgba.hx"
		double a = ( ((double) ((( ((int) (this1) ) & 255 ))) ) / 255 );
		//line 63 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 71 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 74 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 77 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 80 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 83 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 86 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 89 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 92 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 95 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 98 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 101 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 104 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 107 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 110 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 113 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 116 "/HXvariability/color/src/thx/color/Rgba.hx"
		return thx.Floats.toString(((double) (this1) ));
	}
	
	
	public static java.lang.String toString(int this1)
	{
		//line 119 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 122 "/HXvariability/color/src/thx/color/Rgba.hx"
		if (( prefix == null )) 
		{
			//line 122 "/HXvariability/color/src/thx/color/Rgba.hx"
			prefix = "#";
	...
	{
		//line 125 "/HXvariability/color/src/thx/color/Rgba.hx"
	...
	{
		//line 128 "/HXvariability/color/src/thx/color/Rgba.hx"
		return ( this1 & 255 );
	}
	...
	{
		//line 130 "/HXvariability/color/src/thx/color/Rgba.hx"
		return ( ( this1 >> 24 ) & 255 );
	}
	...
	{
		//line 132 "/HXvariability/color/src/thx/color/Rgba.hx"
		return ( ( this1 >> 16 ) & 255 );
	}
	...
	{
		//line 134 "/HXvariability/color/src/thx/color/Rgba.hx"
		return ( ( this1 >> 8 ) & 255 );
	}
