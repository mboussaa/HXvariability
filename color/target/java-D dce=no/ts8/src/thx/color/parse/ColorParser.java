...
public class ColorParser extends haxe.lang.HxObject
{
	static
	{
		//line 7 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		thx.color.parse.ColorParser.parser = new thx.color.parse.ColorParser();
		//line 24 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	public ColorParser()
	{
		//line 19 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		thx.color.parse.ColorParser.__hx_ctor_thx_color_parse_ColorParser(this);
	}
	
	
	public static void __hx_ctor_thx_color_parse_ColorParser(thx.color.parse.ColorParser __temp_me157)
	{
		//line 20 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me157.pattern_color = new haxe.root.EReg("^\\s*([^(]+)\\s*\\(([^)]*)\\)\\s*$", "i");
		//line 21 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me157.pattern_channel = new haxe.root.EReg("^\\s*(-?\\d*.\\d+|-?\\d+)(%|deg|rad)?\\s*$", "i");
	}
	...
	{
		//line 9 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 12 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 15 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 100 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if (( length != channels.length )) 
		{
			//line 101 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			throw haxe.lang.HaxeException.wrap(( ( ( "invalid number of channels, expected " + length ) + " but it is " ) + channels.length ));
		}
		
		//line 102 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		boolean a2 = useInt8;
		//line 102 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 106 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if (( length != channels.length )) 
		{
			//line 107 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			throw haxe.lang.HaxeException.wrap(( ( ( "invalid number of channels, expected " + length ) + " but it is " ) + channels.length ));
		}
		
		//line 108 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 112 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		boolean __temp_useInt8156 = ( (haxe.lang.Runtime.eq(useInt8, null)) ? (true) : (haxe.lang.Runtime.toBool(useInt8)) );
		//line 112 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		switch (channel.index)
		{
			case 0:
			{
				//line 119 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 1:
			{
				//line 114 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 2:
			{
				//line 116 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 3:
			{
				//line 117 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				int v3 = ((int) (haxe.lang.Runtime.toInt(channel.params[0])) );
				//line 117 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				if (__temp_useInt8156) 
				{
					//line 112 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				...
				{
					//line 118 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 4:
			{
				//line 115 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 5:
			{
				//line 113 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		//line 111 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		return 0.0;
	}
	...
	{
		//line 124 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		switch (channel.index)
		{
			case 0:
			{
				//line 127 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				double v = ((double) (haxe.lang.Runtime.toDouble(channel.params[0])) );
				//line 124 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 3:
			{
				//line 126 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			case 5:
			{
				//line 125 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			default:
			{
				//line 128 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 6 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 26 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if ( ! (thx.color.parse.ColorParser.isPureHex.match(s)) ) 
		{
			//line 27 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			if (haxe.lang.Runtime.valEq(haxe.lang.StringExt.substr(s, 0, 1), "#")) 
			{
				//line 28 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				if (( s.length() == 4 )) 
				{
					//line 29 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				...
				{
					//line 30 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					if (( s.length() == 5 )) 
					{
						//line 31 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					...
					{
						//line 33 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			{
				//line 34 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				if (haxe.lang.Runtime.valEq(haxe.lang.StringExt.substr(s, 0, 2), "0x")) 
				{
					//line 35 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					s = haxe.lang.StringExt.substr(s, 2, null);
				}
				else
				{
					//line 37 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					return null;
				}
		...
		//line 40 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		//line 41 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		while (( s.length() > 0 ))
		{
			//line 42 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			...
			//line 43 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			s = haxe.lang.StringExt.substr(s, 2, null);
		}
		
		//line 45 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if (( channels.length == 4 )) 
		{
			//line 46 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		{
			//line 48 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 52 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if ( ! (this.pattern_color.match(s)) ) 
		{
			//line 53 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			return null;
		}
		
		//line 55 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		java.lang.String name = this.pattern_color.matched(1);
		//line 56 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if (( null == name )) 
		{
			//line 56 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			return null;
		...
		//line 58 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		name = name.toLowerCase();
		//line 60 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		//line 64 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		{
			//line 64 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			int _g = 0;
			//line 64 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			while (( _g < s_channels.length ))
			{
				...
				//line 64 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				 ++ _g;
				//line 65 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				channel = this.processChannel(s_channel);
				//line 66 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				if (( null == channel )) 
				{
					//line 66 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					return null;
				...
				//line 67 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
				channels.push(channel);
			}
			
		}
		
		//line 69 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
	...
	{
		//line 73 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		//line 74 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		java.lang.String value = this.pattern_channel.matched(1);
		//line 74 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		java.lang.String unit = this.pattern_channel.matched(2);
		//line 76 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		if (( unit == null )) 
		{
			//line 76 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			unit = "";
		...
		//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		try 
		{
			//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
			{
				...
				switch (__temp_hash5)
				{
					case 0:
					{
						...
						if (__temp_svar3.equals("")) 
						{
							...
							//line 84 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							if (haxe.lang.Runtime.valEq(value, ( haxe.lang.Runtime.toString("") + haxe.lang.Runtime.toString(thx.Ints.parse(value, null)) ))) 
							{
								//line 85 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
								java.lang.Object i = thx.Ints.parse(value, null);
								//line 86 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
								...
								{
									//line 88 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
									...
									{
										//line 90 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							...
							{
								//line 93 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					...
					case 80885:
					{
						...
						if (( (( ( __temp_hash5 == 112661 ) && __temp_svar3.equals("rad") )) || __temp_svar3.equals("RAD") )) 
						{
							//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							__temp_executeDef4 = false;
							//line 82 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							if (thx.Floats.canParse(value)) 
							{
								//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					...
					case 37:
					{
						...
						if (__temp_svar3.equals("%")) 
						{
							//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							__temp_executeDef4 = false;
							//line 78 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							if (thx.Floats.canParse(value)) 
							{
								//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
					...
					case 67558:
					{
						...
						if (( (( ( __temp_hash5 == 99334 ) && __temp_svar3.equals("deg") )) || __temp_svar3.equals("DEG") )) 
						{
							//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							__temp_executeDef4 = false;
							//line 80 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
							if (thx.Floats.canParse(value)) 
							{
								//line 77 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		...
		catch (java.lang.Throwable __temp_catchallException1)
		{
			...
			//line 96 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
