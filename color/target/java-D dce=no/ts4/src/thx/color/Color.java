...
public class Color extends haxe.lang.HxObject
{
	static
	{
		//line 11 "/HXvariability/color/src/thx/color/Color.hx"
	...
	public Color()
	{
		//line 10 "/HXvariability/color/src/thx/color/Color.hx"
		thx.color.Color.__hx_ctor_thx_color_Color(this);
	}
	
	
	public static void __hx_ctor_thx_color_Color(thx.color.Color __temp_me126)
	{
	}
	...
	{
		//line 17 "/HXvariability/color/src/thx/color/Color.hx"
		thx.color.parse.ColorInfo info = thx.color.parse.ColorParser.parseHex(color);
		//line 18 "/HXvariability/color/src/thx/color/Color.hx"
		if (( null == info )) 
		{
			//line 19 "/HXvariability/color/src/thx/color/Color.hx"
			info = thx.color.parse.ColorParser.parseColor(color);
		}
		
		//line 20 "/HXvariability/color/src/thx/color/Color.hx"
		if (( null == info )) 
		{
			//line 21 "/HXvariability/color/src/thx/color/Color.hx"
			haxe.root.Array<java.lang.Object> rgb = ((haxe.root.Array<java.lang.Object>) (thx.color.Color.namedColors.get(color)) );
			//line 22 "/HXvariability/color/src/thx/color/Color.hx"
			if (( null == rgb )) 
			{
				//line 23 "/HXvariability/color/src/thx/color/Color.hx"
				return null;
			}
			else
			{
				//line 25 "/HXvariability/color/src/thx/color/Color.hx"
				return thx.color._Rgbx.Rgbx_Impl_.toRgbxa(rgb);
			}
			
		}
		
		//line 28 "/HXvariability/color/src/thx/color/Color.hx"
		try 
		{
			//line 28 "/HXvariability/color/src/thx/color/Color.hx"
	...
	{
		//line 72 "/HXvariability/color/src/thx/color/Color.hx"
	...
	{
		//line 75 "/HXvariability/color/src/thx/color/Color.hx"
