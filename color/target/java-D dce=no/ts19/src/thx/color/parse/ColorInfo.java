...
public class ColorInfo extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_color_parse_ColorInfo(thx.color.parse.ColorInfo __temp_me157, java.lang.String name, haxe.root.Array<thx.color.parse.ChannelInfo> channels)
	{
		//line 137 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me157.name = name;
		//line 138 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me157.channels = channels;
	}
