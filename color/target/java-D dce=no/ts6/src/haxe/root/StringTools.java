...
public class StringTools extends haxe.lang.HxObject
{
	...
	{
		//line 173 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 185 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 213 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 291 "/usr/lib/haxe/std/StringTools.hx"
		int l = s.length();
		//line 292 "/usr/lib/haxe/std/StringTools.hx"
		int r = 0;
		//line 293 "/usr/lib/haxe/std/StringTools.hx"
		while (( ( r < l ) && haxe.root.StringTools.isSpace(s, ( ( l - r ) - 1 )) ))
		{
			//line 294 "/usr/lib/haxe/std/StringTools.hx"
			 ++ r;
		}
		...
		if (( r > 0 )) 
		{
			//line 297 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 446 "/usr/lib/haxe/std/StringTools.hx"
		if (( index < s.length() )) 
		{
			//line 446 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 475 "/usr/lib/haxe/std/StringTools.hx"
		return ( c == -1 );
	}
	...
	{
		//line 492 "/usr/lib/haxe/std/StringTools.hx"
		if (haxe.lang.Runtime.valEq(argument, "")) 
		{
			//line 493 "/usr/lib/haxe/std/StringTools.hx"
			return "\'\'";
		}
		
		//line 495 "/usr/lib/haxe/std/StringTools.hx"
		if ( ! (new haxe.root.EReg("[^a-zA-Z0-9_@%+=:,./-]", "").match(argument)) ) 
		{
			//line 496 "/usr/lib/haxe/std/StringTools.hx"
			return argument;
		}
		
		//line 500 "/usr/lib/haxe/std/StringTools.hx"
	...
	{
		//line 584 "/usr/lib/haxe/std/StringTools.hx"
