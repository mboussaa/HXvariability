...
public class ColorParser extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_thx_color_parse_ColorParser(thx.color.parse.ColorParser __temp_me158)
	{
		//line 20 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me158.pattern_color = new haxe.root.EReg("^\\s*([^(]+)\\s*\\(([^)]*)\\)\\s*$", "i");
		//line 21 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
		__temp_me158.pattern_channel = new haxe.root.EReg("^\\s*(-?\\d*.\\d+|-?\\d+)(%|deg|rad)?\\s*$", "i");
	}
	...
	public static double getFloatChannel(thx.color.parse.ChannelInfo channel, java.lang.Object useInt8)
	{
		...
		boolean __temp_useInt8157 = ( (haxe.lang.Runtime.eq(useInt8, null)) ? (true) : (haxe.lang.Runtime.toBool(useInt8)) );
		//line 112 "/HXvariability/color/src/thx/color/parse/ColorParser.hx"
