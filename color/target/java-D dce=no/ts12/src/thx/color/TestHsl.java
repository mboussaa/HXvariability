...
public class TestHsl extends haxe.lang.HxObject
{
	...
	{
		//line 8 "/HXvariability/color/test/thx/color/TestHsl.hx"
		thx.color.TestHsl.__hx_ctor_thx_color_TestHsl(this, i);
	}
	
	
	public static void __hx_ctor_thx_color_TestHsl(thx.color.TestHsl __temp_me151, int i)
	{
		//line 9 "/HXvariability/color/test/thx/color/TestHsl.hx"
		__temp_me151.x = i;
	}
	...
	{
		//line 6 "/HXvariability/color/test/thx/color/TestHsl.hx"
	...
	{
		//line 13 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g1 = 0;
		//line 13 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g = this.x;
		//line 13 "/HXvariability/color/test/thx/color/TestHsl.hx"
		while (( _g1 < _g ))
		{
			//line 13 "/HXvariability/color/test/thx/color/TestHsl.hx"
			 ++ _g1;
			//line 14 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 15 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 16 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 17 "/HXvariability/color/test/thx/color/TestHsl.hx"
	...
	{
		//line 21 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g1 = 0;
		//line 21 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g = this.x;
		//line 21 "/HXvariability/color/test/thx/color/TestHsl.hx"
		while (( _g1 < _g ))
		{
			//line 21 "/HXvariability/color/test/thx/color/TestHsl.hx"
			 ++ _g1;
			//line 22 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 22 "/HXvariability/color/test/thx/color/TestHsl.hx"
			haxe.root.Array<java.lang.Object> hsl = ((haxe.root.Array<java.lang.Object>) (this1) );
			//line 23 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 24 "/HXvariability/color/test/thx/color/TestHsl.hx"
	...
	{
		//line 28 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g1 = 0;
		//line 28 "/HXvariability/color/test/thx/color/TestHsl.hx"
		int _g = this.x;
		//line 28 "/HXvariability/color/test/thx/color/TestHsl.hx"
		while (( _g1 < _g ))
		{
			//line 28 "/HXvariability/color/test/thx/color/TestHsl.hx"
			 ++ _g1;
			//line 29 "/HXvariability/color/test/thx/color/TestHsl.hx"
			...
			//line 30 "/HXvariability/color/test/thx/color/TestHsl.hx"
