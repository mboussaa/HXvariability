...
public class Runner extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_utest_Runner(utest.Runner __temp_me163)
	{
		//line 57 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.globalPattern = null;
		//line 63 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.fixtures = new haxe.root.Array<utest.TestFixture>();
		...
		__temp_me163.onStart = new utest.Dispatcher<utest.Runner>();
		//line 66 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.onComplete = new utest.Dispatcher<utest.Runner>();
		//line 67 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.onPrecheck = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
		//line 68 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.onTestStart = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
		//line 69 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.onTestComplete = new utest.Dispatcher<utest.TestHandler<utest.TestFixture>>();
		//line 70 "/usr/lib/haxe/lib/utest/1,4,1/src/utest/Runner.hx"
		__temp_me163.length = 0;
	}
