...
namespace thx.color._Grey {
	public sealed class Grey_Impl_ {
		...
		public static bool nearEquals(double this1, double other, global::haxe.lang.Null<double> tolerance) {
			global::haxe.lang.Null<double> __temp_tolerance166 = ( ( ! (tolerance.hasValue) ) ? (new global::haxe.lang.Null<double>(1e-9, true)) : (tolerance) );
			return global::thx.Floats.nearEquals(this1, ((double) (other) ), __temp_tolerance166);
		}
