...
public sealed class EReg : global::haxe.lang.HxObject {
	...
	public static void __hx_ctor__EReg(global::EReg __temp_me12, string r, string opt) {
		unchecked {
			...
			__temp_me12.regex = new global::System.Text.RegularExpressions.Regex(((string) (r) ), ((global::System.Text.RegularExpressions.RegexOptions) (((object) (opts) )) ));
		}
	}
	...
	public bool matchSub(string s, int pos, global::haxe.lang.Null<int> len) {
		unchecked {
			int __temp_len11 = ( ( ! (len.hasValue) ) ? (-1) : ((len).@value) );
			this.m = ( (( __temp_len11 < 0 )) ? (this.regex.Match(((string) (s) ), ((int) (pos) ))) : (this.regex.Match(((string) (s) ), ((int) (pos) ), ((int) (__temp_len11) ))) );
			this.cur = s;
			return ( this.m as global::System.Text.RegularExpressions.Group ).Success;
		}
	}
