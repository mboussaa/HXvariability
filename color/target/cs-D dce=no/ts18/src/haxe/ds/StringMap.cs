...
namespace haxe.ds {
	public class StringMap<T> : global::haxe.lang.HxObject, global::haxe.ds.StringMap, global::haxe.IMap<object, T> {
		...
		public static void __hx_ctor_haxe_ds_StringMap<T_c>(global::haxe.ds.StringMap<T_c> __temp_me79) {
			unchecked {
				__temp_me79.cachedIndex = -1;
			}
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								T_c[] __temp_new_arr76 = new T_c[this.vals.Length];
								int __temp_i77 = -1;
								while ((  ++ __temp_i77 < this.vals.Length )) {
									object __temp_obj78 = ((object) (this.vals[__temp_i77]) );
									if (( __temp_obj78 != null )) {
										__temp_new_arr76[__temp_i77] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj78);
									}
									
								}
								
								new_me.vals = __temp_new_arr76;
							}
							else {
								new_me.vals = null;
							}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapKeyIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapKeyIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapKeyIterator<T_c>(global::haxe.ds._StringMap.StringMapKeyIterator<T_c> __temp_me80, global::haxe.ds.StringMap<T_c> m) {
			__temp_me80.m = m;
			__temp_me80.i = 0;
			__temp_me80.len = m.nBuckets;
		}
...
namespace haxe.ds._StringMap {
	public sealed class StringMapValueIterator<T> : global::haxe.lang.HxObject, global::haxe.ds._StringMap.StringMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__StringMap_StringMapValueIterator<T_c>(global::haxe.ds._StringMap.StringMapValueIterator<T_c> __temp_me81, global::haxe.ds.StringMap<T_c> m) {
			__temp_me81.m = m;
			__temp_me81.i = 0;
