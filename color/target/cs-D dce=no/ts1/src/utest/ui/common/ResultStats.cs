...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me217) {
			__temp_me217.assertations = 0;
			__temp_me217.successes = 0;
			__temp_me217.failures = 0;
			__temp_me217.errors = 0;
			__temp_me217.warnings = 0;
			__temp_me217.isOk = true;
			__temp_me217.hasFailures = false;
			__temp_me217.hasErrors = false;
			__temp_me217.hasWarnings = false;
			__temp_me217.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me217.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me217.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me217.onAddWarnings = new global::utest.Dispatcher<int>();
		}
