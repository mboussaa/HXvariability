...
namespace utest.ui.common {
	public class ResultStats : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultStats(global::utest.ui.common.ResultStats __temp_me216) {
			__temp_me216.assertations = 0;
			__temp_me216.successes = 0;
			__temp_me216.failures = 0;
			__temp_me216.errors = 0;
			__temp_me216.warnings = 0;
			__temp_me216.isOk = true;
			__temp_me216.hasFailures = false;
			__temp_me216.hasErrors = false;
			__temp_me216.hasWarnings = false;
			__temp_me216.onAddSuccesses = new global::utest.Dispatcher<int>();
			__temp_me216.onAddFailures = new global::utest.Dispatcher<int>();
			__temp_me216.onAddErrors = new global::utest.Dispatcher<int>();
			__temp_me216.onAddWarnings = new global::utest.Dispatcher<int>();
		}
