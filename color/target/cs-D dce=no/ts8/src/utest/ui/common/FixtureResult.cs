...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me210, string methodName) {
			__temp_me210.methodName = methodName;
			__temp_me210.list = new global::List<object>();
			__temp_me210.hasTestError = false;
			__temp_me210.hasSetupError = false;
			__temp_me210.hasTeardownError = false;
			__temp_me210.hasTimeoutError = false;
			__temp_me210.hasAsyncError = false;
