...
namespace utest {
	public class Runner : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_Runner(global::utest.Runner __temp_me200) {
			__temp_me200.globalPattern = null;
			__temp_me200.fixtures = new global::Array<object>();
			__temp_me200.onProgress = new global::utest.Dispatcher<object>();
			__temp_me200.onStart = new global::utest.Dispatcher<object>();
			__temp_me200.onComplete = new global::utest.Dispatcher<object>();
			__temp_me200.onPrecheck = new global::utest.Dispatcher<object>();
			__temp_me200.onTestStart = new global::utest.Dispatcher<object>();
			__temp_me200.onTestComplete = new global::utest.Dispatcher<object>();
			__temp_me200.length = 0;
		}
