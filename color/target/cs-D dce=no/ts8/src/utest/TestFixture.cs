...
namespace utest {
	public class TestFixture : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_TestFixture(global::utest.TestFixture __temp_me201, object target, string method, string setup, string teardown) {
			__temp_me201.target = target;
			__temp_me201.method = method;
			__temp_me201.setup = setup;
			__temp_me201.teardown = teardown;
		}
