...
namespace thx.color.parse {
	public class ColorParser : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_color_parse_ColorParser(global::thx.color.parse.ColorParser __temp_me192) {
			__temp_me192.pattern_color = new global::EReg("^\\s*([^(]+)\\s*\\(([^)]*)\\)\\s*$", "i");
			__temp_me192.pattern_channel = new global::EReg("^\\s*(-?\\d*.\\d+|-?\\d+)(%|deg|rad)?\\s*$", "i");
		}
		...
		public static double getFloatChannel(global::thx.color.parse.ChannelInfo channel, global::haxe.lang.Null<bool> useInt8) {
			unchecked {
				bool __temp_useInt8191 = ( ( ! (useInt8.hasValue) ) ? (true) : ((useInt8).@value) );
...
namespace thx.color.parse {
	public class ColorInfo : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_color_parse_ColorInfo(global::thx.color.parse.ColorInfo __temp_me193, string name, global::Array<object> channels) {
			__temp_me193.name = name;
			__temp_me193.channels = channels;
		}
