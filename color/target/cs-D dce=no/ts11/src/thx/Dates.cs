...
namespace thx {
	public class Dates : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_thx_Dates(global::thx.Dates __temp_me108) {
		}
		...
		public static global::Date create(int year, global::haxe.lang.Null<int> month, global::haxe.lang.Null<int> day, global::haxe.lang.Null<int> hour, global::haxe.lang.Null<int> minute, global::haxe.lang.Null<int> second) {
			unchecked {
				global::haxe.lang.Null<int> __temp_second105 = ( ( ! (second.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (second) );
				global::haxe.lang.Null<int> __temp_minute104 = ( ( ! (minute.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (minute) );
				global::haxe.lang.Null<int> __temp_hour103 = ( ( ! (hour.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (hour) );
				global::haxe.lang.Null<int> __temp_day102 = ( ( ! (day.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (day) );
				global::haxe.lang.Null<int> __temp_month101 = ( ( ! (month.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (month) );
				__temp_minute104 = new global::haxe.lang.Null<int>(( (__temp_minute104).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_second105).@value) ) / 60 )) ))) ) ), true);
				__temp_second105 = new global::haxe.lang.Null<int>(((int) (( (__temp_second105).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_second105).@value < 0 )) {
					__temp_second105 = new global::haxe.lang.Null<int>(( (__temp_second105).@value + 60 ), true);
				}
				
				__temp_hour103 = new global::haxe.lang.Null<int>(( (__temp_hour103).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_minute104).@value) ) / 60 )) ))) ) ), true);
				__temp_minute104 = new global::haxe.lang.Null<int>(((int) (( (__temp_minute104).@value % (new global::haxe.lang.Null<int>(60, true)).@value )) ), true);
				if (( (__temp_minute104).@value < 0 )) {
					__temp_minute104 = new global::haxe.lang.Null<int>(( (__temp_minute104).@value + 60 ), true);
				}
				
				__temp_day102 = new global::haxe.lang.Null<int>(( (__temp_day102).@value + ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_hour103).@value) ) / 24 )) ))) ) ), true);
				__temp_hour103 = new global::haxe.lang.Null<int>(((int) (( (__temp_hour103).@value % (new global::haxe.lang.Null<int>(24, true)).@value )) ), true);
				if (( (__temp_hour103).@value < 0 )) {
					__temp_hour103 = new global::haxe.lang.Null<int>(( (__temp_hour103).@value + 24 ), true);
				}
				
				if (global::haxe.lang.Runtime.eq((__temp_day102).toDynamic(), 0)) {
					{
						__temp_month101 = new global::haxe.lang.Null<int>(( (__temp_month101).@value - 1 ), true);
					}
					
					if (( (__temp_month101).@value < 0 )) {
						__temp_month101 = new global::haxe.lang.Null<int>(11, true);
						 -- year;
					}
					
					__temp_day102 = new global::haxe.lang.Null<int>(global::thx.Dates.daysInMonth(year, (__temp_month101).@value), true);
				}
				
				year += ((int) (global::System.Math.Floor(((double) (( ((double) ((__temp_month101).@value) ) / 12 )) ))) );
				__temp_month101 = new global::haxe.lang.Null<int>(((int) (( (__temp_month101).@value % (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
				if (( (__temp_month101).@value < 0 )) {
					__temp_month101 = new global::haxe.lang.Null<int>(( (__temp_month101).@value + 12 ), true);
				}
				
				int days = global::thx.Dates.daysInMonth(year, (__temp_month101).@value);
				while (( (__temp_day102).@value > days )) {
					if (( (__temp_day102).@value > days )) {
						__temp_day102 = new global::haxe.lang.Null<int>(((int) (( (__temp_day102).@value - (new global::haxe.lang.Null<int>(days, true)).@value )) ), true);
						{
							__temp_month101 = new global::haxe.lang.Null<int>(( (__temp_month101).@value + 1 ), true);
						}
					...
					if (( (__temp_month101).@value > 11 )) {
						__temp_month101 = new global::haxe.lang.Null<int>(((int) (( (__temp_month101).@value - (new global::haxe.lang.Null<int>(12, true)).@value )) ), true);
						 ++ year;
					}
					
					days = global::thx.Dates.daysInMonth(year, (__temp_month101).@value);
				}
				
				return new global::Date(year, (__temp_month101).@value, (__temp_day102).@value, (__temp_hour103).@value, (__temp_minute104).@value, (__temp_second105).@value);
			}
		}
		...
		public static bool nearEquals(global::Date self, global::Date other, global::haxe.lang.Null<int> units, global::thx.TimePeriod period) {
			unchecked {
				global::haxe.lang.Null<int> __temp_units106 = ( ( ! (units.hasValue) ) ? (new global::haxe.lang.Null<int>(1, true)) : (units) );
				if (( null == period )) {
					period = global::thx.TimePeriod.Second;
				}
				
				if (( (__temp_units106).@value < 0 )) {
					__temp_units106 = new global::haxe.lang.Null<int>(( - ((__temp_units106).@value) ), true);
				}
				
				global::Date min = global::thx.Dates.jump(self, period, ( - ((__temp_units106).@value) ));
				global::Date max = global::thx.Dates.jump(self, period, (__temp_units106).@value);
		...
		public static global::Date snapToWeekDay(global::Date date, int day, global::haxe.lang.Null<int> firstDayOfWk) {
			unchecked {
				global::haxe.lang.Null<int> __temp_firstDayOfWk107 = ( ( ! (firstDayOfWk.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (firstDayOfWk) );
				int d = ((int) (global::haxe.lang.Runtime.toInt(((object) (date.date.DayOfWeek) ))) );
				int s = day;
				if (( s < (__temp_firstDayOfWk107).@value )) {
					s += 7;
				}
				
				if (( d < (__temp_firstDayOfWk107).@value )) {
					d += 7;
				}
