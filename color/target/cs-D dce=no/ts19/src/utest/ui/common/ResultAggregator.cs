...
namespace utest.ui.common {
	public class ResultAggregator : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ResultAggregator(global::utest.ui.common.ResultAggregator __temp_me215, global::utest.Runner runner, global::haxe.lang.Null<bool> flattenPackage) {
			bool __temp_flattenPackage214 = ( ( ! (flattenPackage.hasValue) ) ? (false) : ((flattenPackage).@value) );
			if (( runner == null )) {
				throw global::haxe.lang.HaxeException.wrap("runner argument is null");
			}
			
			__temp_me215.flattenPackage = __temp_flattenPackage214;
			__temp_me215.runner = runner;
			runner.onStart.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me215, "start", 67859554)) ));
			runner.onProgress.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me215, "progress", 103479213)) ));
			runner.onComplete.@add(((global::haxe.lang.Function) (new global::haxe.lang.Closure(__temp_me215, "complete", 2143813817)) ));
			__temp_me215.onStart = new global::utest.Notifier();
			__temp_me215.onComplete = new global::utest.Dispatcher<object>();
			__temp_me215.onProgress = new global::utest.Dispatcher<object>();
		}
