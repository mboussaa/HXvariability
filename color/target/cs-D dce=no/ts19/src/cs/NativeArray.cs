...
namespace cs._NativeArray {
	public class NativeArrayIterator<T> : global::haxe.lang.HxObject, global::cs._NativeArray.NativeArrayIterator {
		...
		public static void __hx_ctor_cs__NativeArray_NativeArrayIterator<T_c>(global::cs._NativeArray.NativeArrayIterator<T_c> __temp_me29, T_c[] arr) {
			__temp_me29.arr = arr;
			__temp_me29.idx = ((uint) (0) );
		}
			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.arr != null )) {
								T_c[] __temp_new_arr26 = new T_c[this.arr.Length];
								int __temp_i27 = -1;
								while ((  ++ __temp_i27 < this.arr.Length )) {
									object __temp_obj28 = ((object) (this.arr[__temp_i27]) );
									if (( __temp_obj28 != null )) {
										__temp_new_arr26[__temp_i27] = global::haxe.lang.Runtime.genericCast<T_c>(__temp_obj28);
									}
									
								}
								
								new_me.arr = __temp_new_arr26;
							}
							else {
								new_me.arr = null;
							}
