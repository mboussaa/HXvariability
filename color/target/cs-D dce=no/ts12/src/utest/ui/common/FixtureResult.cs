...
namespace utest.ui.common {
	public class FixtureResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_FixtureResult(global::utest.ui.common.FixtureResult __temp_me209, string methodName) {
			__temp_me209.methodName = methodName;
			__temp_me209.list = new global::List<object>();
			__temp_me209.hasTestError = false;
			__temp_me209.hasSetupError = false;
			__temp_me209.hasTeardownError = false;
			__temp_me209.hasTimeoutError = false;
			__temp_me209.hasAsyncError = false;
