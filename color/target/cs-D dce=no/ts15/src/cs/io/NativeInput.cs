...
namespace cs.io {
	public class NativeInput : global::haxe.io.Input {
		...
		public static void __hx_ctor_cs_io_NativeInput(global::cs.io.NativeInput __temp_me34, global::System.IO.Stream stream) {
			__temp_me34.stream = stream;
			__temp_me34._eof = false;
			if ( ! (stream.CanRead) ) {
