...
namespace utest.ui.common {
	public class ClassResult : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_utest_ui_common_ClassResult(global::utest.ui.common.ClassResult __temp_me208, string className, string setupName, string teardownName) {
			__temp_me208.fixtures = new global::haxe.ds.StringMap<object>();
			__temp_me208.className = className;
			__temp_me208.setupName = setupName;
			__temp_me208.hasSetup =  ! (string.Equals(setupName, null)) ;
			__temp_me208.teardownName = teardownName;
			__temp_me208.hasTeardown =  ! (string.Equals(teardownName, null)) ;
			__temp_me208.methods = 0;
		...
		public virtual global::Array<object> methodNames(global::haxe.lang.Null<bool> errorsHavePriority) {
			bool __temp_errorsHavePriority207 = ( ( ! (errorsHavePriority.hasValue) ) ? (true) : ((errorsHavePriority).@value) );
			...
			if (__temp_errorsHavePriority207) {
